...
{
    public class FelFuryByBash : CombatRoutine
    {
        #region Routine Overrides -- Modify only the Name and Class here!
        /// <summary>
        /// Override for display name.
        /// </summary>
        public override string Name
        {
            get { return "Fel Fury by Bash - version:" + _versionnumber; }
        }
        ...
        {
            get { return "Demonhunter"; }
        }

        /// <summary>
        /// Override for Settings Form.
        /// </summary>
        ...
        /// Only rename InterfaceExample to your interface name!
        /// </summary>
        public override void Initialize()
        {
            WriteLogging();

            Interface = new FelFuryInterface();
        ...
        #region Privates -- Modify only the Version Number in the String " " here !
        /// <summary>
        /// String for version number.
        /// </summary>
        private static readonly string _versionnumber = "0.0.1 (7.3.2)";
        ...
        /// <summary>
        /// Rotationstatus for pausing the rotation.
        /// </summary>
        ...
        private static void WriteLogging()
        {
            ...
            WriteLog("Fel Fury by Bash - v" + _versionnumber);
        ...
        {
            if (DebuggerTimer.Elapsed.TotalMilliseconds >= timer)
            {
                DebuggerTimer.Reset();
                _debuggerdetected = false;
            }
            ...
            if (EnableDebugger && !_debuggerdetected)
            {
                ...
                WriteLog("=======================================");
                WriteLog("Player Talents: " + WoW.Talent(1) + WoW.Talent(2) + WoW.Talent(3) + WoW.Talent(4) + WoW.Talent(5) + WoW.Talent(6) + WoW.Talent(7));
                WriteLog("Player Race: " + WoW.PlayerRace);
                WriteLog("Player Spec: " + WoW.PlayerSpec);
                WriteLog("GCD: " + CurrentGlobalCooldown);

                if (HasSetBonus(SetBonus.T19TwoSet))
                    WriteLog("T19 2P: True");

                if (HasSetBonus(SetBonus.T19FourSet))
                    WriteLog("T19 4P: True");

                if (HasSetBonus(SetBonus.T20TwoSet))
                    WriteLog("T20 2P: True");

                if (HasSetBonus(SetBonus.T20FourSet))
                    WriteLog("T20 4P: True");

                WriteLog("Our Current Health is: " + WoW.PlayerHealthPercent);
                WriteLog("Our Target Health is: " + WoW.TargetHealthPercent);
                WriteLog("Our Current Power is: " + WoW.CurrentPower);
                WriteLog("Our current Haste is: " + WoW.PlayerHastePercent);
                WriteLog("Our AoE units count is:" + WoW.CurrentEnemyUnitCount);
                WriteLog("Do we have a target: " + WoW.PlayerHasTarget);
                WriteLog("Is our target an enemy: " + WoW.TargetIsEnemy);

                //WriteLog("118000,DragonRoarAura " + HasAura(Auras.ExampleBuff));
            }
        }
        ...
        /// Override for Settings Form.
        /// </summary>
        private FelFuryInterface Interface
        {
            get; set;
        }

        /// <summary>
        /// Void used for filling the Interface.
        /// </summary>
        private void BuildInterface()
        {
            // Routine Settings
            Interface.boxuseautoaoe.Checked = EnableAutomatedAoE;
            Interface.boxuseautoaoe.CheckedChanged += EnableAutomatedAoE_CheckedChanged;
            Interface.boxuseautocooldowns.Checked = EnableCooldowns;
            Interface.boxuseautocooldowns.CheckedChanged += EnableCooldowns_CheckedChanged;

            // Ability Settings
            Interface.boxMeta.Checked = MetaOnBoss;
            Interface.boxMeta.CheckedChanged += MetaOnBoss_CheckedChanged;
            Interface.boxOtherCDs.Checked = OtherCDsOnBoss;
            Interface.boxOtherCDs.CheckedChanged += OtherCDsOnBoss_CheckedChanged;

            // Item Settings
            Interface.exampleitem1.Checked = ExampleItem;
            Interface.exampleitem1.CheckedChanged += ExampleItem_CheckedChanged;


            // System Settings
            Interface.boxenabledebugger.Checked = EnableDebugger;
            Interface.boxenabledebugger.CheckedChanged += EnableDebugger_CheckedChanged;
        ...
        #region Wrappers
        /// <summary>
        /// Used for checking CanCast on Items.
        /// </summary>
        /// <param name="spell">Spell ENUM.</param>
        private static bool CanCastItem(Items item)
        {
            switch (item)
            {
                case Items.KJBW:
                    return !WoW.IsItemOnCooldown("KJBW");

                case Items.SpecterofBetrayal:
                    return !WoW.IsItemOnCooldown("Specter of Betrayal");

                case Items.UmbralMoonglaives:
                    return !WoW.IsItemOnCooldown("Umbral Moonglaives");
        ...
        /// <summary>
        /// Used for casting items.
        /// </summary>
        /// <param name="spell">Spell ENUM.</param>
        private static void CastItem(Items item)
        {
            switch (item)
            {
                case Items.KJBW:
                    WoW.CastItem("KJBW"); return;

                case Items.SpecterofBetrayal:
                    WoW.CastItem("Specter of Betrayal"); return;

                case Items.UmbralMoonglaives:
                    WoW.CastItem("Umbral Moonglaives"); return;
        ...
        private static bool HasAura(Auras aura)
        {
            ...
            {
                case Auras.Bloodlet:
                    return WoW.TargetHasDebuff("BloodletAura");

                case Auras.Nemesis:
                    return WoW.TargetHasDebuff("NemesisAura");

                case Auras.Momentum:
                    return WoW.PlayerHasBuff("MomentumAura");

                case Auras.ChaosBlades:
                    return WoW.PlayerHasBuff("ChaosBladesAura");

                case Auras.Anguish:
                    return WoW.TargetHasDebuff("AnguishAura");

                case Auras.Metamorphosis:
                    return WoW.PlayerHasBuff("MetamorphosisAura");
        ...
        /// <returns>True or False.</returns>
        private static bool HasSetBonus(SetBonus set)
        {
            switch (set)
            {
                case SetBonus.T19TwoSet:
                    return WoW.SetBonus(19) >= 2;

                case SetBonus.T19FourSet:
                    return WoW.SetBonus(19) >= 4;

                case SetBonus.T20TwoSet:
                    return WoW.SetBonus(20) >= 2;

                case SetBonus.T20FourSet:
                    return WoW.SetBonus(20) >= 4;
        ...
        /// I'm going to leave this as it is so you can see where on the warrior tree and how it checks them.
        /// 
        /// </summary>
        ...
        private static bool HasTalent(Talents talent)
        {
            switch (talent)
            {
                case Talents.FelMastery:
                    return WoW.Talent(1) == 1;

                case Talents.Felblade:
                    return WoW.Talent(1) == 2;

                case Talents.BlindFury:
                    return WoW.Talent(1) == 3;

                case Talents.Prepared:
                    return WoW.Talent(2) == 1;

                case Talents.DemonBlades:
                    return WoW.Talent(2) == 2;

                case Talents.DemonicAppetite:
                    return WoW.Talent(2) == 3;

                case Talents.ChaosCleave:
                    return WoW.Talent(3) == 1;

                case Talents.FirstBlood:
                    return WoW.Talent(3) == 2;

                case Talents.Bloodlet:
                    return WoW.Talent(3) == 3;

                case Talents.Netherwalk:
                    return WoW.Talent(4) == 1;

                case Talents.DesperateInstincts:
                    return WoW.Talent(4) == 2;

                case Talents.SoulRending:
                    return WoW.Talent(4) == 3;

                case Talents.Momentum:
                    return WoW.Talent(5) == 1;

                case Talents.FelEruption:
                    return WoW.Talent(5) == 2;

                case Talents.Nemesis:
                    return WoW.Talent(5) == 3;

                case Talents.MasteroftheGlaive:
                    return WoW.Talent(6) == 1;

                case Talents.UnleashedPower:
                    return WoW.Talent(6) == 2;

                case Talents.DemonReborn:
                    return WoW.Talent(6) == 3;

                case Talents.ChaosBlades:
                    return WoW.Talent(7) == 1;

                case Talents.FelBarrage:
                    return WoW.Talent(7) == 2;

                case Talents.Demonic:
        ...
        /// <summary>
        /// Returns the selected aura's time remaining.
        /// Here we check the time remaining on auras (buffs/debuffs) on ourself.
        /// </summary>
        /// <param name="aura">Aura ENUM.</param>
        /// <returns>Time remaining in seconds.</returns>
        private static int AuraTimeRemaining(Auras aura)
        {
            switch (aura)
            {
                case Auras.Metamorphosis:
                    return WoW.PlayerBuffTimeRemaining("MetamorphosisAura");
        ...
        /// Returns the race.
        /// </summary>
        /// <param name="race">Enum name of the race.</param>
        /// Pretty self-explained here.
        /// <returns>True or False.</returns>
        private static bool PlayerRace(Races race)
        {
            switch (race)
            {
                case Races.BloodElf:
        ...
        /// <summary>
        /// Returns true or false for preavbility checks.
        /// Here we can do ability checks. If the spell requires x energy or x buff etc you add it.
        /// I'm gonna leave some examples so you can see how it is done.
        /// Always use Prebility.Combat as your first check on the top of the rotation. 
        /// I will leave an example there too.
        /// </summary>
        /// <param name="ability"></param>
        /// <returns>True or False.</returns>
        private static bool PreAbilityCheck(PreAbility ability)
        {
            switch (ability)
            {
                ...
                case PreAbility.BladeDance:
                    return (HasTalent(Talents.FirstBlood) || HasSetBonus(SetBonus.T20FourSet) || (_enemycount >= 6 && HasTalent(Talents.ChaosCleave)) || (_enemycount >= 3 && !HasTalent(Talents.ChaosCleave)));
                ...
                case PreAbility.PoolingBladeDance:
                    return (PreAbilityCheck(PreAbility.BladeDance) && ((HasTalent(Talents.FirstBlood) && WoW.CurrentFury <= 55) || (!HasTalent(Talents.FirstBlood) && WoW.CurrentFury <= 75)));
                ...
                case PreAbility.PoolingChaosStrike:
                    return (HasTalent(Talents.ChaosCleave) && WoW.CurrentFury <= 100 && _enemycount <= 2);
                ...
                case PreAbility.PoolingMetamorphosis:
                    return (!HasTalent(Talents.Demonic) && WoW.PlayerCooldownTimeRemaining("Metamorphosis") <= 6 & WoW.CurrentFury <= 110 && (!PreAbilityCheck(PreAbility.WaitNemesis) || WoW.PlayerCooldownTimeRemaining("Nemesis") <= 10 && (!PreAbilityCheck(PreAbility.WaitChaosBlades) || WoW.PlayerCooldownTimeRemaining("Chaos Blades") <= 6)));

                case PreAbility.Metamorphosis:
                    return (MetaOnBoss/* && WoW.TargetIsBoss*/);
                ...
                case PreAbility.WaitChaosBlades:
                    return (!(!HasTalent(Talents.ChaosBlades) || WoW.CanCast("Chaos Blades") || WoW.PlayerCooldownTimeRemaining("Chaos Blades") >= 60));

                case PreAbility.ChaosBlades:
                    return (OtherCDsOnBoss/* && WoW.TargetIsBoss*/);
                ...
                case PreAbility.WaitNemesis:
                    return (!(HasTalent(Talents.Nemesis) || WoW.CanCast("Nemesis") || WoW.PlayerCooldownTimeRemaining("Nemesis") >= 60));

                case PreAbility.Nemesis:
                    return (OtherCDsOnBoss/* && WoW.TargetIsBoss*/);

                case PreAbility.Combat:
                    return (WoW.PlayerHasTarget || WoW.TargetIsBoss) && !WoW.PlayerIsChanneling && WoW.PlayerIsInCombat && WoW.TargetIsEnemy && WoW.IsSpellInRange("Chaos Strike") && WoW.PlayerHealthPercent > 0;
        ...
        /// </summary>
        /// <param name="spell">The item to cast.</param>
        /// <param name="reqs">The required booleans</param>
        /// /// <param name="ret">Should we return or not - DEFAULT SHOULD BE TRUE! - You can use false on cooldowns to continue traversing the tree.</param>
        private void NewStyleItemCast(Items item, bool reqs = true, bool ret = true)
        {
            if (CanCastItem(item) && reqs)
            {
                CastItem(item); if (ret) { return; }
            }
        }
        ...
        /// <summary>
        /// Returns the Global Cooldown for the current character.
        /// </summary>
        ...
        {
            return EnableCooldowns && WoW.UseCooldowns;
        }
        ...
        {
            short key = WoW.GetAsyncKeyState(Keys.LShiftKey);
            if ((key & 0x8000) != 0)
            {
        ...
        #region ENUMS
        /// <summary>
        /// ENUM for the preability checks.
        /// 
        /// This enum is only for abilities
        /// That is either a cooldown,ability etc that requires lots of checks. 
        /// Which means tidy code
        /// Here you add your ability names
        /// Do not use space in the name of these abilities. For example "Battle Cry" needs to be BattleCry
        /// 
        /// This applies to every Enum in this region.
        /// Enum's also needs a "," after each other and ends with no ","
        /// </summary>
        private enum PreAbility
        {
            BladeDance,
            PoolingBladeDance,
            PoolingChaosStrike,
            PoolingMetamorphosis,
            Metamorphosis,
            WaitChaosBlades,
            ChaosBlades,
            WaitNemesis,
        ...
        /// Do not modify this unless we get T21
        /// </summary>
        ...
        private static bool EnableAutomatedAoE
        {
            get
            {
                var enableautomatedaoe = ConfigFile.ReadValue("FelFuryByBash", "EnableAutomatedAoE").Trim();
                return enableautomatedaoe != "" && Convert.ToBoolean(enableautomatedaoe);
            }
            set { ConfigFile.WriteValue("FelFuryByBash", "EnableAutomatedAoE", value.ToString()); }
        }

        /// <summary>
        /// Checked-Changed handler.
        /// </summary>
        private void EnableAutomatedAoE_CheckedChanged(object sender, EventArgs e)
        {
            EnableAutomatedAoE = Interface.boxuseautoaoe.Checked;
        }
        ...
        private static bool EnableCooldowns
        {
            get
            {
                var enablecooldowns = ConfigFile.ReadValue("FelFuryByBash", "EnableCooldowns").Trim();
                return enablecooldowns != "" && Convert.ToBoolean(enablecooldowns);
            }
            set { ConfigFile.WriteValue("FelFuryByBash", "EnableCooldowns", value.ToString()); }
        }

        private static bool ExampleItem
        {
            get
            {
                var exampleitem = ConfigFile.ReadValue("FelFuryByBash", "ExampleItem").Trim();
                return exampleitem != "" && Convert.ToBoolean(exampleitem);
            }
            set { ConfigFile.WriteValue("FelFuryByBash", "ExampleItem", value.ToString()); }
        }

        private void ExampleItem_CheckedChanged(object sender, EventArgs e)
        {
            ExampleItem = Interface.exampleitem1.Checked;
        }

        /// <summary>
        /// Checked-Changed handler.
        /// </summary>
        private void EnableCooldowns_CheckedChanged(object sender, EventArgs e)
        {
            EnableCooldowns = Interface.boxuseautocooldowns.Checked;
        }

        /// <summary>
        /// Setting boolean.
        /// </summary>
        private static bool MetaOnBoss
        {
            get
            {
                var metaonboss = ConfigFile.ReadValue("FelFuryByBash", "MetaOnBoss").Trim();
                return metaonboss != "" && Convert.ToBoolean(metaonboss);
            }
            set { ConfigFile.WriteValue("FelFuryByBash", "MetaOnBoss", value.ToString()); }
        }

        /// <summary>
        /// Checked-Changed handler.
        /// </summary>
        private void MetaOnBoss_CheckedChanged(object sender, EventArgs e)
        {
            MetaOnBoss = Interface.boxMeta.Checked;
        }

        /// <summary>
        /// Setting boolean.
        /// </summary>
        private static bool OtherCDsOnBoss
        {
            get
            {
                var othercdsonboss = ConfigFile.ReadValue("FelFuryByBash", "OtherCDsOnBoss").Trim();
                return othercdsonboss != "" && Convert.ToBoolean(othercdsonboss);
            }
            set { ConfigFile.WriteValue("FelFuryByBash", "OtherCDsOnBoss", value.ToString()); }
        }

        /// <summary>
        /// Checked-Changed handler.
        /// </summary>
        private void OtherCDsOnBoss_CheckedChanged(object sender, EventArgs e)
        {
            OtherCDsOnBoss = Interface.boxOtherCDs.Checked;
        }
        ...
        private static bool EnableDebugger
        {
            get
            {
                var enabledebugger = ConfigFile.ReadValue("FelFuryByBash", "EnableDebugger").Trim();
                return enabledebugger != "" && Convert.ToBoolean(enabledebugger);
            }
            set { ConfigFile.WriteValue("FelFuryByBash", "EnableDebugger", value.ToString()); }
        }

        /// <summary>
        /// Checked-Changed handler.
        /// </summary>
        private void EnableDebugger_CheckedChanged(object sender, EventArgs e)
        {
            EnableDebugger = Interface.boxenabledebugger.Checked;
        }
        ...
        private void FelFuryRotation()
        {
            ...
            #region Rotation
            {
                ...
                if (!PreAbilityCheck(PreAbility.Combat))
                    return;

                if (EnableAutomatedAoE)
                    _enemycount = WoW.CurrentEnemyUnitCount;

                if (!EnableAutomatedAoE && _enemycount > 0)
                    _enemycount = 0;

                #endregion

                if (PreAbilityCheck(PreAbility.Combat) && (PreAbilityCheck(PreAbility.Metamorphosis) || PreAbilityCheck(PreAbility.Nemesis) || PreAbilityCheck(PreAbility.ChaosBlades)))
                {
                    ...
                    if (WoW.CanCast("Metamorphosis") && !(HasTalent(Talents.Demonic) || PreAbilityCheck(PreAbility.PoolingMetamorphosis) || PreAbilityCheck(PreAbility.WaitNemesis) || PreAbilityCheck(PreAbility.WaitChaosBlades)) && PreAbilityCheck(PreAbility.Metamorphosis))
                    {
                        WoW.CastSpell("Metamorphosis");
                        return;
                    }
                    //actions.cooldown +=/ metamorphosis,if= talent.demonic.enabled & buff.metamorphosis.up & fury < 40
                    if (WoW.CanCast("Metamorphosis") && HasTalent(Talents.Demonic) && HasAura(Auras.Metamorphosis) && Fury <= 40 && PreAbilityCheck(PreAbility.Metamorphosis))
                    {
                        WoW.CastSpell("Metamorphosis");
                        return;
                    }
                    ...
                    if (WoW.CanCast("Nemesis") && (HasAura(Auras.ChaosBlades) || HasAura(Auras.Metamorphosis) || WoW.PlayerCooldownTimeRemaining("Metamorphosis") <= 20) && PreAbilityCheck(PreAbility.Nemesis))
                    {
                    ...
                    if (WoW.CanCast("Chaos Blades") && HasAura(Auras.Metamorphosis) || WoW.PlayerCooldownTimeRemaining("Metamorphosis") >= 60 && PreAbilityCheck(PreAbility.ChaosBlades))
                    {
                ...
                if (PreAbilityCheck(PreAbility.Combat) && HasTalent(Talents.Demonic))
                {
                    #region Logging
                    const string msg = "P73 - Switching to Demonic tree.";
                    ...
                    if (WoW.CanCast("Throw Glaive") && HasTalent(Talents.Bloodlet) && (!HasTalent(Talents.Momentum) || HasAura(Auras.Momentum)) && WoW.PlayerSpellCharges("Throw Glaive") == 2)
                    {
                        WoW.CastSpell("Throw Glaive");
                        return;
                    }
                    //actions.demonic +=/ death_sweep,if= variable.blade_dance
                    if (WoW.CanCast("Death Sweep") && PreAbilityCheck(PreAbility.BladeDance) && HasAura(Auras.Metamorphosis) && Fury >= 15)
                    {
                        WoW.CastSpell("Death Sweep");
                        return;
                    }
                    //actions.demonic +=/ fel_eruption
                    if (WoW.CanCast("Fel Eruption") && HasTalent(Talents.FelEruption) && Fury >= 10)
                    {
                    ...
                    if (WoW.CanCast("FOTI") && (/*_enemycount >= FotIMin || */(!HasTalent(Talents.Momentum) || HasAura(Auras.Momentum))))
                    {
                        WoW.CastSpell("FOTI");
                        return;
                    }
                    //actions.demonic +=/ blade_dance,if= variable.blade_dance & cooldown.eye_beam.remains > 5 & !cooldown.metamorphosis.ready
                    if (WoW.CanCast("Blade Dance") && PreAbilityCheck(PreAbility.BladeDance) && WoW.PlayerCooldownTimeRemaining("Eye Beam") >= 5 && !WoW.CanCast("Metamorphosis") && Fury >= 15)
                    {
                    ...
                    if (WoW.CanCast("Throw Glaive") && HasTalent(Talents.Bloodlet) && _enemycount >= 2 && (!HasTalent(Talents.MasteroftheGlaive) || !HasTalent(Talents.Momentum) || HasAura(Auras.Momentum)))
                    {
                        WoW.CastSpell("Throw Glaive");
                        return;
                    }
                    //actions.demonic +=/ felblade,if= fury.deficit >= 30
                    if (WoW.CanCast("Felblade") && Fury <= 110 && HasTalent(Talents.Felblade))
                    {
                    ...
                    if (WoW.CanCast("Eye Beam") && Fury >= 50 && (/*_enemycount >= EyeBeamMin || */ _enemycount >= 3 || !HasAura(Auras.Metamorphosis)))
                    {
                    ...
                    if (WoW.CanCast("Annihilation") && HasAura(Auras.Metamorphosis) && Fury >= 40 && (!HasTalent(Talents.Momentum) || HasAura(Auras.Momentum) || Fury >= 110 || AuraTimeRemaining(Auras.Metamorphosis) <= 5) && !PreAbilityCheck(PreAbility.PoolingBladeDance))
                    {
                    ...
                    if (WoW.CanCast("Throw Glaive") && HasTalent(Talents.Bloodlet) && (!HasTalent(Talents.MasteroftheGlaive) || !HasTalent(Talents.Momentum) || HasAura(Auras.Momentum)))
                    {
                        WoW.CastSpell("Throw Glaive");
                        return;
                    }
                    ...
                    if (WoW.CanCast("Chaos Strike") && Fury >= 40 && (!HasTalent(Talents.Momentum) || HasAura(Auras.Momentum) || Fury > 110) && !PreAbilityCheck(PreAbility.PoolingChaosStrike) && !PreAbilityCheck(PreAbility.PoolingMetamorphosis) && !PreAbilityCheck(PreAbility.PoolingBladeDance))
                    {
                ...
                {
                    #region Logging
                    const string msg = "P73 - Switching to Non-Demonic tree.";
                    ...
                    /*if (CanCast(Spells.DemonsBite))
                    {
                        CastSpell(Spells.DemonsBite); return;
                    }*/
                    ...
                    //if (WoW.CanCast("FelRush, (HasTalent(Talents.Momentum) || HasTalent(Talents.FelMastery)) && (!HasTalent(Talents.Momentum) || (WoW.PlayerSpellCharges("Fel Rush") == 2 || WoW.PlayerCooldownTimeRemaining("Vengeful Retreat") >= 4) && !HasAura(Auras.Momentum)) && (!HasTalent(Talents.FelMastery) || Fury<=115));
                    ...
                    if (WoW.CanCast("Fel Barrage") && HasTalent(Talents.FelBarrage) && (HasAura(Auras.Momentum) || !HasTalent(Talents.Momentum)))
                    {
                    ...
                    if (WoW.CanCast("Felblade") && HasTalent(Talents.Felblade) && Fury < 15 & (WoW.PlayerCooldownTimeRemaining("Death Sweep") < 2 * CurrentGlobalCooldown || WoW.PlayerCooldownTimeRemaining("Blade Dance") < 2 * CurrentGlobalCooldown))
                    {
                        WoW.CastSpell("Felblade");
                        return;
                    }
                    //actions.normal +=/ death_sweep,if= variable.blade_dance
                    if (WoW.CanCast("Death Sweep") && PreAbilityCheck(PreAbility.BladeDance) && HasAura(Auras.Metamorphosis))
                    {
                        WoW.CastSpell("Death Sweep");
                        return;
                    }
                    //actions.normal +=/ fel_rush,if= charges = 2 & !talent.momentum.enabled & !talent.fel_mastery.enabled & !buff.metamorphosis.up
                    //if (WoW.CanCast("FelRush") && WoW.PlayerSpellCharges("Fel Rush") == 2 && !HasTalent(Talents.Momentum) && !HasTalent(Talents.FelMastery) & !HasAura(Auras.Metamorphosis));
                    //actions.normal +=/ fel_eruption
                    if (WoW.CanCast("Fel Eruption") && HasTalent(Talents.FelEruption))
                    {
                        WoW.CastSpell("Fel Eruption");
                        return;
                    }
                    ...
                    if (WoW.CanCast("FOTI") && (/*_enemycount >= FotIMin || */(!HasTalent(Talents.Momentum) || HasAura(Auras.Momentum)) && (!HasTalent(Talents.ChaosBlades) || HasAura(Auras.ChaosBlades) || WoW.PlayerCooldownTimeRemaining("Chaos Blades") >= 30)))
                    {
                        WoW.CastSpell("FOTI");
                        return;
                    }
                    //actions.normal +=/ blade_dance,if= variable.blade_dance
                    if (WoW.CanCast("Blade Dance") && PreAbilityCheck(PreAbility.BladeDance))
                    {
                        WoW.CastSpell("Blade Dance");
                        return;
                    }
                    ...
                    if (WoW.CanCast("Felblade") && HasTalent(Talents.Felblade) && Fury <= 110)
                    {
                        WoW.CastSpell("Felblade");
                        return;
                    }
                    ...
                    if (WoW.CanCast("Eye Beam") && /*_enemycount >= EyeBeamMin || */ _enemycount >= 3 || (HasTalent(Talents.BlindFury) && Fury <= 105)/* || HasSetBonus(SetBonus.T21TwoSet)*/)
                    {
                        WoW.CastSpell("Eye Beam");
                        return;
                    }
                    ...
                    if (WoW.CanCast("Annihilation") && HasAura(Auras.Metamorphosis) && (HasTalent(Talents.DemonBlades) || !HasTalent(Talents.Momentum) || HasAura(Auras.Momentum) || Fury >= 110 || AuraTimeRemaining(Auras.Metamorphosis) <= 5) && !PreAbilityCheck(PreAbility.PoolingBladeDance))
                    {
                        WoW.CastSpell("Annihilation");
                        return;
                    }
                    ...
                    if (WoW.CanCast("Throw Glaive") && !HasTalent(Talents.Bloodlet) && !HasAura(Auras.Metamorphosis) && _enemycount >= 3)
                    {
                        WoW.CastSpell("Throw Glaive");
                        return;
                    }
                    ...
                    if (WoW.CanCast("Chaos Strike") && (HasTalent(Talents.DemonBlades) || !HasTalent(Talents.Momentum) || HasAura(Auras.Momentum) || Fury > 110) && !PreAbilityCheck(PreAbility.PoolingChaosStrike) && !PreAbilityCheck(PreAbility.PoolingMetamorphosis) && !PreAbilityCheck(PreAbility.PoolingBladeDance))
                    {
                        WoW.CastSpell("Chaos Strike");
                        return;
                    }
                    ...
                    //if (WoW.CanCast("FelRush") && !HasTalent(Talents.Momentum) && (HasTalent(Talents.DemonBlades) || !HasAura(Auras.Metamorphosis)));
    ...
    public class FelFuryInterface : Form
    {
        /// <summary>
        ...
        public FelFuryInterface()
        {
            this.toplogobox = new System.Windows.Forms.PictureBox();
            this.rotationsettings = new System.Windows.Forms.GroupBox();
            this.labelabilitysettings = new System.Windows.Forms.Label();
            this.labelroutinesettings = new System.Windows.Forms.Label();
            this.boxOtherCDs = new System.Windows.Forms.CheckBox();
            this.boxexamplesetting = new System.Windows.Forms.CheckBox();
            this.boxuseautoaoe = new System.Windows.Forms.CheckBox();
            this.boxMeta = new System.Windows.Forms.CheckBox();
            this.boxuseautocooldowns = new System.Windows.Forms.CheckBox();
            this.itemsettings = new System.Windows.Forms.GroupBox();
            this.boxalternativerotation = new System.Windows.Forms.CheckBox();
            this.boxenabledebugger = new System.Windows.Forms.CheckBox();
            this.labelsystemsettings = new System.Windows.Forms.Label();
            this.exampleitem1 = new System.Windows.Forms.CheckBox();
            this.labelequippeditems = new System.Windows.Forms.Label();
            this.groupBox1 = new System.Windows.Forms.GroupBox();
            this.buttonsaveandclose = new System.Windows.Forms.Button();
            ((System.ComponentModel.ISupportInitialize)(this.toplogobox)).BeginInit();
            this.rotationsettings.SuspendLayout();
            this.itemsettings.SuspendLayout();
            this.SuspendLayout();
            // 
            // toplogobox
            // 
            this.toplogobox.BackColor = System.Drawing.Color.White;
            this.toplogobox.Location = new System.Drawing.Point(0, 0);
            this.toplogobox.Name = "toplogobox";
            this.toplogobox.Size = new System.Drawing.Size(784, 95);
            this.toplogobox.TabIndex = 0;
            this.toplogobox.TabStop = false;
            // 
            // rotationsettings
            // 
            this.rotationsettings.Controls.Add(this.labelabilitysettings);
            this.rotationsettings.Controls.Add(this.labelroutinesettings);
            this.rotationsettings.Controls.Add(this.boxOtherCDs);
            this.rotationsettings.Controls.Add(this.boxexamplesetting);
            this.rotationsettings.Controls.Add(this.boxuseautoaoe);
            this.rotationsettings.Controls.Add(this.boxMeta);
            this.rotationsettings.Controls.Add(this.boxuseautocooldowns);
            this.rotationsettings.Location = new System.Drawing.Point(12, 101);
            this.rotationsettings.Name = "rotationsettings";
            this.rotationsettings.Size = new System.Drawing.Size(250, 225);
            this.rotationsettings.TabIndex = 1;
            this.rotationsettings.TabStop = false;
            // 
            // labelabilitysettings
            // 
            this.labelabilitysettings.AutoSize = true;
            this.labelabilitysettings.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.labelabilitysettings.Location = new System.Drawing.Point(6, 105);
            this.labelabilitysettings.Name = "labelabilitysettings";
            this.labelabilitysettings.Size = new System.Drawing.Size(91, 13);
            this.labelabilitysettings.TabIndex = 11;
            this.labelabilitysettings.Text = "Ability Settings";
            // 
            // labelroutinesettings
            // 
            this.labelroutinesettings.AutoSize = true;
            this.labelroutinesettings.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.labelroutinesettings.Location = new System.Drawing.Point(6, 13);
            this.labelroutinesettings.Name = "labelroutinesettings";
            this.labelroutinesettings.Size = new System.Drawing.Size(101, 13);
            this.labelroutinesettings.TabIndex = 10;
            this.labelroutinesettings.Text = "Routine Settings";
            // 
            // boxexample2onboss
            // 
            this.boxOtherCDs.AutoSize = true;
            this.boxOtherCDs.ForeColor = System.Drawing.Color.Chocolate;
            this.boxOtherCDs.Location = new System.Drawing.Point(6, 147);
            this.boxOtherCDs.Name = "boxOtherCDs";
            this.boxOtherCDs.Size = new System.Drawing.Size(217, 17);
            this.boxOtherCDs.TabIndex = 6;
            this.boxOtherCDs.Text = "Use Other CDs on Boss";
            this.boxOtherCDs.UseVisualStyleBackColor = true;
            // 
            // boxexamplesetting
            // 
            this.boxexamplesetting.AutoSize = true;
            this.boxexamplesetting.ForeColor = System.Drawing.Color.OrangeRed;
            this.boxexamplesetting.Location = new System.Drawing.Point(6, 78);
            this.boxexamplesetting.Name = "boxexamplesetting";
            this.boxexamplesetting.Size = new System.Drawing.Size(142, 17);
            this.boxexamplesetting.TabIndex = 9;
            this.boxexamplesetting.Text = "Example Routine Setting";
            this.boxexamplesetting.UseVisualStyleBackColor = true;
            // 
            // boxuseautoaoe
            // 
            this.boxuseautoaoe.AutoSize = true;
            this.boxuseautoaoe.ForeColor = System.Drawing.Color.OrangeRed;
            this.boxuseautoaoe.Location = new System.Drawing.Point(6, 32);
            this.boxuseautoaoe.Name = "boxuseautoaoe";
            this.boxuseautoaoe.Size = new System.Drawing.Size(132, 17);
            this.boxuseautoaoe.TabIndex = 8;
            this.boxuseautoaoe.Text = "Use AoE automatically";
            this.boxuseautoaoe.UseVisualStyleBackColor = true;
            // 
            // boxexampleonboss
            // 
            this.boxMeta.AutoSize = true;
            this.boxMeta.ForeColor = System.Drawing.Color.Chocolate;
            this.boxMeta.Location = new System.Drawing.Point(6, 124);
            this.boxMeta.Name = "boxMeta";
            this.boxMeta.Size = new System.Drawing.Size(201, 17);
            this.boxMeta.TabIndex = 5;
            this.boxMeta.Text = "Use Meta on Boss";
            this.boxMeta.UseVisualStyleBackColor = true;
            // 
            // boxuseautocooldowns
            // 
            this.boxuseautocooldowns.AutoSize = true;
            this.boxuseautocooldowns.ForeColor = System.Drawing.Color.OrangeRed;
            this.boxuseautocooldowns.Location = new System.Drawing.Point(6, 55);
            this.boxuseautocooldowns.Name = "boxuseautocooldowns";
            this.boxuseautocooldowns.Size = new System.Drawing.Size(163, 17);
            this.boxuseautocooldowns.TabIndex = 7;
            this.boxuseautocooldowns.Text = "Use cooldowns automatically";
            this.boxuseautocooldowns.UseVisualStyleBackColor = true;
            // 
            // itemsettings
            // 
            this.itemsettings.Controls.Add(this.boxalternativerotation);
            this.itemsettings.Controls.Add(this.boxenabledebugger);
            this.itemsettings.Controls.Add(this.labelsystemsettings);
            this.itemsettings.Controls.Add(this.exampleitem1);
            this.itemsettings.Controls.Add(this.labelequippeditems);
            this.itemsettings.Location = new System.Drawing.Point(268, 101);
            this.itemsettings.Name = "itemsettings";
            this.itemsettings.Size = new System.Drawing.Size(250, 225);
            this.itemsettings.TabIndex = 2;
            this.itemsettings.TabStop = false;
            // 
            // boxalternativerotation
            // 
            this.boxalternativerotation.AutoSize = true;
            this.boxalternativerotation.ForeColor = System.Drawing.Color.DimGray;
            this.boxalternativerotation.Location = new System.Drawing.Point(6, 191);
            this.boxalternativerotation.Name = "boxalternativerotation";
            this.boxalternativerotation.Size = new System.Drawing.Size(201, 17);
            this.boxalternativerotation.TabIndex = 14;
            this.boxalternativerotation.Text = "Enable test functions (DO NOT USE)";
            this.boxalternativerotation.UseVisualStyleBackColor = true;
            // 
            // boxenabledebugger
            // 
            this.boxenabledebugger.AutoSize = true;
            this.boxenabledebugger.ForeColor = System.Drawing.Color.DimGray;
            this.boxenabledebugger.Location = new System.Drawing.Point(6, 168);
            this.boxenabledebugger.Name = "boxenabledebugger";
            this.boxenabledebugger.Size = new System.Drawing.Size(109, 17);
            this.boxenabledebugger.TabIndex = 13;
            this.boxenabledebugger.Text = "Enable Debugger";
            this.boxenabledebugger.UseVisualStyleBackColor = true;
            // 
            // labelsystemsettings
            // 
            this.labelsystemsettings.AutoSize = true;
            this.labelsystemsettings.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.labelsystemsettings.Location = new System.Drawing.Point(6, 148);
            this.labelsystemsettings.Name = "labelsystemsettings";
            this.labelsystemsettings.Size = new System.Drawing.Size(97, 13);
            this.labelsystemsettings.TabIndex = 12;
            this.labelsystemsettings.Text = "System Settings";
            // 
            // exampleitem1
            // 
            this.exampleitem1.AutoSize = true;
            this.exampleitem1.ForeColor = System.Drawing.Color.DodgerBlue;
            this.exampleitem1.Location = new System.Drawing.Point(6, 32);
            this.exampleitem1.Name = "exampleitem1";
            this.exampleitem1.Size = new System.Drawing.Size(89, 17);
            this.exampleitem1.TabIndex = 12;
            this.exampleitem1.Text = "Example Item";
            this.exampleitem1.UseVisualStyleBackColor = true;
            // 
            // labelequippeditems
            // 
            this.labelequippeditems.AutoSize = true;
            this.labelequippeditems.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.labelequippeditems.Location = new System.Drawing.Point(6, 13);
            this.labelequippeditems.Name = "labelequippeditems";
            this.labelequippeditems.Size = new System.Drawing.Size(94, 13);
            this.labelequippeditems.TabIndex = 11;
            this.labelequippeditems.Text = "Equipped Items";
            // 
            // groupBox1
            // 
            this.groupBox1.Location = new System.Drawing.Point(524, 101);
            ...
            // buttonsaveandclose
            // 
            this.buttonsaveandclose.Location = new System.Drawing.Point(657, 332);
            ...
            this.Controls.Add(this.itemsettings);
            this.Controls.Add(this.rotationsettings);
            this.Controls.Add(this.toplogobox);
            this.Name = "ExampleInterface";
            this.Text = "Form1";
            ((System.ComponentModel.ISupportInitialize)(this.toplogobox)).EndInit();
            this.rotationsettings.ResumeLayout(false);
            this.rotationsettings.PerformLayout();
        ...
        private System.Windows.Forms.PictureBox toplogobox;
        private System.Windows.Forms.GroupBox rotationsettings;
        private System.Windows.Forms.GroupBox itemsettings;
        public System.Windows.Forms.CheckBox boxOtherCDs;
        public System.Windows.Forms.CheckBox boxMeta;
        public System.Windows.Forms.CheckBox boxuseautocooldowns;
        public System.Windows.Forms.CheckBox boxexamplesetting;
        public System.Windows.Forms.CheckBox boxuseautoaoe;
        private System.Windows.Forms.Label labelabilitysettings;
        private System.Windows.Forms.Label labelroutinesettings;
        private System.Windows.Forms.Label labelequippeditems;
        public System.Windows.Forms.CheckBox exampleitem1;
        private System.Windows.Forms.GroupBox groupBox1;
        private System.Windows.Forms.Label labelsystemsettings;
        public System.Windows.Forms.CheckBox boxenabledebugger;
        public System.Windows.Forms.CheckBox boxalternativerotation;
        public System.Windows.Forms.Button buttonsaveandclose;
    }
    #endregion
}
...
[SpellBook.db]
Spell,201427,Annihilation,NumPad1
Spell,69179,ArcaneTorrentRacial,NumPad2
Spell,26297,BerserkingRacial,NumPad2
Spell,188499,Blade Dance,NumPad3
Spell,20572,BloodFuryRacial,NumPad2
Spell,247938,Chaos Blades,NumPad4
Spell,162794,Chaos Strike,NumPad1
Spell,210152,Death Sweep,NumPad3
Spell,162243,Demons Bite,NumPad5
Spell,198013,Eye Beam,NumPad6
Spell,211053,Fel Barrage,NumPad4
Spell,211881,Fel Eruption,NumPad7
Spell,195072,Fel Rush,R
Spell,232893,Felblade,NumPad8
Spell,201467,FOTI,NumPad9
Spell,191427,Metamorphosis,NumPad0
Spell,206491,Nemesis,NumPad7
Spell,185123,Throw Glaive,Subtract
Spell,198793,Vengeful Retreat,Multiply
Item,144259,KJBW,F5
Item,151190,Specter of Betrayal,F5
Item,147012,Umbral Moonglaives,F5
Range,162794,Chaos Strike
Buff,208628,MomentumAura
Buff,211797,ChaosBladesAura
Buff,162264,MetamorphosisAura
Debuff,207690,BloodletAura
Debuff,206491,NemesisAura
Debuff,225084,FelEruptionAura
Debuff,202443,AnguishAura
Charge,185123,Throw Glaive
*/
