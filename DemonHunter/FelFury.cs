...
{
    public class FelFury : CombatRoutine
    {
        #region Startup
        ...
        {
            get { return "FelFury, Demon Hunter rotation - version:" + _versionnumber; }
        }
        ...
        {
            WriteLog("FelFury by Bash - v" + _versionnumber);
        ...
        public class FelFuryInterface : Form
        {
            ...
            {
                System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FelFuryInterface));
...
[SpellBook.db]
Spell,258860,DarkSlash,D1
Spell,258925,FelBarrage,D1
Spell,210152,DeathSweep,D1
Spell,188499,BladeDance,D1
Spell,258920,ImmolationAura,D1
Spell,232893,Felblade,D1
Spell,198013,EyeBeam,D1
Spell,201427,Annihilation,D1
Spell,162794,ChaosStrike,D1
Spell,195072,FelRush,D1
...
Buff,206491,NemesisBuff

Debuff,206491,NemesisDebuff

Talent,213410,Demonic
Talent,258925,FelBarrage
