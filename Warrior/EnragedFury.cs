...
{
    public class EnragedFury : CombatRoutine
    {
        #region Startup
        ...
        {
            get { return "EnragedFury, Fury Warrior rotation - version:" + _versionnumber; }
        }
        ...
        public override void Initialize()
        {
            ...
            Interface = new EnragedFuryInterface();
        ...
        private EnragedFuryInterface Interface { get; set; }
        ...
        {
            WriteLog("EnragedFury by Bash - v" + _versionnumber);
            WriteLog("Make sure to properly enable all required settings!");
            //WriteLog("Recommended Talent Build : 0000000 - But all are supported!");
            WriteLog("Selected Talents: " + WoW.Talent(1) + WoW.Talent(2) + WoW.Talent(3) + WoW.Talent(4) + WoW.Talent(5) + WoW.Talent(6) + WoW.Talent(7));
        }
        ...
        {
            Log.Write("Bash: " + message, Color.SaddleBrown);
        }
        ...
        private void BuildInterface()
        {
            ...
            //Combobox Example
            Interface.cmbSTBattleCry.Text = cmbSTBattleCry;
            Interface.cmbSTBattleCry.SelectedIndexChanged += cmbSTBattleCry_SelectedIndexChanged;

            //Combobox Example
            Interface.cmbSTOdynsFury.Text = cmbSTOdynsFury;
            Interface.cmbSTOdynsFury.SelectedIndexChanged += cmbSTOdynsFury_SelectedIndexChanged;

            //Combobox Example
            Interface.cmbSTAvatar.Text = cmbSTAvatar;
            Interface.cmbSTAvatar.SelectedIndexChanged += cmbSTAvatar_SelectedIndexChanged;

            //Combobox Example
            Interface.cmbSTTrinkets.Text = cmbSTTrinkets;
            Interface.cmbSTTrinkets.SelectedIndexChanged += cmbSTTrinkets_SelectedIndexChanged;

            //Number Box Up Down Example
            Interface.numSTOdynsFuryTargets.Text = numSTOdynsFuryTargets;
            Interface.numSTOdynsFuryTargets.ValueChanged += numSTOdynsFuryTargets_ValueChanged;

            //Combobox Example
            Interface.cmbAOEBattleCry.Text = cmbAOEBattleCry;
            Interface.cmbAOEBattleCry.SelectedIndexChanged += cmbAOEBattleCry_SelectedIndexChanged;

            //Combobox Example
            Interface.cmbAOEOdynsFury.Text = cmbAOEOdynsFury;
            Interface.cmbAOEOdynsFury.SelectedIndexChanged += cmbAOEOdynsFury_SelectedIndexChanged;

            //Combobox Example
            Interface.cmbAOEAvatar.Text = cmbAOEAvatar;
            Interface.cmbAOEAvatar.SelectedIndexChanged += cmbAOEAvatar_SelectedIndexChanged;

            //Combobox Example
            Interface.cmbAOETrinkets.Text = cmbAOETrinkets;
            Interface.cmbAOETrinkets.SelectedIndexChanged += cmbAOETrinkets_SelectedIndexChanged;

            //Number Box Up Down Example
            Interface.numAOEOdynsFuryTargets.Text = numAOEOdynsFuryTargets;
            Interface.numAOEOdynsFuryTargets.ValueChanged += numAOEOdynsFuryTargets_ValueChanged;

            //Combobox Example
            Interface.cmbCleaveBattleCry.Text = cmbCleaveBattleCry;
            Interface.cmbCleaveBattleCry.SelectedIndexChanged += cmbCleaveBattleCry_SelectedIndexChanged;

            //Combobox Example
            Interface.cmbCleaveOdynsFury.Text = cmbCleaveOdynsFury;
            Interface.cmbCleaveOdynsFury.SelectedIndexChanged += cmbCleaveOdynsFury_SelectedIndexChanged;

            //Combobox Example
            Interface.cmbCleaveAvatar.Text = cmbCleaveAvatar;
            Interface.cmbCleaveAvatar.SelectedIndexChanged += cmbCleaveAvatar_SelectedIndexChanged;

            //Combobox Example
            Interface.cmbCleaveTrinkets.Text = cmbCleaveTrinkets;
            Interface.cmbCleaveTrinkets.SelectedIndexChanged += cmbCleaveTrinkets_SelectedIndexChanged;

            //Number Box Up Down Example
            Interface.numCleaveOdynsFuryTargets.Text = numCleaveOdynsFuryTargets;
            Interface.numCleaveOdynsFuryTargets.ValueChanged += numCleaveOdynsFuryTargets_ValueChanged;
        }
        ...
        private static bool HasItem(Item item)
        {
            switch (item)
            {
                case Item.ConvergenceofFates: return WoW.IsItemEquipped("ConvergenceofFates");
                case Item.UmbralMoonglaives: return WoW.IsItemEquipped("UmbralMoonglaives");
                case Item.KazzalaxFujiedasFury: return WoW.IsItemEquipped("KazzalaxFujiedasFury");
        ...
        private static bool HasTalent(Talent talent)
        {
            switch (talent)
            {
                case Talent.WarMachine: return WoW.Talent(1) == 1;
                case Talent.EndlessRage: return WoW.Talent(1) == 2;
                case Talent.FreshMeat: return WoW.Talent(1) == 3;
                case Talent.Shockwave: return WoW.Talent(2) == 1;
                case Talent.StormBolt: return WoW.Talent(2) == 2;
                case Talent.DoubleTime: return WoW.Talent(2) == 3;
                case Talent.WreckingBall: return WoW.Talent(3) == 1;
                case Talent.Outburst: return WoW.Talent(3) == 2;
                case Talent.Avatar: return WoW.Talent(3) == 3;
                case Talent.FuriousCharge: return WoW.Talent(4) == 1;
                case Talent.BoundingStride: return WoW.Talent(4) == 2;
                case Talent.Warpaint: return WoW.Talent(4) == 3;
                case Talent.Massacre: return WoW.Talent(5) == 1;
                case Talent.FrothingBerserker: return WoW.Talent(5) == 2;
                case Talent.Carnage: return WoW.Talent(5) == 3;
                case Talent.Bloodbath: return WoW.Talent(6) == 1;
                case Talent.Frenzy: return WoW.Talent(6) == 2;
                case Talent.InnerRage: return WoW.Talent(6) == 3;
                case Talent.Bladestorm: return WoW.Talent(7) == 1;
                case Talent.RecklessAbandon: return WoW.Talent(7) == 2;
                case Talent.DragonRoar: return WoW.Talent(7) == 3;
                default: return false;
            }
        }
        ...
        private static bool HasAura(Auras aura)
        {
            switch (aura)
            {
                case Auras.MeatCleaver: return WoW.PlayerHasBuff("MeatCleaverAura");
                case Auras.DragonRoar: return WoW.PlayerHasBuff("DragonRoarAura");
                case Auras.BattleCry: return WoW.PlayerHasBuff("BattleCryAura");
                case Auras.Avatar: return WoW.PlayerHasBuff("AvatarAura");
                case Auras.Enrage: return WoW.PlayerHasBuff("EnrageAura");
                case Auras.WreckingBall: return WoW.PlayerHasBuff("WreckingBallAura");
                case Auras.Juggernaut: return WoW.PlayerHasBuff("JuggernautAura");
                case Auras.Massacre: return WoW.PlayerHasBuff("MassacreAura");
                case Auras.SenseDeath: return WoW.PlayerHasBuff("SenseDeathAura");
                case Auras.StoneHeart: return WoW.PlayerHasBuff("StoneHeartAura");
                case Auras.FrothingBerserker: return WoW.PlayerHasBuff("FrothingBerserkerAura");
                case Auras.Frenzy: return WoW.PlayerHasBuff("FrenzyAura");
                case Auras.FujiedasFury: return WoW.PlayerHasBuff("FujiedasFuryAura");
                case Auras.FelCrazedRage: return WoW.PlayerHasBuff("FelCrazedRageAura");
                case Auras.BloodyRage: return WoW.PlayerHasBuff("BloodyRageAura");
                case Auras.RagingThirst: return WoW.PlayerHasBuff("RagingThirstAura");
                case Auras.Bloodbath: return WoW.PlayerHasBuff("BloodbathAura");
                default: return false;
            }
        }
        ...
        private static int AuraRemaining(Auras aura)
        {
            switch (aura)
            {
                case Auras.MeatCleaver: return WoW.PlayerBuffTimeRemaining("MeatCleaverAura");
                case Auras.DragonRoar: return WoW.PlayerBuffTimeRemaining("DragonRoarAura");
                case Auras.BattleCry: return WoW.PlayerBuffTimeRemaining("BattleCryAura");
                case Auras.Avatar: return WoW.PlayerBuffTimeRemaining("AvatarAura");
                case Auras.Enrage: return WoW.PlayerBuffTimeRemaining("EnrageAura");
                case Auras.WreckingBall: return WoW.PlayerBuffTimeRemaining("WreckingBallAura");
                case Auras.Juggernaut: return WoW.PlayerBuffTimeRemaining("JuggernautAura");
                case Auras.Massacre: return WoW.PlayerBuffTimeRemaining("MassacreAura");
                case Auras.SenseDeath: return WoW.PlayerBuffTimeRemaining("SenseDeathAura");
                case Auras.StoneHeart: return WoW.PlayerBuffTimeRemaining("StoneHeartAura");
                case Auras.FrothingBerserker: return WoW.PlayerBuffTimeRemaining("FrothingBerserkerAura");
                case Auras.Frenzy: return WoW.PlayerBuffTimeRemaining("FrenzyAura");
                case Auras.FujiedasFury: return WoW.PlayerBuffTimeRemaining("FujiedasFuryAura");
                case Auras.FelCrazedRage: return WoW.PlayerBuffTimeRemaining("FelCrazedRageAura");
                case Auras.BloodyRage: return WoW.PlayerBuffTimeRemaining("BloodyRageAura");
                case Auras.RagingThirst: return WoW.PlayerBuffTimeRemaining("RagingThirstAura");
                case Auras.Bloodbath: return WoW.PlayerBuffTimeRemaining("BloodbathAura");
        ...
        private static int AuraStacks(Auras aura)
        {
            switch (aura)
            {
                case Auras.Frenzy: return WoW.PlayerBuffStacks("FrenzyAura");
        ...
        private static int SpellCD(Spells spell)
        {
            switch (spell)
            {
                case Spells.BattleCry: return WoW.PlayerCooldownTimeRemaining("BattleCry");
                case Spells.Bloodbath: return WoW.PlayerCooldownTimeRemaining("Bloodbath");
                case Spells.RagingBlow: return WoW.PlayerCooldownTimeRemaining("RagingBlow");
                case Spells.Bladestorm: return WoW.PlayerCooldownTimeRemaining("Bladestorm");
                case Spells.Bloodthirst: return WoW.PlayerCooldownTimeRemaining("Bloodthirst");
                default: return 0;
            }
        }
        ...
        private static string cmbSTBattleCry
        {
            get { var cmbSTBattleCry = ConfigFile.ReadValue("EnragedFury", "cmbSTBattleCry"); try { return cmbSTBattleCry; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbSTBattleCry", value); }
        }

        private void cmbSTBattleCry_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbSTBattleCry = Convert.ToString(Interface.cmbSTBattleCry.SelectedItem);
        }

        private static string cmbSTOdynsFury
        {
            get { var cmbSTOdynsFury = ConfigFile.ReadValue("EnragedFury", "cmbSTOdynsFury"); try { return cmbSTOdynsFury; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbSTOdynsFury", value); }
        }

        private void cmbSTOdynsFury_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbSTOdynsFury = Convert.ToString(Interface.cmbSTOdynsFury.SelectedItem);
        }
        private static string cmbSTAvatar
        {
            get { var cmbSTAvatar = ConfigFile.ReadValue("EnragedFury", "cmbSTAvatar"); try { return cmbSTAvatar; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbSTAvatar", value); }
        }

        private void cmbSTAvatar_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbSTAvatar = Convert.ToString(Interface.cmbSTAvatar.SelectedItem);
        }
        private static string cmbSTTrinkets
        {
            get { var cmbSTTrinkets = ConfigFile.ReadValue("EnragedFury", "cmbSTTrinkets"); try { return cmbSTTrinkets; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbSTTrinkets", value); }
        }

        private void cmbSTTrinkets_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbSTTrinkets = Convert.ToString(Interface.cmbSTTrinkets.SelectedItem);
        }

        private static string numSTOdynsFuryTargets
        {
            get { var numSTOdynsFuryTargets = ConfigFile.ReadValue("EnragedFury", "numSTOdynsFuryTargets"); try { return numSTOdynsFuryTargets; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "numSTOdynsFuryTargets", value); }
        }

        private void numSTOdynsFuryTargets_ValueChanged(object sender, EventArgs e)
        {
            numSTOdynsFuryTargets = Convert.ToString(Interface.numSTOdynsFuryTargets.Value);
        }

        private static string cmbAOEBattleCry
        {
            get { var cmbAOEBattleCry = ConfigFile.ReadValue("EnragedFury", "cmbAOEBattleCry"); try { return cmbAOEBattleCry; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbAOEBattleCry", value); }
        }

        private void cmbAOEBattleCry_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbAOEBattleCry = Convert.ToString(Interface.cmbAOEBattleCry.SelectedItem);
        }

        private static string cmbAOEOdynsFury
        {
            get { var cmbAOEOdynsFury = ConfigFile.ReadValue("EnragedFury", "cmbAOEOdynsFury"); try { return cmbAOEOdynsFury; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbAOEOdynsFury", value); }
        }

        private void cmbAOEOdynsFury_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbAOEOdynsFury = Convert.ToString(Interface.cmbAOEOdynsFury.SelectedItem);
        }
        private static string cmbAOEAvatar
        {
            get { var cmbAOEAvatar = ConfigFile.ReadValue("EnragedFury", "cmbAOEAvatar"); try { return cmbAOEAvatar; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbAOEAvatar", value); }
        }

        private void cmbAOEAvatar_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbAOEAvatar = Convert.ToString(Interface.cmbAOEAvatar.SelectedItem);
        }
        private static string cmbAOETrinkets
        {
            get { var cmbAOETrinkets = ConfigFile.ReadValue("EnragedFury", "cmbAOETrinkets"); try { return cmbAOETrinkets; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbAOETrinkets", value); }
        }

        private void cmbAOETrinkets_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbAOETrinkets = Convert.ToString(Interface.cmbAOETrinkets.SelectedItem);
        }

        private static string numAOEOdynsFuryTargets
        {
            get { var numAOEOdynsFuryTargets = ConfigFile.ReadValue("EnragedFury", "numAOEOdynsFuryTargets"); try { return numAOEOdynsFuryTargets; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "numAOEOdynsFuryTargets", value); }
        }

        private void numAOEOdynsFuryTargets_ValueChanged(object sender, EventArgs e)
        {
            numAOEOdynsFuryTargets = Convert.ToString(Interface.numAOEOdynsFuryTargets.Value);
        }

        private static string cmbCleaveBattleCry
        {
            get { var cmbCleaveBattleCry = ConfigFile.ReadValue("EnragedFury", "cmbCleaveBattleCry"); try { return cmbCleaveBattleCry; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbCleaveBattleCry", value); }
        }

        private void cmbCleaveBattleCry_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbCleaveBattleCry = Convert.ToString(Interface.cmbCleaveBattleCry.SelectedItem);
        }

        private static string cmbCleaveOdynsFury
        {
            get { var cmbCleaveOdynsFury = ConfigFile.ReadValue("EnragedFury", "cmbCleaveOdynsFury"); try { return cmbCleaveOdynsFury; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbCleaveOdynsFury", value); }
        }

        private void cmbCleaveOdynsFury_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbCleaveOdynsFury = Convert.ToString(Interface.cmbCleaveOdynsFury.SelectedItem);
        }
        private static string cmbCleaveAvatar
        {
            get { var cmbCleaveAvatar = ConfigFile.ReadValue("EnragedFury", "cmbCleaveAvatar"); try { return cmbCleaveAvatar; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbCleaveAvatar", value); }
        }

        private void cmbCleaveAvatar_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbCleaveAvatar = Convert.ToString(Interface.cmbCleaveAvatar.SelectedItem);
        }
        private static string cmbCleaveTrinkets
        {
            get { var cmbCleaveTrinkets = ConfigFile.ReadValue("EnragedFury", "cmbCleaveTrinkets"); try { return cmbCleaveTrinkets; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "cmbCleaveTrinkets", value); }
        }

        private void cmbCleaveTrinkets_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmbCleaveTrinkets = Convert.ToString(Interface.cmbCleaveTrinkets.SelectedItem);
        }

        private static string numCleaveOdynsFuryTargets
        {
            get { var numCleaveOdynsFuryTargets = ConfigFile.ReadValue("EnragedFury", "numCleaveOdynsFuryTargets"); try { return numCleaveOdynsFuryTargets; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("EnragedFury", "numCleaveOdynsFuryTargets", value); }
        }

        private void numCleaveOdynsFuryTargets_ValueChanged(object sender, EventArgs e)
        {
            numCleaveOdynsFuryTargets = Convert.ToString(Interface.numCleaveOdynsFuryTargets.Value);
        }
        ...
        private static string cmbSTBattleCryConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbSTBattleCry"); }
        }

        private static string cmbSTOdynsFuryConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbSTBattleCry"); }
        }

        private static string cmbSTAvatarConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbSTAvatar"); }
        }

        private static string cmbSTTrinketsConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbSTTrinkets"); }
        }

        private static int numSTOdynsFuryTargetsConfig
        {
            get { return ConfigFile.ReadValue<int>("EnragedFury", "numSTOdynsFuryTargets"); }
        }

        private static string cmbAOEBattleCryConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbAOEBattleCry"); }
        }

        private static string cmbAOEOdynsFuryConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbAOEBattleCry"); }
        }

        private static string cmbAOEAvatarConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbAOEAvatar"); }
        }

        private static string cmbAOETrinketsConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbAOETrinkets"); }
        }

        private static int numAOEOdynsFuryTargetsConfig
        {
            get { return ConfigFile.ReadValue<int>("EnragedFury", "numAOEOdynsFuryTargets"); }
        }

        private static string cmbCleaveBattleCryConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbCleaveBattleCry"); }
        }

        private static string cmbCleaveOdynsFuryConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbCleaveBattleCry"); }
        }

        private static string cmbCleaveAvatarConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbCleaveAvatar"); }
        }

        private static string cmbCleaveTrinketsConfig
        {
            get { return ConfigFile.ReadValue<string>("EnragedFury", "cmbCleaveTrinkets"); }
        }

        private static int numCleaveOdynsFuryTargetsConfig
        {
            get { return ConfigFile.ReadValue<int>("EnragedFury", "numCleaveOdynsFuryTargets"); }
        }
        ...
        private bool PreCheck(Precheck ability)
        {
            switch (ability)
            {
                ...
                case Precheck.BattleCry:
                    return ((combatRoutine.Type == RotationType.SingleTarget && ((WoW.UseCooldowns && cmbSTBattleCry == "CD Toggle") ||
                                                                                (WoW.TargetIsBoss && cmbSTBattleCry == "OnBoss") || (cmbSTBattleCry == "Always"))) || 
                           (combatRoutine.Type == RotationType.AOE && ((WoW.UseCooldowns && cmbAOEBattleCry == "CD Toggle") ||
                                                                                (WoW.TargetIsBoss && cmbAOEBattleCry == "OnBoss") || (cmbAOEBattleCry == "Always"))) ||
                           (combatRoutine.Type == RotationType.SingleTargetCleave && ((WoW.UseCooldowns && cmbCleaveBattleCry == "CD Toggle") ||
                                                                       (WoW.TargetIsBoss && cmbCleaveBattleCry == "OnBoss") || (cmbCleaveBattleCry == "Always"))));

                case Precheck.Avatar:
                    return ((WoW.UseCooldowns && cmbSTAvatar == "CD Toggle") ||
                            (WoW.TargetIsBoss && cmbSTAvatar == "OnBoss") || (cmbSTAvatar == "Always"));

                case Precheck.Trinkets:
                    return ((WoW.UseCooldowns && cmbSTTrinkets == "CD Toggle") ||
                            (WoW.TargetIsBoss && cmbSTTrinkets == "OnBoss") || (cmbSTTrinkets == "Always"));
                case Precheck.OdynsFury:
                    return ((WoW.UseCooldowns && cmbSTOdynsFury == "CD Toggle") ||
                            (WoW.TargetIsBoss && cmbSTOdynsFury == "OnBoss") || (cmbSTOdynsFury == "Always"));
        ...
        private static bool OdynsFuryTargets
        {
            get {
                return Convert.ToInt32(numSTOdynsFuryTargets) <= WoW.CurrentEnemyUnitCount; 
            }
        }   
        ...
        public void CDRotation()
        {
            ...
            if (SpellCast("Rampage", (HasAura(Auras.Massacre) && AuraRemaining(Auras.Enrage) < 1))) return;
            //actions.cooldowns +=/ bloodthirst,if= target.health.pct < 20 & buff.enrage.remains < 1
            if (SpellCast("Bloodthirst", (Power(Unit.TargetHP) < 20 && AuraRemaining(Auras.Enrage) < 1))) return;
            //actions.cooldowns +=/ execute
            if (SpellCast("Execute", (HasAura(Auras.StoneHeart) || (Power(Unit.TargetHP) < 20 && (HasAura(Auras.SenseDeath) || Power(Unit.Rage) >= 25))))) return;
            //actions.cooldowns +=/ raging_blow,if= talent.inner_rage.enabled & buff.enrage.up
            if (SpellCast("RagingBlow", (HasTalent(Talent.InnerRage) && HasAura(Auras.Enrage)))) return;
            ...
            if (SpellCast("Rampage", ((Power(Unit.Rage) >= 85 || HasAura(Auras.Massacre)) &&
                ((Power(Unit.Rage) >= 100 && HasTalent(Talent.FrothingBerserker) && !HasSet(Bonus.T21Four)) ||
                 HasSet(Bonus.T21Four) || !HasTalent(Talent.FrothingBerserker))))) return;
            //actions.cooldowns +=/ odyns_fury,if= buff.enrage.up & (cooldown.raging_blow.remains > 0 | !talent.inner_rage.enabled)
            if (SpellCast("OdynsFury", ((PreCheck(Precheck.OdynsFury) && OdynsFuryTargets) &&
                (HasAura(Auras.Enrage) && (SpellCD(Spells.RagingBlow) > 0 || !HasTalent(Talent.InnerRage)))))) return;
            //actions.cooldowns +=/ berserker_rage,if= talent.outburst.enabled & buff.enrage.down & buff.battle_cry.up
            if (SpellCast("BerserkerRage",
                (HasTalent(Talent.Outburst) && !HasAura(Auras.Enrage) && HasAura(Auras.BattleCry)))) return;
            //actions.cooldowns +=/ bloodthirst,if= (buff.enrage.remains < 1 & !talent.outburst.enabled) | !talent.inner_rage.enabled
            if (SpellCast("Bloodthirst",((AuraRemaining(Auras.Enrage) < 1 && !HasTalent(Talent.Outburst)) || !HasTalent(Talent.InnerRage)))) return;
            //actions.cooldowns +=/ whirlwind,if= buff.wrecking_ball.react & buff.enrage.up
            if (SpellCast("Whirlwind",(HasAura(Auras.WreckingBall) && HasAura(Auras.Enrage)))) return;
            //actions.cooldowns +=/ raging_blow
            if (SpellCast("RagingBlow", (HasTalent(Talent.InnerRage) || HasAura(Auras.Enrage)))) return;
            //actions.cooldowns +=/ bloodthirst
            if (SpellCast("Bloodthirst")) return;
            //actions.cooldowns +=/ furious_slash
            if (SpellCast("FuriousSlash")) return;
        }

        #endregion

        #region ExecuteRotation

        public void ExecuteRotation()
        {
            //actions.execute = bloodthirst,if= buff.fujiedas_fury.up & buff.fujiedas_fury.remains < 2
            if (SpellCast("Bloodthirst",
                (HasAura(Auras.FujiedasFury) && AuraRemaining(Auras.FujiedasFury) < 2))) return;
            ...
            if (SpellCast("Execute",((HasAura(Auras.SenseDeath) || HasAura(Auras.StoneHeart) || Power(Unit.Rage) >= 25) && ((!HasAura(Auras.Juggernaut) || AuraRemaining(Auras.Juggernaut) < 2) || HasAura(Auras.StoneHeart))))) return;
            //actions.execute +=/ furious_slash,if= talent.frenzy.enabled & buff.frenzy.remains <= 2
            if(SpellCast("FuriousSlash",(HasTalent(Talent.Frenzy) && AuraRemaining(Auras.Frenzy) <= 2))) return;
            //actions.execute +=/ rampage,if= buff.massacre.react & buff.enrage.remains < 1
            if (SpellCast("Rampage",(HasAura(Auras.Massacre) && AuraRemaining(Auras.Enrage) < 1))) return;
            //actions.execute +=/ execute
            if (SpellCast("Execute", (HasAura(Auras.SenseDeath) || HasAura(Auras.StoneHeart) || Power(Unit.Rage) >= 25))) return;
            //actions.execute +=/ odyns_fury
            if (SpellCast("OdynsFury")) return;
            //actions.execute +=/ bloodthirst
            if (SpellCast("Bloodthirst")) return;
            //actions.execute +=/ furious_slash,if= set_bonus.tier19_2pc
            if (SpellCast("FuriousSlash", HasSet(Bonus.T19Two))) return;
        ...
        public void AOERotation()
        {
            ...
            if (SpellCast("Bloodthirst",(!HasAura(Auras.Enrage) || Power(Unit.Rage) < 90))) return;

            if (SpellCast("OdynsFury", ((PreCheck(Precheck.OdynsFury) && OdynsFuryTargets)))) return;
            ...
            if (SpellCast("Bladestorm", (HasTalent(Talent.Bladestorm) && AuraRemaining(Auras.Enrage) > 2))) return;
            //actions.aoe +=/ whirlwind,if= buff.meat_cleaver.down
            if (SpellCast("Whirlwind", (!HasAura(Auras.MeatCleaver))))
            ...
            if (SpellCast("Rampage", ((Power(Unit.Rage) >= 85 || HasAura(Auras.Massacre)) && (HasAura(Auras.MeatCleaver) && (!HasAura(Auras.Enrage) && !HasTalent(Talent.FrothingBerserker) || HasAura(Auras.Massacre) || Power(Unit.Rage) >= 100))))) return;
            //actions.aoe +=/ bloodthirst
            if (SpellCast("Bloodthirst")) return;
            //actions.aoe +=/ whirlwind
            if (SpellCast("Whirlwind")) return;
        }

        #endregion

        #region ThreeTargetRotation

        public void ThreeTargetRotation()
        {
            //actions.three_targets = execu`te,if= buff.stone_heart.react
            if (SpellCast("Execute", HasAura(Auras.StoneHeart))) return;
            ...
            if (SpellCast("Rampage", ((Power(Unit.Rage) >= 85 || HasAura(Auras.Massacre)) && (HasAura(Auras.MeatCleaver) && ((!HasAura(Auras.Enrage) && !HasTalent(Talent.FrothingBerserker)) || (Power(Unit.Rage) >= 100 && HasTalent(Talent.FrothingBerserker))) || HasAura(Auras.Massacre))))) return;
            //actions.three_targets +=/ raging_blow,if= talent.inner_rage.enabled
            if (SpellCast("RagingBlow",HasTalent(Talent.InnerRage))) return;
        ...
        public void STRotation()
        {
            ...
            if (SpellCast("Rampage", ((Power(Unit.Rage) >= 85 || HasAura(Auras.Massacre)) && (Power(Unit.TargetHP) > 21 && (Power(Unit.Rage) >= 100 || !HasTalent(Talent.FrothingBerserker)) && (((SpellCD(Spells.BattleCry) > 5 || SpellCD(Spells.Bloodbath) > 5) && !HasTalent(Talent.Carnage)) || ((SpellCD(Spells.BattleCry) > 3 || SpellCD(Spells.Bloodbath) > 3) && HasTalent(Talent.Carnage))) || HasAura(Auras.Massacre))))) return;
            ...
            if (SpellCast("Execute",(HasAura(Auras.StoneHeart) && ((HasTalent(Talent.InnerRage) && SpellCD(Spells.RagingBlow) > 1) || HasAura(Auras.Enrage))))) return;
            //actions.single_target +=/ bloodthirst
            if (SpellCast("Bloodthirst")) return;
            //actions.single_target +=/ furious_slash,if= set_bonus.tier19_2pc & !talent.inner_rage.enabled
            if (SpellCast("FuriousSlash",(HasSet(Bonus.T19Two) && !HasTalent(Talent.InnerRage)))) return;
        ...
        public override void Pulse()
        {
            ...
            if ((Player(Status.TargetBoss) || !Player(Status.TargetBoss)) && Player(Status.InCombat) && Player(Status.TargetEnemy) && !Player(Status.IsChanneling) && WoW.IsSpellInRange("Bloodthirst"))
            {
                ...
                if (SpellCast("DragonRoar",
                    (HasTalent(Talent.DragonRoar) && ((HasItem(Item.ConvergenceofFates) && SpellCD(Spells.BattleCry) < 2) ||
                     !HasItem(Item.ConvergenceofFates) &&
                     (SpellCD(Spells.BattleCry) > 10 || SpellCD(Spells.BattleCry) < 2) ||
                     (HasTalent(Talent.Bloodbath) &&
                      (SpellCD(Spells.Bloodbath) < 1 || HasAura(Auras.Bloodbath))))))) return;
                //actions +=/ rampage,if= cooldown.battle_cry.remains < 1 & cooldown.bloodbath.remains < 1 & target.health.pct > 20
                if (SpellCast("Rampage",((Power(Unit.Rage) >= 85 || HasAura(Auras.Massacre)) &&
                    (SpellCD(Spells.BattleCry) < 1 && SpellCD(Spells.Bloodbath) < 1 &&
                     Power(Unit.TargetHP) > 20)))) return;
                ...
                if (SpellCast("FuriousSlash",
                    (HasTalent(Talent.Frenzy) && (AuraStacks(Auras.Frenzy) < 3 || AuraRemaining(Auras.Frenzy) < 3 ||
                                                  (SpellCD(Spells.BattleCry) < 1 && AuraRemaining(Auras.Frenzy) < 9)))))
                    return;
                ...
                if (SpellCast("Bloodthirst",
                    (HasItem(Item.KazzalaxFujiedasFury) && !HasAura(Auras.FujiedasFury)))) return;
                ...
                if (SpellCast("Avatar", (PreCheck(Precheck.Avatar) && ((PreCheck(Precheck.BattleCry) && (AuraRemaining(Auras.BattleCry) > 5 || SpellCD(Spells.BattleCry) < 12)) || !PreCheck(Precheck.BattleCry))))) return;
                ...
                if (SpellCast("BattleCry", (PreCheck(Precheck.BattleCry) &&
                    (HasTalent(Talent.RecklessAbandon) && !HasTalent(Talent.Bloodbath) &&
                     (HasItem(Item.UmbralMoonglaives) && (WoW.PlayerItemCooldownRemaining("UmbralMoonglaives") > 3 &&
                                                          WoW.PlayerItemCooldownRemaining("UmbralMoonglaives") < 90) ||
                      !HasItem(Item.UmbralMoonglaives)))))) return;
                ...
                if (SpellCast("BattleCry", (PreCheck(Precheck.BattleCry) &&
                    (HasTalent(Talent.Bladestorm) && SpellCD(Spells.Bladestorm) == 0 &&
                     Power(Unit.EnemyCount) >= 4)))) return;
                ...
                if (SpellCast("BattleCry", (PreCheck(Precheck.BattleCry) &&
                    (HasAura(Auras.DragonRoar) && (SpellCD(Spells.Bloodthirst) == 0 ||
                                                   AuraRemaining(Auras.Enrage) > SpellCD(Spells.Bloodthirst)))))) return;
                ...
                if (SpellCast("BattleCry", (PreCheck(Precheck.BattleCry) &&
                    ((WoW.IsSpellOnGCD("FuriousSlash") || WoW.PlayerWasLastCastedSpell("Rampage")) &&
                     (SpellCD(Spells.Bloodbath) == 0 || HasAura(Auras.Bloodbath) || !HasTalent(Talent.Bloodbath)) &&
                     (HasItem(Item.UmbralMoonglaives) && (WoW.PlayerItemCooldownRemaining("UmbralMoonglaives") > 3 &&
                                                          WoW.PlayerItemCooldownRemaining("UmbralMoonglaives") < 90) ||
                      !HasItem(Item.UmbralMoonglaives)))))) return;
                //actions +=/ bloodbath,if= buff.battle_cry.up | (target.time_to_die < 14) | (cooldown.battle_cry.remains < 2 & prev_gcd.1.rampage)
                if (SpellCast("Bloodbath",
                    (HasTalent(Talent.Bloodbath) && (HasAura(Auras.BattleCry) ||
                    (SpellCD(Spells.BattleCry) < 2 && WoW.PlayerWasLastCastedSpell("Rampage")))))) return;
                //actions +=/ blood_fury,if= buff.battle_cry.up
                if (SpellCast("BloodFury", (PlayerRace(Race.Orc) && HasAura(Auras.BattleCry)))) return;
                //actions +=/ berserking,if= (buff.battle_cry.up & (buff.avatar.up | !talent.avatar.enabled)) | (buff.battle_cry.up & target.time_to_die < 40)
                if (SpellCast("Berserking",
                    (PlayerRace(Race.Troll) && HasAura(Auras.BattleCry) &&
                     (HasAura(Auras.Avatar) || !HasTalent(Talent.Avatar))))) return;
                //actions +=/ arcane_torrent,if= rage < rage.max - 40
                if (SpellCast("ArcaneTorrent", (PlayerRace(Race.BloodElf) && Power(Unit.Rage) < 60))) return;
                //actions +=/ run_action_list,name = cooldowns,if= buff.battle_cry.up & spell_targets.whirlwind = 1
                if(HasAura(Auras.BattleCry) && Power(Unit.EnemyCount) <= 1) CDRotation();
                //actions +=/ run_action_list,name = three_targets,if= target.health.pct > 20 & (spell_targets.whirlwind = 3 | spell_targets.whirlwind = 4)
                if(Power(Unit.TargetHP) > 20 && (Power(Unit.EnemyCount) == 3 || Power(Unit.EnemyCount) == 4)) ThreeTargetRotation();
                //actions +=/ run_action_list,name = aoe,if= spell_targets.whirlwind > 4
                if(Power(Unit.EnemyCount) > 4) AOERotation();
                //actions +=/ run_action_list,name = execute,if= target.health.pct < 20
                if(Power(Unit.TargetHP) < 20) ExecuteRotation();
                //actions +=/ run_action_list,name = single_target,if= target.health.pct > 20
                if(Power(Unit.TargetHP) > 20) STRotation();
            }
        }

        private void ExampleDefensive()
        {
        }
        ...
        public class EnragedFuryInterface : Form
        {
            ...
            public EnragedFuryInterface()
            {
                this.buttonsaveandclose = new System.Windows.Forms.Button();
                this.lblSTBattleCry = new System.Windows.Forms.Label();
                this.numSTOdynsFuryTargets = new System.Windows.Forms.NumericUpDown();
                this.PictureBox1 = new System.Windows.Forms.PictureBox();
                this._groupST = new System.Windows.Forms.GroupBox();
                this.lblOdynsFuryTargets = new System.Windows.Forms.Label();
                this.lblSTOdynsFury = new System.Windows.Forms.Label();
                this.cmbSTBattleCry = new System.Windows.Forms.ComboBox();
                this.cmbSTOdynsFury = new System.Windows.Forms.ComboBox();
                this.cmbSTAvatar = new System.Windows.Forms.ComboBox();
                this.lblSTAvatar = new System.Windows.Forms.Label();
                this.cmbSTTrinkets = new System.Windows.Forms.ComboBox();
                this.lblSTTrinkets = new System.Windows.Forms.Label();
                this.groupAOE = new System.Windows.Forms.GroupBox();
                this.cmbAOETrinkets = new System.Windows.Forms.ComboBox();
                this.lblAOETrinkets = new System.Windows.Forms.Label();
                this.cmbAOEAvatar = new System.Windows.Forms.ComboBox();
                this.lblAOEAvatar = new System.Windows.Forms.Label();
                this.cmbAOEOdynsFury = new System.Windows.Forms.ComboBox();
                this.lblAOEOdynsFury = new System.Windows.Forms.Label();
                this.lblAOEOdynsFuryTargets = new System.Windows.Forms.Label();
                this.numAOEOdynsFuryTargets = new System.Windows.Forms.NumericUpDown();
                this.cmbAOEBattleCry = new System.Windows.Forms.ComboBox();
                this.lblAOEBattleCry = new System.Windows.Forms.Label();
                this.groupCleave = new System.Windows.Forms.GroupBox();
                this.cmbCleaveTrinkets = new System.Windows.Forms.ComboBox();
                this.lblCleaveTrinkets = new System.Windows.Forms.Label();
                this.cmbCleaveAvatar = new System.Windows.Forms.ComboBox();
                this.lblCleaveAvatar = new System.Windows.Forms.Label();
                this.cmbCleaveOdynsFury = new System.Windows.Forms.ComboBox();
                this.lblCleaveOdynsFury = new System.Windows.Forms.Label();
                this.lblCleaveOdynsFuryTargets = new System.Windows.Forms.Label();
                this.numCleaveOdynsFuryTargets = new System.Windows.Forms.NumericUpDown();
                this.cmbCleaveBattleCry = new System.Windows.Forms.ComboBox();
                this.lblCleaveBattleCry = new System.Windows.Forms.Label();
                ((System.ComponentModel.ISupportInitialize)(this.numSTOdynsFuryTargets)).BeginInit();
                ((System.ComponentModel.ISupportInitialize)(this.PictureBox1)).BeginInit();
                this._groupST.SuspendLayout();
                this.groupAOE.SuspendLayout();
                ((System.ComponentModel.ISupportInitialize)(this.numAOEOdynsFuryTargets)).BeginInit();
                this.groupCleave.SuspendLayout();
                ((System.ComponentModel.ISupportInitialize)(this.numCleaveOdynsFuryTargets)).BeginInit();
                this.SuspendLayout();
                // 
                // buttonsaveandclose
                // 
                this.buttonsaveandclose.Location = new System.Drawing.Point(638, 332);
                this.buttonsaveandclose.Name = "buttonsaveandclose";
                this.buttonsaveandclose.Size = new System.Drawing.Size(117, 23);
                ...
                // lblSTBattleCry
                // 
                this.lblSTBattleCry.AutoSize = true;
                this.lblSTBattleCry.BackColor = System.Drawing.Color.Transparent;
                this.lblSTBattleCry.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblSTBattleCry.ForeColor = System.Drawing.SystemColors.Control;
                this.lblSTBattleCry.Location = new System.Drawing.Point(9, 25);
                this.lblSTBattleCry.Name = "lblSTBattleCry";
                this.lblSTBattleCry.Size = new System.Drawing.Size(58, 15);
                this.lblSTBattleCry.TabIndex = 12;
                this.lblSTBattleCry.Text = "Battle Cry";
                // 
                // numSTOdynsFuryTargets
                // 
                this.numSTOdynsFuryTargets.Location = new System.Drawing.Point(129, 85);
                this.numSTOdynsFuryTargets.Name = "numSTOdynsFuryTargets";
                this.numSTOdynsFuryTargets.Size = new System.Drawing.Size(63, 21);
                this.numSTOdynsFuryTargets.TabIndex = 0;
                // 
                // PictureBox1
                // 
                ...
                this.PictureBox1.Size = new System.Drawing.Size(765, 127);
                this.PictureBox1.TabIndex = 23;
                this.PictureBox1.TabStop = false;
                // 
                // _groupST
                // 
                this._groupST.Controls.Add(this.cmbSTTrinkets);
                this._groupST.Controls.Add(this.lblSTTrinkets);
                this._groupST.Controls.Add(this.cmbSTAvatar);
                this._groupST.Controls.Add(this.lblSTAvatar);
                this._groupST.Controls.Add(this.cmbSTOdynsFury);
                this._groupST.Controls.Add(this.lblSTOdynsFury);
                this._groupST.Controls.Add(this.lblOdynsFuryTargets);
                this._groupST.Controls.Add(this.numSTOdynsFuryTargets);
                this._groupST.Controls.Add(this.cmbSTBattleCry);
                this._groupST.Controls.Add(this.lblSTBattleCry);
                this._groupST.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this._groupST.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
                this._groupST.Location = new System.Drawing.Point(32, 139);
                this._groupST.Name = "_groupST";
                this._groupST.Size = new System.Drawing.Size(230, 175);
                this._groupST.TabIndex = 21;
                this._groupST.TabStop = false;
                this._groupST.Text = "Rotation: Single Target";
                // 
                // lblOdynsFuryTargets
                // 
                this.lblOdynsFuryTargets.AutoSize = true;
                this.lblOdynsFuryTargets.BackColor = System.Drawing.Color.Transparent;
                this.lblOdynsFuryTargets.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblOdynsFuryTargets.ForeColor = System.Drawing.SystemColors.Control;
                this.lblOdynsFuryTargets.Location = new System.Drawing.Point(9, 87);
                this.lblOdynsFuryTargets.Name = "lblOdynsFuryTargets";
                this.lblOdynsFuryTargets.Size = new System.Drawing.Size(114, 15);
                this.lblOdynsFuryTargets.TabIndex = 20;
                this.lblOdynsFuryTargets.Text = "Odyn\'s Fury Targets";
                // 
                // lblSTOdynsFury
                // 
                this.lblSTOdynsFury.AutoSize = true;
                this.lblSTOdynsFury.BackColor = System.Drawing.Color.Transparent;
                this.lblSTOdynsFury.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblSTOdynsFury.ForeColor = System.Drawing.SystemColors.Control;
                this.lblSTOdynsFury.Location = new System.Drawing.Point(9, 59);
                this.lblSTOdynsFury.Name = "lblSTOdynsFury";
                this.lblSTOdynsFury.Size = new System.Drawing.Size(70, 15);
                this.lblSTOdynsFury.TabIndex = 21;
                this.lblSTOdynsFury.Text = "Odyn\'s Fury";
                // 
                // cmbSTBattleCry
                // 
                this.cmbSTBattleCry.FormattingEnabled = true;
                this.cmbSTBattleCry.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbSTBattleCry.Location = new System.Drawing.Point(129, 22);
                this.cmbSTBattleCry.Name = "cmbSTBattleCry";
                this.cmbSTBattleCry.Size = new System.Drawing.Size(80, 23);
                this.cmbSTBattleCry.TabIndex = 19;
                // 
                // cmbSTOdynsFury
                // 
                this.cmbSTOdynsFury.FormattingEnabled = true;
                this.cmbSTOdynsFury.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbSTOdynsFury.Location = new System.Drawing.Point(129, 54);
                this.cmbSTOdynsFury.Name = "cmbSTOdynsFury";
                this.cmbSTOdynsFury.Size = new System.Drawing.Size(80, 23);
                this.cmbSTOdynsFury.TabIndex = 22;
                // 
                // cmbSTAvatar
                // 
                this.cmbSTAvatar.FormattingEnabled = true;
                this.cmbSTAvatar.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbSTAvatar.Location = new System.Drawing.Point(129, 112);
                this.cmbSTAvatar.Name = "cmbSTAvatar";
                this.cmbSTAvatar.Size = new System.Drawing.Size(80, 23);
                this.cmbSTAvatar.TabIndex = 25;
                // 
                // lblSTAvatar
                // 
                this.lblSTAvatar.AutoSize = true;
                this.lblSTAvatar.BackColor = System.Drawing.Color.Transparent;
                this.lblSTAvatar.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblSTAvatar.ForeColor = System.Drawing.SystemColors.Control;
                this.lblSTAvatar.Location = new System.Drawing.Point(9, 116);
                this.lblSTAvatar.Name = "lblSTAvatar";
                this.lblSTAvatar.Size = new System.Drawing.Size(40, 15);
                this.lblSTAvatar.TabIndex = 24;
                this.lblSTAvatar.Text = "Avatar";
                // 
                // cmbSTTrinkets
                // 
                this.cmbSTTrinkets.FormattingEnabled = true;
                this.cmbSTTrinkets.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbSTTrinkets.Location = new System.Drawing.Point(129, 141);
                this.cmbSTTrinkets.Name = "cmbSTTrinkets";
                this.cmbSTTrinkets.Size = new System.Drawing.Size(80, 23);
                this.cmbSTTrinkets.TabIndex = 27;
                // 
                // lblSTTrinkets
                // 
                this.lblSTTrinkets.AutoSize = true;
                this.lblSTTrinkets.BackColor = System.Drawing.Color.Transparent;
                this.lblSTTrinkets.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblSTTrinkets.ForeColor = System.Drawing.SystemColors.Control;
                this.lblSTTrinkets.Location = new System.Drawing.Point(9, 145);
                this.lblSTTrinkets.Name = "lblSTTrinkets";
                this.lblSTTrinkets.Size = new System.Drawing.Size(80, 15);
                this.lblSTTrinkets.TabIndex = 26;
                this.lblSTTrinkets.Text = "Trinkets (NYI)";
                // 
                // groupAOE
                // 
                this.groupAOE.Controls.Add(this.cmbAOETrinkets);
                this.groupAOE.Controls.Add(this.lblAOETrinkets);
                this.groupAOE.Controls.Add(this.cmbAOEAvatar);
                this.groupAOE.Controls.Add(this.lblAOEAvatar);
                this.groupAOE.Controls.Add(this.cmbAOEOdynsFury);
                this.groupAOE.Controls.Add(this.lblAOEOdynsFury);
                this.groupAOE.Controls.Add(this.lblAOEOdynsFuryTargets);
                this.groupAOE.Controls.Add(this.numAOEOdynsFuryTargets);
                this.groupAOE.Controls.Add(this.cmbAOEBattleCry);
                this.groupAOE.Controls.Add(this.lblAOEBattleCry);
                this.groupAOE.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.groupAOE.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
                this.groupAOE.Location = new System.Drawing.Point(268, 139);
                this.groupAOE.Name = "groupAOE";
                this.groupAOE.Size = new System.Drawing.Size(230, 175);
                this.groupAOE.TabIndex = 28;
                this.groupAOE.TabStop = false;
                this.groupAOE.Text = "Rotation: AOE";
                // 
                // cmbAOETrinkets
                // 
                this.cmbAOETrinkets.FormattingEnabled = true;
                this.cmbAOETrinkets.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbAOETrinkets.Location = new System.Drawing.Point(129, 141);
                this.cmbAOETrinkets.Name = "cmbAOETrinkets";
                this.cmbAOETrinkets.Size = new System.Drawing.Size(80, 23);
                this.cmbAOETrinkets.TabIndex = 27;
                // 
                // lblAOETrinkets
                // 
                this.lblAOETrinkets.AutoSize = true;
                this.lblAOETrinkets.BackColor = System.Drawing.Color.Transparent;
                this.lblAOETrinkets.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblAOETrinkets.ForeColor = System.Drawing.SystemColors.Control;
                this.lblAOETrinkets.Location = new System.Drawing.Point(9, 145);
                this.lblAOETrinkets.Name = "lblAOETrinkets";
                this.lblAOETrinkets.Size = new System.Drawing.Size(80, 15);
                this.lblAOETrinkets.TabIndex = 26;
                this.lblAOETrinkets.Text = "Trinkets (NYI)";
                // 
                // cmbAOEAvatar
                // 
                this.cmbAOEAvatar.FormattingEnabled = true;
                this.cmbAOEAvatar.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbAOEAvatar.Location = new System.Drawing.Point(129, 112);
                this.cmbAOEAvatar.Name = "cmbAOEAvatar";
                this.cmbAOEAvatar.Size = new System.Drawing.Size(80, 23);
                this.cmbAOEAvatar.TabIndex = 25;
                // 
                // lblAOEAvatar
                // 
                this.lblAOEAvatar.AutoSize = true;
                this.lblAOEAvatar.BackColor = System.Drawing.Color.Transparent;
                this.lblAOEAvatar.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblAOEAvatar.ForeColor = System.Drawing.SystemColors.Control;
                this.lblAOEAvatar.Location = new System.Drawing.Point(9, 116);
                this.lblAOEAvatar.Name = "lblAOEAvatar";
                this.lblAOEAvatar.Size = new System.Drawing.Size(40, 15);
                this.lblAOEAvatar.TabIndex = 24;
                this.lblAOEAvatar.Text = "Avatar";
                // 
                // cmbAOEOdynsFury
                // 
                this.cmbAOEOdynsFury.FormattingEnabled = true;
                this.cmbAOEOdynsFury.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbAOEOdynsFury.Location = new System.Drawing.Point(129, 54);
                this.cmbAOEOdynsFury.Name = "cmbAOEOdynsFury";
                this.cmbAOEOdynsFury.Size = new System.Drawing.Size(80, 23);
                this.cmbAOEOdynsFury.TabIndex = 22;
                // 
                // lblAOEOdynsFury
                // 
                this.lblAOEOdynsFury.AutoSize = true;
                this.lblAOEOdynsFury.BackColor = System.Drawing.Color.Transparent;
                this.lblAOEOdynsFury.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblAOEOdynsFury.ForeColor = System.Drawing.SystemColors.Control;
                this.lblAOEOdynsFury.Location = new System.Drawing.Point(9, 59);
                this.lblAOEOdynsFury.Name = "lblAOEOdynsFury";
                this.lblAOEOdynsFury.Size = new System.Drawing.Size(70, 15);
                this.lblAOEOdynsFury.TabIndex = 21;
                this.lblAOEOdynsFury.Text = "Odyn\'s Fury";
                // 
                // lblAOEOdynsFuryTargets
                // 
                this.lblAOEOdynsFuryTargets.AutoSize = true;
                this.lblAOEOdynsFuryTargets.BackColor = System.Drawing.Color.Transparent;
                this.lblAOEOdynsFuryTargets.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblAOEOdynsFuryTargets.ForeColor = System.Drawing.SystemColors.Control;
                this.lblAOEOdynsFuryTargets.Location = new System.Drawing.Point(9, 87);
                this.lblAOEOdynsFuryTargets.Name = "lblAOEOdynsFuryTargets";
                this.lblAOEOdynsFuryTargets.Size = new System.Drawing.Size(114, 15);
                this.lblAOEOdynsFuryTargets.TabIndex = 20;
                this.lblAOEOdynsFuryTargets.Text = "Odyn\'s Fury Targets";
                // 
                // numAOEOdynsFuryTargets
                // 
                this.numAOEOdynsFuryTargets.Location = new System.Drawing.Point(129, 85);
                this.numAOEOdynsFuryTargets.Name = "numAOEOdynsFuryTargets";
                this.numAOEOdynsFuryTargets.Size = new System.Drawing.Size(63, 21);
                this.numAOEOdynsFuryTargets.TabIndex = 0;
                // 
                // cmbAOEBattleCry
                // 
                this.cmbAOEBattleCry.FormattingEnabled = true;
                this.cmbAOEBattleCry.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbAOEBattleCry.Location = new System.Drawing.Point(129, 22);
                this.cmbAOEBattleCry.Name = "cmbAOEBattleCry";
                this.cmbAOEBattleCry.Size = new System.Drawing.Size(80, 23);
                this.cmbAOEBattleCry.TabIndex = 19;
                // 
                // lblAOEBattleCry
                // 
                this.lblAOEBattleCry.AutoSize = true;
                this.lblAOEBattleCry.BackColor = System.Drawing.Color.Transparent;
                this.lblAOEBattleCry.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblAOEBattleCry.ForeColor = System.Drawing.SystemColors.Control;
                this.lblAOEBattleCry.Location = new System.Drawing.Point(9, 25);
                this.lblAOEBattleCry.Name = "lblAOEBattleCry";
                this.lblAOEBattleCry.Size = new System.Drawing.Size(58, 15);
                this.lblAOEBattleCry.TabIndex = 12;
                this.lblAOEBattleCry.Text = "Battle Cry";
                // 
                // groupCleave
                // 
                this.groupCleave.Controls.Add(this.cmbCleaveTrinkets);
                this.groupCleave.Controls.Add(this.lblCleaveTrinkets);
                this.groupCleave.Controls.Add(this.cmbCleaveAvatar);
                this.groupCleave.Controls.Add(this.lblCleaveAvatar);
                this.groupCleave.Controls.Add(this.cmbCleaveOdynsFury);
                this.groupCleave.Controls.Add(this.lblCleaveOdynsFury);
                this.groupCleave.Controls.Add(this.lblCleaveOdynsFuryTargets);
                this.groupCleave.Controls.Add(this.numCleaveOdynsFuryTargets);
                this.groupCleave.Controls.Add(this.cmbCleaveBattleCry);
                this.groupCleave.Controls.Add(this.lblCleaveBattleCry);
                this.groupCleave.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.groupCleave.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
                this.groupCleave.Location = new System.Drawing.Point(504, 139);
                this.groupCleave.Name = "groupCleave";
                this.groupCleave.Size = new System.Drawing.Size(230, 175);
                this.groupCleave.TabIndex = 29;
                this.groupCleave.TabStop = false;
                this.groupCleave.Text = "Rotation: Cleave";
                // 
                // cmbCleaveTrinkets
                // 
                this.cmbCleaveTrinkets.FormattingEnabled = true;
                this.cmbCleaveTrinkets.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbCleaveTrinkets.Location = new System.Drawing.Point(129, 141);
                this.cmbCleaveTrinkets.Name = "cmbCleaveTrinkets";
                this.cmbCleaveTrinkets.Size = new System.Drawing.Size(80, 23);
                this.cmbCleaveTrinkets.TabIndex = 27;
                // 
                // lblCleaveTrinkets
                // 
                this.lblCleaveTrinkets.AutoSize = true;
                this.lblCleaveTrinkets.BackColor = System.Drawing.Color.Transparent;
                this.lblCleaveTrinkets.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblCleaveTrinkets.ForeColor = System.Drawing.SystemColors.Control;
                this.lblCleaveTrinkets.Location = new System.Drawing.Point(9, 145);
                this.lblCleaveTrinkets.Name = "lblCleaveTrinkets";
                this.lblCleaveTrinkets.Size = new System.Drawing.Size(80, 15);
                this.lblCleaveTrinkets.TabIndex = 26;
                this.lblCleaveTrinkets.Text = "Trinkets (NYI)";
                // 
                // cmbCleaveAvatar
                // 
                this.cmbCleaveAvatar.FormattingEnabled = true;
                this.cmbCleaveAvatar.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbCleaveAvatar.Location = new System.Drawing.Point(129, 112);
                this.cmbCleaveAvatar.Name = "cmbCleaveAvatar";
                this.cmbCleaveAvatar.Size = new System.Drawing.Size(80, 23);
                this.cmbCleaveAvatar.TabIndex = 25;
                // 
                // lblCleaveAvatar
                // 
                this.lblCleaveAvatar.AutoSize = true;
                this.lblCleaveAvatar.BackColor = System.Drawing.Color.Transparent;
                this.lblCleaveAvatar.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblCleaveAvatar.ForeColor = System.Drawing.SystemColors.Control;
                this.lblCleaveAvatar.Location = new System.Drawing.Point(9, 116);
                this.lblCleaveAvatar.Name = "lblCleaveAvatar";
                this.lblCleaveAvatar.Size = new System.Drawing.Size(40, 15);
                this.lblCleaveAvatar.TabIndex = 24;
                this.lblCleaveAvatar.Text = "Avatar";
                // 
                // cmbCleaveOdynsFury
                // 
                this.cmbCleaveOdynsFury.FormattingEnabled = true;
                this.cmbCleaveOdynsFury.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbCleaveOdynsFury.Location = new System.Drawing.Point(129, 54);
                this.cmbCleaveOdynsFury.Name = "cmbCleaveOdynsFury";
                this.cmbCleaveOdynsFury.Size = new System.Drawing.Size(80, 23);
                this.cmbCleaveOdynsFury.TabIndex = 22;
                // 
                // lblCleaveOdynsFury
                // 
                this.lblCleaveOdynsFury.AutoSize = true;
                this.lblCleaveOdynsFury.BackColor = System.Drawing.Color.Transparent;
                this.lblCleaveOdynsFury.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblCleaveOdynsFury.ForeColor = System.Drawing.SystemColors.Control;
                this.lblCleaveOdynsFury.Location = new System.Drawing.Point(9, 59);
                this.lblCleaveOdynsFury.Name = "lblCleaveOdynsFury";
                this.lblCleaveOdynsFury.Size = new System.Drawing.Size(70, 15);
                this.lblCleaveOdynsFury.TabIndex = 21;
                this.lblCleaveOdynsFury.Text = "Odyn\'s Fury";
                // 
                // lblCleaveOdynsFuryTargets
                // 
                this.lblCleaveOdynsFuryTargets.AutoSize = true;
                this.lblCleaveOdynsFuryTargets.BackColor = System.Drawing.Color.Transparent;
                this.lblCleaveOdynsFuryTargets.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblCleaveOdynsFuryTargets.ForeColor = System.Drawing.SystemColors.Control;
                this.lblCleaveOdynsFuryTargets.Location = new System.Drawing.Point(9, 87);
                this.lblCleaveOdynsFuryTargets.Name = "lblCleaveOdynsFuryTargets";
                this.lblCleaveOdynsFuryTargets.Size = new System.Drawing.Size(114, 15);
                this.lblCleaveOdynsFuryTargets.TabIndex = 20;
                this.lblCleaveOdynsFuryTargets.Text = "Odyn\'s Fury Targets";
                // 
                // numCleaveOdynsFuryTargets
                // 
                this.numCleaveOdynsFuryTargets.Location = new System.Drawing.Point(129, 85);
                this.numCleaveOdynsFuryTargets.Name = "numCleaveOdynsFuryTargets";
                this.numCleaveOdynsFuryTargets.Size = new System.Drawing.Size(63, 21);
                this.numCleaveOdynsFuryTargets.TabIndex = 0;
                // 
                // cmbCleaveBattleCry
                // 
                this.cmbCleaveBattleCry.FormattingEnabled = true;
                this.cmbCleaveBattleCry.Items.AddRange(new object[] {
            "Always",
            "OnBoss",
            "CD Toggle",
            "Off"});
                this.cmbCleaveBattleCry.Location = new System.Drawing.Point(129, 22);
                this.cmbCleaveBattleCry.Name = "cmbCleaveBattleCry";
                this.cmbCleaveBattleCry.Size = new System.Drawing.Size(80, 23);
                this.cmbCleaveBattleCry.TabIndex = 19;
                // 
                // lblCleaveBattleCry
                // 
                this.lblCleaveBattleCry.AutoSize = true;
                this.lblCleaveBattleCry.BackColor = System.Drawing.Color.Transparent;
                this.lblCleaveBattleCry.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.lblCleaveBattleCry.ForeColor = System.Drawing.SystemColors.Control;
                this.lblCleaveBattleCry.Location = new System.Drawing.Point(9, 25);
                this.lblCleaveBattleCry.Name = "lblCleaveBattleCry";
                this.lblCleaveBattleCry.Size = new System.Drawing.Size(58, 15);
                this.lblCleaveBattleCry.TabIndex = 12;
                this.lblCleaveBattleCry.Text = "Battle Cry";
                // 
                // ExampleInterface
                // 
                ...
                this.Controls.Add(this.groupCleave);
                this.Controls.Add(this.groupAOE);
                this.Controls.Add(this._groupST);
                this.Controls.Add(this.PictureBox1);
                this.Controls.Add(this.buttonsaveandclose);
                this.ForeColor = System.Drawing.SystemColors.ControlText;
                this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
                this.Name = "ExampleInterface";
                this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
                this.Text = "Savage";
                ((System.ComponentModel.ISupportInitialize)(this.numSTOdynsFuryTargets)).EndInit();
                ((System.ComponentModel.ISupportInitialize)(this.PictureBox1)).EndInit();
                this._groupST.ResumeLayout(false);
                this._groupST.PerformLayout();
                this.groupAOE.ResumeLayout(false);
                this.groupAOE.PerformLayout();
                ((System.ComponentModel.ISupportInitialize)(this.numAOEOdynsFuryTargets)).EndInit();
                this.groupCleave.ResumeLayout(false);
                this.groupCleave.PerformLayout();
                ((System.ComponentModel.ISupportInitialize)(this.numCleaveOdynsFuryTargets)).EndInit();
                this.ResumeLayout(false);

            }

            public Button buttonsaveandclose;
            private Label lblSTBattleCry;
            public PictureBox PictureBox1;
            public NumericUpDown numSTOdynsFuryTargets;
            private GroupBox _groupST;
            private Label lblSTOdynsFury;
            private Label lblOdynsFuryTargets;
            public ComboBox cmbSTBattleCry;
            public ComboBox cmbSTTrinkets;
            private Label lblSTTrinkets;
            public ComboBox cmbSTAvatar;
            private Label lblSTAvatar;
            public ComboBox cmbSTOdynsFury;
            private GroupBox groupAOE;
            public ComboBox cmbAOETrinkets;
            private Label lblAOETrinkets;
            public ComboBox cmbAOEAvatar;
            private Label lblAOEAvatar;
            public ComboBox cmbAOEOdynsFury;
            private Label lblAOEOdynsFury;
            private Label lblAOEOdynsFuryTargets;
            public NumericUpDown numAOEOdynsFuryTargets;
            public ComboBox cmbAOEBattleCry;
            private Label lblAOEBattleCry;
            private GroupBox groupCleave;
            public ComboBox cmbCleaveTrinkets;
            private Label lblCleaveTrinkets;
            public ComboBox cmbCleaveAvatar;
            private Label lblCleaveAvatar;
            public ComboBox cmbCleaveOdynsFury;
            private Label lblCleaveOdynsFury;
            private Label lblCleaveOdynsFuryTargets;
            public NumericUpDown numCleaveOdynsFuryTargets;
            public ComboBox cmbCleaveBattleCry;
            private Label lblCleaveBattleCry;
...
[SpellBook.db]
Spell,69179,ArcaneTorrent,D1
Spell,107574,Avatar,D1
Spell,1719,BattleCry,D1
Spell,18499,BerserkerRage,D1
Spell,26297,Berserking,D1
Spell,46924,Bladestorm,D1
Spell,12292,Bloodbath,D1
Spell,20572,BloodFury,D1
Spell,23881,Bloodthirst,D1
Spell,118000,DragonRoar,D1
Spell,5308,Execute,D1
Spell,100130,FuriousSlash,D1
Spell,205545,OdynsFury,D1
Spell,85288,RagingBlow,D1
Spell,184367,Rampage,D1
Spell,46968,Shockwave,D1
Spell,190411,Whirlwind,D1
Range,23881,Bloodthirst
Item,140806,ConvergenceofFates,D1
Item,147012,UmbralMoonglaives,D1
Item,137053,KazzalaxFujiedasFury,D1
Buff,85739,MeatCleaverAura
Buff,118000,DragonRoarAura
Buff,1719,BattleCryAura
Buff,107574,AvatarAura
Buff,184362,EnrageAura
Buff,215570,WreckingBallAura
Buff,201009,JuggernautAura
Buff,206316,MassacreAura
Buff,200979,SenseDeathAura
Buff,225947,StoneHeartAura
Buff,215572,FrothingBerserkerAura
Buff,202539,FrenzyAura
Buff,207775,FujiedasFuryAura
Buff,225141,FelCrazedRageAura
Buff,242953,BloodyRageAura
Buff,242300,RagingThirstAura
Buff,12292,BloodbathAura
*/
