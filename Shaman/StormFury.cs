...
{
    public class StormFury : CombatRoutine
    {
        #region Startup
        ...
        {
            get { return "StormFury - Enhance Shaman - version:" + _versionnumber; }
        }
        ...
        public override void Initialize()
        {
            ...
            Interface = new StormFuryInterface();
        ...
        private StormFuryInterface Interface { get; set; }
        ...
        {
            WriteLog("StormFury by Bash - v" + _versionnumber);
        ...
        private static bool HasItem(Items item)
        {
            switch (item)
            {
                case Items.Akainu: return false/*WoW.IsItemOnCooldown("ExampleItem")*/;
        ...
        private static bool HasTalent(Talents talent)
        {
            switch (talent)
            {
                case Talents.Windsong: return WoW.Talent(1) == 1;
                case Talents.HotHand: return WoW.Talent(1) == 2;
                case Talents.Landslide: return WoW.Talent(1) == 3;
                case Talents.Rainfall: return WoW.Talent(2) == 1;
                case Talents.FeralLunge: return WoW.Talent(2) == 2;
                case Talents.WindRushTotem: return WoW.Talent(2) == 3;
                case Talents.LightningSurgeTotem: return WoW.Talent(3) == 1;
                case Talents.EarthgrabTotem: return WoW.Talent(3) == 2;
                case Talents.VoodooTotem: return WoW.Talent(3) == 3;
                case Talents.LightningShield: return WoW.Talent(4) == 1;
                case Talents.AncestralSwiftness: return WoW.Talent(4) == 2;
                case Talents.Hailstorm: return WoW.Talent(4) == 3;
                case Talents.Tempest: return WoW.Talent(5) == 1;
                case Talents.Overcharge: return WoW.Talent(5) == 2;
                case Talents.EmpoweredStormlash: return WoW.Talent(5) == 3;
                case Talents.CrashingStorm: return WoW.Talent(6) == 1;
                case Talents.FuryofAir: return WoW.Talent(6) == 2;
                case Talents.Sundering: return WoW.Talent(6) == 3;
                case Talents.Ascendance: return WoW.Talent(7) == 1;
                case Talents.Boulderfist: return WoW.Talent(7) == 2;
                case Talents.EarthenSpike: return WoW.Talent(7) == 3;
                default: return false;
            }
        }
        ...
        private static bool HasAura(Auras aura)
        {
            switch (aura)
            {
                case Auras.LandslideAura: return WoW.PlayerHasBuff("Landslide");
                case Auras.FuryofAirAura: return false;
                case Auras.FlametongueAura: return WoW.PlayerHasBuff("Flametongue");
                case Auras.FrostbrandAura: return WoW.PlayerHasBuff("Frostbrand");
                case Auras.AscendanceAura: return WoW.PlayerHasBuff("Ascendance");
                case Auras.CrashLightningAura: return WoW.PlayerHasBuff("Crash Lightning");
                case Auras.StormbringerAura: return WoW.PlayerHasBuff("Stormbringer");
                case Auras.HotHandAura: return WoW.PlayerHasBuff("Hot Hand");
                case Auras.LightningCrashAura: return WoW.PlayerHasBuff("Lightning Crash");
                case Auras.EarthenSpikeAura: return WoW.TargetHasDebuff("Earthen Spike");
                default: return false;
            }
        }
        ...
        private static int AuraRemaining(Auras aura)
        {
            switch (aura)
            {
                case Auras.LandslideAura: return WoW.PlayerBuffTimeRemaining("Landslide");
                case Auras.FuryofAirAura: return 0;
                case Auras.FlametongueAura: return WoW.PlayerBuffTimeRemaining("Flametongue");
                case Auras.FrostbrandAura: return WoW.PlayerBuffTimeRemaining("Frostbrand");
                case Auras.AscendanceAura: return WoW.PlayerBuffTimeRemaining("Ascendance");
                case Auras.CrashLightningAura: return WoW.PlayerBuffTimeRemaining("Crash Lightning");
                case Auras.StormbringerAura: return WoW.PlayerBuffTimeRemaining("Stormbringer");
                case Auras.HotHandAura: return WoW.PlayerBuffTimeRemaining("Hot Hand");
                case Auras.LightningCrashAura: return WoW.PlayerBuffTimeRemaining("Lightning Crash");
                case Auras.EarthenSpikeAura: return WoW.TargetDebuffTimeRemaining("Earthen Spike");
                default: return 0;
            }
        }
        ...
        private static int AuraStacks(Auras aura)
        {
            switch (aura)
            {
                //case Auras.ExampleBuff: return WoW.PlayerBuffStacks("ExampleBuff");
                //case Auras.ExampleDebuff: return WoW.TargetDebuffStacks("ExampleDebuff");
                default: return 0;
            }
        }
        ...
        private static int SpellCharges(Spells spell)
        {
            switch (spell)
            {
                case Spells.Rockbiter: return WoW.PlayerSpellCharges("Rockbiter");
                default: return 0;
            }
        }
        ...
        #region SpecialBool
        private static bool SpecialBool(SpecialVariable variable)
        {
            switch (variable)
            {
                //actions+=/variable,name=hailstormCheck,value=((talent.hailstorm.enabled&!buff.frostbrand.up)|!talent.hailstorm.enabled)
                case SpecialVariable.HailstormCheck: return ((HasTalent(Talents.Hailstorm) && !HasAura(Auras.FrostbrandAura)) || !HasTalent(Talents.Hailstorm));
                //actions+=/variable,name=furyCheck80,value=(!talent.fury_of_air.enabled|(talent.fury_of_air.enabled&maelstrom>80))
                case SpecialVariable.FuryCheck80: return (!HasTalent(Talents.FuryofAir) || (HasTalent(Talents.FuryofAir) && Power(Powers.Maelstrom) > 80));
                //actions+=/variable,name=furyCheck70,value=(!talent.fury_of_air.enabled|(talent.fury_of_air.enabled&maelstrom>70))
                case SpecialVariable.FuryCheck70: return (!HasTalent(Talents.FuryofAir) || (HasTalent(Talents.FuryofAir) && Power(Powers.Maelstrom) > 70));
                //actions+=/variable,name=furyCheck45,value=(!talent.fury_of_air.enabled|(talent.fury_of_air.enabled&maelstrom>45))
                case SpecialVariable.FuryCheck45: return (!HasTalent(Talents.FuryofAir) || (HasTalent(Talents.FuryofAir) && Power(Powers.Maelstrom) > 45));
                //actions+=/variable,name=furyCheck25,value=(!talent.fury_of_air.enabled|(talent.fury_of_air.enabled&maelstrom>25))
                case SpecialVariable.FuryCheck25: return (!HasTalent(Talents.FuryofAir) || (HasTalent(Talents.FuryofAir) && Power(Powers.Maelstrom) > 25));
                //actions+=/variable,name=OCPool70,value=(!talent.overcharge.enabled|(talent.overcharge.enabled&maelstrom>70))
                case SpecialVariable.OCPool70: return (!HasTalent(Talents.Overcharge) || (HasTalent(Talents.Overcharge) && Power(Powers.Maelstrom) > 70));
                //actions+=/variable,name=OCPool60,value=(!talent.overcharge.enabled|(talent.overcharge.enabled&maelstrom>60))
                case SpecialVariable.OCPool60: return (!HasTalent(Talents.Overcharge) || (HasTalent(Talents.Overcharge) && Power(Powers.Maelstrom) > 60));
                ...
                case SpecialVariable.AkainuAS: return (HasItem(Items.Akainu) && HasAura(Auras.HotHandAura) && !HasAura(Auras.FrostbrandAura));
                //actions+=/variable,name=LightningCrashNotUp,value=(!buff.lightning_crash.up&set_bonus.tier20_2pc)
                case SpecialVariable.LightningCrashNotUp: return (!HasAura(Auras.LightningCrashAura) && HasSetBonus(SetBonus.T20TwoSet));
                ...
                //case "AlphaWolfCheck": return (WoW.PetBuffTimeRemaining("AlphaWolfAura") < 2 && );
                case SpecialVariable.StrikeCD: return (WoW.CanCast("Windstrike") || WoW.CanCast ("Stormstrike"));
                default: return false;
            }
        }
        #endregion
        ...
        {
            get { var ExampleCombo = ConfigFile.ReadValue("StormFury", "ExampleCombo"); try { return ExampleCombo; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("StormFury", "ExampleCombo", value); }
        }
        ...
        {
            get { var ExampleNum = ConfigFile.ReadValue("StormFury", "ExampleNum"); try { return ExampleNum; } catch (FormatException) { return ""; } }
            set { ConfigFile.WriteValue("StormFury", "ExampleNum", value); }
        }
        ...
        {
            get { var ExampleCheck = ConfigFile.ReadValue("StormFury", "ExampleCheck").Trim(); return ExampleCheck != "" && Convert.ToBoolean(ExampleCheck); }
            set { ConfigFile.WriteValue("StormFury", "ExampleCheck", value.ToString()); }
        }
        ...
        {
            get { return ConfigFile.ReadValue<string>("StormFury", "ExampleCombo"); }
        }
        private static int ExampleNumConfig
        {
            get { return ConfigFile.ReadValue<int>("StormFury", "ExampleNum"); }
        }
        private static bool ExampleCheckConfig
        {
            get { return ConfigFile.ReadValue<bool>("StormFury", "ExampleCheck"); }
        }
        ...
        private static int Power(Powers unit)
        {
            switch (unit)
            {
                case Powers.Astral: return WoW.CurrentAstralPower;
                case Powers.Chi: return WoW.CurrentChi;
                case Powers.ComboPoints: return WoW.CurrentComboPoints;
                case Powers.Energy: return WoW.CurrentEnergy;
                case Powers.Focus: return WoW.CurrentFocus;
                case Powers.Holy: return WoW.CurrentHolyPower;
                case Powers.Maelstrom: return WoW.CurrentMaelstrom;
                case Powers.Mana: return WoW.CurrentMana;
                case Powers.Pain: return WoW.CurrentPain;
                case Powers.Power: return WoW.CurrentPower;
                case Powers.Rage: return WoW.CurrentRage;
                case Powers.Runes: return WoW.CurrentRunes;
                case Powers.Runic: return WoW.CurrentRunicPower;
                case Powers.SoulShards: return WoW.CurrentSoulShards;
                case Powers.TargetHP: return WoW.TargetHealthPercent;
                case Powers.PlayerHP: return WoW.PlayerHealthPercent;
                default: return 0;
            }
        }
        ...
        private static bool PlayerRace(Races race)
        {
            switch (race)
            {
                case Races.Tauren: return WoW.PlayerRace == "Tauren";
                case Races.Troll: return WoW.PlayerRace == "Troll";
                case Races.Human: return WoW.PlayerRace == "Human";
                case Races.Dwarf: return WoW.PlayerRace == "Dwarf";
                case Races.NightElf: return WoW.PlayerRace == "NightElf";
                case Races.Gnome: return WoW.PlayerRace == "Gnome";
                case Races.Draenei: return WoW.PlayerRace == "Draenei";
                case Races.Pandaren: return WoW.PlayerRace == "Pandaren";
                case Races.Orc: return WoW.PlayerRace == "Orc";
                case Races.Undead: return WoW.PlayerRace == "Undead";
                case Races.BloodElf: return WoW.PlayerRace == "BloodElf";
                case Races.Goblin: return WoW.PlayerRace == "Goblin";
                case Races.Worgen: return WoW.PlayerRace == "Worgen";
                default: return false;
            }
        }
        ...
        private static bool HasSetBonus(SetBonus set)
        {
            switch (set)
            {
                case SetBonus.T19TwoSet: return WoW.SetBonus(19) >= 2;
                case SetBonus.T19FourSet: return WoW.SetBonus(19) >= 4;
                case SetBonus.T20TwoSet: return WoW.SetBonus(20) >= 2;
                case SetBonus.T20FourSet: return WoW.SetBonus(20) >= 4;
                case SetBonus.T21TwoSet: return WoW.SetBonus(21) >= 2;
                case SetBonus.T21FourSet: return WoW.SetBonus(21) >= 4;
                default: return false;
            }
        }
        ...
        {
            get { return WoW.CurrentEnemyUnitCount; }
        }
        ...
        public void StormFuryAsc()
        {
            //actions.asc=earthen_spike
            SpellCast("Earthen Spike");
            //actions.asc+=/doom_winds,if=cooldown.strike.up
            SpellCast("Doom Winds",SpecialBool(SpecialVariable.StrikeCD));
            //actions.asc+=/windstrike
            SpellCast("Windstrike");
        }
        ...
        public void StormFuryOpener()
        {
            //actions.opener=rockbiter,if=maelstrom<15&time<gcd
            SpellCast("Rockbiter",(Power(Powers.Maelstrom) < 15 && CombatSec < CurrentGlobalCooldown));
        }
        ...
        public void StormFuryCore()
        {
            //actions.core+=/crash_lightning,if=!buff.crash_lightning.up&active_enemies>=2
            SpellCast("Crash Lightning",(!HasAura(Auras.CrashLightningAura) && active_enemies >= 2));
            //actions.core+=/windsong
            SpellCast("Windsong");
            //actions.core+=/crash_lightning,if=active_enemies>=8|(active_enemies>=6&talent.crashing_storm.enabled)
            SpellCast("Crash Lightning", (active_enemies >= 8 || (active_enemies >= 6 && HasTalent(Talents.CrashingStorm))));
            //actions.core+=/windstrike
            SpellCast("Windstrike");
            //actions.core+=/stormstrike,if=buff.stormbringer.up&variable.furyCheck25
            SpellCast("Stormstrike",(HasAura(Auras.StormbringerAura) && SpecialBool(SpecialVariable.FuryCheck25)));
            //actions.core+=/crash_lightning,if=active_enemies>=4|(active_enemies>=2&talent.crashing_storm.enabled)
            SpellCast("Crash Lightning",(active_enemies >= 4 || (active_enemies >= 2 && HasTalent(Talents.CrashingStorm))));
            //actions.core+=/lightning_bolt,if=talent.overcharge.enabled&variable.furyCheck45&maelstrom>=40
            SpellCast("Lightning Bolt",(HasTalent(Talents.Overcharge) && SpecialBool(SpecialVariable.FuryCheck45) && Power(Powers.Maelstrom) >= 40));
            ...
            SpellCast("Stormstrike",((!HasTalent(Talents.Overcharge) && SpecialBool(SpecialVariable.FuryCheck45)) || (HasTalent(Talents.Overcharge) && SpecialBool(SpecialVariable.FuryCheck80))));
            //actions.core+=/frostbrand,if=variable.akainuAS
            SpellCast("Frostbrand",SpecialBool(SpecialVariable.AkainuAS));
            //actions.core+=/lava_lash,if=buff.hot_hand.react&((variable.akainuEquipped&buff.frostbrand.up)|!variable.akainuEquipped)
            SpellCast("Lava Lash", (HasAura(Auras.HotHandAura) && ((HasItem(Items.Akainu) && HasAura(Auras.FrostbrandAura)) || !HasItem(Items.Akainu))));
            //actions.core+=/sundering,if=active_enemies>=3
            SpellCast("Sundering", active_enemies >= 3);
            //actions.core+=/crash_lightning,if=active_enemies>=3|variable.LightningCrashNotUp|variable.alphaWolfCheck
            SpellCast("Crash Lightning", (active_enemies >= 3 || SpecialBool(SpecialVariable.LightningCrashNotUp)/* || SpecialVariable("AlphaWolfCheck")*/));
        }
        ...
        public void StormFuryBuffs()
        {
            //actions.buffs=rockbiter,if=talent.landslide.enabled&!buff.landslide.up
            SpellCast("Rockbiter", (HasTalent(Talents.Landslide) && !HasAura(Auras.LandslideAura)));
            //actions.buffs+=/fury_of_air,if=!ticking&maelstrom>22
            SpellCast("Fury of Air", (HasTalent(Talents.FuryofAir) && !HasAura(Auras.FuryofAirAura) && Power(Powers.Maelstrom) > 22));
            //actions.buffs+=/crash_lightning,if=artifact.alpha_wolf.rank&prev_gcd.1.feral_spirit
            //SpellCast("Crash Lightning", SpecialBool(SpecialVariable.AlphaWolf) && PrevGCD == "Feral Spirit");
            //actions.buffs+=/flametongue,if=!buff.flametongue.up
            SpellCast("Flametongue", !HasAura(Auras.FlametongueAura));
            //actions.buffs+=/frostbrand,if=talent.hailstorm.enabled&!buff.frostbrand.up&variable.furyCheck45
            SpellCast("Frostbrand", (HasTalent(Talents.Hailstorm) && !HasAura(Auras.FrostbrandAura) && SpecialBool(SpecialVariable.FuryCheck45)));
            //actions.buffs+=/flametongue,if=buff.flametongue.remains<6+gcd&cooldown.doom_winds.remains<gcd*2
            SpellCast("Flametongue", (AuraRemaining(Auras.FlametongueAura) < 6 + CurrentGlobalCooldown && WoW.PlayerCooldownTimeRemaining("Doom Winds") < CurrentGlobalCooldown * 2));
            //actions.buffs+=/frostbrand,if=talent.hailstorm.enabled&buff.frostbrand.remains<6+gcd&cooldown.doom_winds.remains<gcd*2
            SpellCast("Frostbrand", (HasTalent(Talents.Hailstorm) && AuraRemaining(Auras.FrostbrandAura) < 6 + CurrentGlobalCooldown && WoW.PlayerCooldownTimeRemaining("Doom Winds") < CurrentGlobalCooldown * 2));
        }
        ...
        public void StormFuryFiller()
        {
            //actions.filler=rockbiter,if=maelstrom<120
            SpellCast("Rockbiter", Power(Powers.Maelstrom) < 120);
            //actions.filler+=/flametongue,if=buff.flametongue.remains<4.8
            SpellCast("Flametongue", AuraRemaining(Auras.FlametongueAura) < 4.8);
            ...
            SpellCast("Crash Lightning", ((HasTalent(Talents.CrashingStorm) || active_enemies >= 2) && HasAura(Auras.EarthenSpikeAura) && Power(Powers.Maelstrom) >= 40 && SpecialBool(SpecialVariable.OCPool60)));
            //actions.filler+=/frostbrand,if=talent.hailstorm.enabled&buff.frostbrand.remains<4.8&maelstrom>40
            SpellCast("Frostbrand", (HasTalent(Talents.Hailstorm) && AuraRemaining(Auras.FrostbrandAura) < 4.8 && Power(Powers.Maelstrom) > 40));
            //actions.filler+=/frostbrand,if=variable.akainuEquipped&!buff.frostbrand.up&maelstrom>=75
            SpellCast("Frostbrand", (HasItem(Items.Akainu) && !HasAura(Auras.FrostbrandAura) && Power(Powers.Maelstrom) >= 75));
            //actions.filler+=/sundering
            SpellCast("Sundering");
            //actions.filler+=/lava_lash,if=maelstrom>=50&variable.OCPool70&variable.furyCheck80
            SpellCast("Lava Lash", (Power(Powers.Maelstrom) >= 50 && SpecialBool(SpecialVariable.OCPool70) && SpecialBool(SpecialVariable.FuryCheck80)));
            ...
            SpellCast("Crash Lightning", ((Power(Powers.Maelstrom) >= 65 || HasTalent(Talents.CrashingStorm) || active_enemies >= 2) && SpecialBool(SpecialVariable.OCPool60) && SpecialBool(SpecialVariable.FuryCheck45)));
            //actions.filler+=/flametongue
            SpellCast("Flametongue");
        }
        ...
        public override void Pulse()
        {
            ...
            if ((WoW.TargetIsBoss || !WoW.TargetIsBoss) && WoW.PlayerIsInCombat && WoW.TargetIsEnemy && WoW.IsSpellInRange("Rockbiter"))
            {
                StormFuryOpener();
                if (HasAura(Auras.AscendanceAura)){StormFuryAsc();}
                StormFuryBuffs();
                StormFuryCDs();
                StormFuryCore();
                StormFuryFiller();
        ...
        private void StormFuryDefensive()
        {
        }
        ...
        public class StormFuryInterface : Form
        {
            /// <summary>
            ...
            public StormFuryInterface()
            {
                this.buttonsaveandclose = new System.Windows.Forms.Button();
                this.ExampleLabel = new System.Windows.Forms.Label();
                this.ExampleCombo = new System.Windows.Forms.ComboBox();
                this.ExampleNum = new System.Windows.Forms.NumericUpDown();
                this.PictureBox1 = new System.Windows.Forms.PictureBox();
                this._groupBox1 = new System.Windows.Forms.GroupBox();
                this.ExampleCheck = new System.Windows.Forms.CheckBox();
                ((System.ComponentModel.ISupportInitialize)(this.ExampleNum)).BeginInit();
                ...
                this.ExampleLabel.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.ExampleLabel.ForeColor = System.Drawing.SystemColors.Control;
                this.ExampleLabel.Location = new System.Drawing.Point(6, 37);
                this.ExampleLabel.Name = "ExampleLabel";
                this.ExampleLabel.Size = new System.Drawing.Size(87, 15);
                this.ExampleLabel.TabIndex = 12;
                this.ExampleLabel.Text = "ExampleLabel";
                // 
                // ExampleCombo
                // 
                this.ExampleCombo.FormattingEnabled = true;
                this.ExampleCombo.Items.AddRange(new object[] {
            "Always",
            "Never",
            "OnBoss"});
                this.ExampleCombo.Location = new System.Drawing.Point(152, 104);
                this.ExampleCombo.Name = "ExampleCombo";
                this.ExampleCombo.Size = new System.Drawing.Size(80, 23);
                this.ExampleCombo.TabIndex = 19;
                // 
                // ExampleNum
                // 
                this.ExampleNum.Location = new System.Drawing.Point(169, 59);
                this.ExampleNum.Name = "ExampleNum";
                this.ExampleNum.Size = new System.Drawing.Size(63, 21);
                this.ExampleNum.TabIndex = 0;
                // 
                // PictureBox1
                // 
                ...
                // _groupBox1
                // 
                this._groupBox1.Controls.Add(this.ExampleNum);
                this._groupBox1.Controls.Add(this.ExampleLabel);
                this._groupBox1.Controls.Add(this.ExampleCheck);
                this._groupBox1.Controls.Add(this.ExampleCombo);
                this._groupBox1.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this._groupBox1.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
                this._groupBox1.Location = new System.Drawing.Point(262, 139);
                this._groupBox1.Name = "_groupBox1";
                this._groupBox1.Size = new System.Drawing.Size(249, 193);
                this._groupBox1.TabIndex = 21;
                this._groupBox1.TabStop = false;
                this._groupBox1.Text = "Example GroupBox";
                // 
                // ExampleCheck
                // 
                this.ExampleCheck.AutoSize = true;
                this.ExampleCheck.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                this.ExampleCheck.ForeColor = System.Drawing.SystemColors.Control;
                this.ExampleCheck.Location = new System.Drawing.Point(5, 142);
                this.ExampleCheck.Name = "ExampleCheck";
                this.ExampleCheck.Size = new System.Drawing.Size(130, 19);
                this.ExampleCheck.TabIndex = 1;
                this.ExampleCheck.Text = "ExampleCheckBox";
                ...
                this.Text = "Savage";
                ((System.ComponentModel.ISupportInitialize)(this.ExampleNum)).EndInit();
...
[SpellBook.db]
Spell,187874,Crash Lightning,NumPad1
Spell,193796,Flametongue,NumPad2
Spell,60103,Lava Lash,NumPad3
Spell,187837,Lightning Bolt,NumPad4
Spell,193786,Rockbiter,NumPad5
Spell,17364,Stormstrike,NumPad6
Spell,115356,Windstrike,NumPad6
Spell,201898,Windsong,NumPad7
Spell,192106,Lightning Shield,NumPad8
Spell,197211,Fury of Air,NumPad9
Spell,197214,Sundering,NumPad9
Spell,114051,Ascendance,NumPad0
Spell,188089,Earthen Spike,NumPad0
Spell,51533,Feral Spirit,Subtract
Spell,196834,Frostbrand,Multiply
Spell,2825,Bloodlust,F1
Spell,204945,Doom Winds,F2
Buff,202004,Landslide
Buff,194084,Flametongue
Buff,196834,Frostbrand
Buff,114051,Ascendance
Buff,187878,Crash Lightning
Buff,201846,Stormbringer
Buff,215785,Hot Hand
Buff,242284,Lightning Crash
Debuff,188089,Earthen Spike
Range,187837,Lightning Bolt,NumPad4
Range,193786,Rockbiter,NumPad5
Charge,193786,Rockbiter
*/
