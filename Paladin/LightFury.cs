...
{
    public class LightFury : CombatRoutine
    {
        #region Startup
        ...
        {
            get { return "LightFury - Paladin Routine by Bash - version:" + _versionnumber; }
        }
        ...
        public override void Initialize()
        {
            ...
            Interface = new LightFuryInterface();
        ...
        private LightFuryInterface Interface { get; set; }
        ...
        {
            WriteLog("LightFury - Paladin Routine by Bash - v" + _versionnumber);
        ...
        private enum Auras
        {
            ...
            Crusade,
            DivinePurpose,
            ScarletInquisitorsExpurgation,
            LiadrinsFuryUnleashed,
            Bloodlust,
            Judgment,
            Exhaustion
        }
        ...
        private static bool HasTalent(Talent talent)
        {
            switch (talent)
            {
                case Talent.FinalVerdict: return WoW.Talent(1) == 1;
                case Talent.ExecutionSentence: return WoW.Talent(1) == 2;
                case Talent.Consecration: return WoW.Talent(1) == 3;
                case Talent.TheFiresofJustice: return WoW.Talent(2) == 1;
                case Talent.Zeal: return WoW.Talent(2) == 2;
                case Talent.GreaterJudgment: return WoW.Talent(2) == 3;
                case Talent.FistofJustice: return WoW.Talent(3) == 1;
                case Talent.Repentance: return WoW.Talent(3) == 2;
                case Talent.BlindingLight: return WoW.Talent(3) == 3;
                case Talent.VirtuesBlade: return WoW.Talent(4) == 1;
                case Talent.BladeofWrath: return WoW.Talent(4) == 2;
                case Talent.DivineHammer: return WoW.Talent(4) == 3;
                case Talent.JusticarsVengeance: return WoW.Talent(5) == 1;
                case Talent.EyeforanEye: return WoW.Talent(5) == 2;
                case Talent.WordofGlory: return WoW.Talent(5) == 3;
                case Talent.DivineIntervention: return WoW.Talent(6) == 1;
                case Talent.Cavalier: return WoW.Talent(6) == 2;
                case Talent.JudgmentofLight: return WoW.Talent(6) == 3;
                case Talent.DivinePurpose: return WoW.Talent(7) == 1;
                case Talent.Crusade: return WoW.Talent(7) == 2;
                case Talent.HolyWrath: return WoW.Talent(7) == 3;
                default: return false;
            }
        }
        ...
        private static bool HasAura(Auras aura)
        {
            switch (aura)
            {
                case Auras.AvengingWrath: return WoW.PlayerHasBuff("AvengingWrathAura");
                case Auras.Crusade: return WoW.PlayerHasBuff("CrusadeAura");
                case Auras.DivinePurpose: return WoW.PlayerHasBuff("DivinePurposeAura");
                case Auras.ScarletInquisitorsExpurgation: return WoW.PlayerHasBuff("ScarletInquisitorsExpurgationAura");
                case Auras.LiadrinsFuryUnleashed: return WoW.PlayerHasBuff("LiadrinsFuryUnleashedAura");
                case Auras.Bloodlust: return WoW.PlayerHasBuff("BloodlustAura");
                case Auras.Judgment: return WoW.TargetHasDebuff("JudgmentAura");
                case Auras.Exhaustion: return WoW.TargetHasDebuff("ExhaustionAura");
                default: return false;
            }
        }
        ...
        private static int AuraRemaining(Auras aura)
        {
            switch (aura)
            {
                case Auras.AvengingWrath: return WoW.PlayerBuffTimeRemaining("AvengingWrathAura");
                case Auras.Crusade: return WoW.PlayerBuffTimeRemaining("CrusadeAura");
                case Auras.DivinePurpose: return WoW.PlayerBuffTimeRemaining("DivinePurposeAura");
                case Auras.ScarletInquisitorsExpurgation: return WoW.PlayerBuffTimeRemaining("ScarletInquisitorsExpurgationAura");
                case Auras.LiadrinsFuryUnleashed: return WoW.PlayerBuffTimeRemaining("LiadrinsFuryUnleashedAura");
                case Auras.Bloodlust: return WoW.PlayerBuffTimeRemaining("BloodlustAura");
                case Auras.Judgment: return WoW.TargetDebuffTimeRemaining("JudgmentAura");
                case Auras.Exhaustion: return WoW.TargetDebuffTimeRemaining("ExhaustionAura");
                default: return 0;
            }
        }
        ...
        private static int AuraStacks(Auras aura)
        {
            switch (aura)
            {
                case Auras.ScarletInquisitorsExpurgation: return WoW.PlayerBuffStacks("ScarletInquisitorsExpurgationAura");
                case Auras.Crusade: return WoW.PlayerBuffStacks("CrusadeAura");
        ...
        private static int SpellCharges(Spells spell)
        {
            switch (spell)
            {
                case Spells.CrusaderStrike: return WoW.PlayerSpellCharges("CrusaderStrikeCharges");
                default: return 0;
            }
        }
        ...
        {
            if (SpellCast("TemplarsVerdict", ((HasAura(Auras.Judgment) && Power(Unit.Holy) >= 3) || (Power(Unit.Holy) == 5 && WoW.PlayerCooldownTimeRemaining("Judgment") > 3)))) return;
            if (SpellCast("WakeofAshes", (HasAura(Auras.Judgment) && Power(Unit.Holy) == 0))) return;
            if (SpellCast("Judgment", (Power(Unit.Holy) == 5))) return;
            if (SpellCast("CrusaderStrike", (Power(Unit.Holy) <= 4  && SpellCharges(Spells.CrusaderStrike) == 2))) return;
            if (SpellCast("BladeofJustice", (Power(Unit.Holy) <= 3))) return;
            if (SpellCast("CrusaderStrike", (Power(Unit.Holy) <= 4))) return;
        ...
        public override void Pulse()
        {
            ...
            if ((Player(Status.TargetBoss) || !Player(Status.TargetBoss)) && Player(Status.InCombat) && Player(Status.TargetEnemy) && WoW.IsSpellInRange("CrusaderStrike"))
            {
                Rotation();
                ExampleDefensive();
            }
        ...
        public class LightFuryInterface : Form
        {
            ...
            public LightFuryInterface()
            {
                System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LightFuryInterface));
...
[SpellBook.db]
Spell,28730,ArcaneTorrent,NumPad1
Spell,26297,Berserking,NumPad1
Spell,184575,BladeofJustice,NumPad1
Spell,33702,BloodFury,NumPad1
Spell,20271,Judgment,NumPad1
Spell,255647,LightsJudgement,NumPad1
Spell,210220,HolyWrath,NumPad1
Spell,184662,ShieldofVengeance,NumPad1
Spell,31884,AvengingWrath,NumPad1
Spell,231895,Crusade,NumPad1
Spell,213757,ExecutionSentence,NumPad1
Spell,53385,DivineStorm,NumPad1
Spell,215661,JusticarsVengeance,NumPad1
Spell,85256,TemplarsVerdict,NumPad1
Spell,198034,DivineHammer,NumPad1
Spell,205273,WakeofAshes,NumPad1
Spell,217020,Zeal,NumPad1
Spell,35395,CrusaderStrike,NumPad1
Spell,205228,Consecration,NumPad1
Spell,853,HammerofJustice,NumPad1
Buff,12472,AvengingWrathAura
Buff,231895,CrusadeAura
Buff,223817,DivinePurposeAura
Buff,248289,ScarletInquisitorsExpurgationAura
Buff,208410,LiadrinsFuryUnleashedAura
Buff,71975,BloodlustAura
Debuff,197277,JudgmentAura
Debuff,80354,ExhaustionAura
Range,35395,CrusaderStrike,NumPad2
Charge,35395,CrusaderStrikeCharges
*/
