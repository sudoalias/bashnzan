...
namespace Pixie.Rotation
{
    public class ShadowFury : CombatRoutine
    {
        ...
        {
            get { return "ShadowFury, Subtlety Rogue rotation - version:" + _versionnumber; }
        }
        ...
        private ShadowFuryInterface Interface { get; set; }
        ...
        private void BuildInterface()
        {
            ...
            //CheckBox Example
            Interface.ExampleCheck.Checked = ExampleCheck;
            Interface.ExampleCheck.CheckedChanged += ExampleCheck_CheckedChanged;
        }
        ...
        private enum Item
        {
            DenialoftheHalfGiants,
            TheFirstoftheDead,
            ShadowSatyrsWalk,
            InsigniaofRavenholdt,
            MantleoftheMasterAssassin
        }
        ...
        private static bool HasItem(Item item)
        {
            switch (item)
            {
                case Item.DenialoftheHalfGiants: return WoW.IsItemEquipped("Denial of the Half-Giants");
                case Item.TheFirstoftheDead: return WoW.IsItemEquipped("TheFirstoftheDead");
                case Item.ShadowSatyrsWalk: return WoW.IsItemEquipped("ShadowSatyrsWalk");
                case Item.InsigniaofRavenholdt: return WoW.IsItemEquipped("InsigniaofRavenholdt");
                case Item.MantleoftheMasterAssassin: return WoW.IsItemEquipped("MantleoftheMasterAssassin");
        ...
        private static bool HasTalent(Talent talent)
        {
            switch (talent)
            {
                case Talent.MasterofSubtlety: return WoW.Talent(1) == 1;
                case Talent.Weaponmaster: return WoW.Talent(1) == 2;
                case Talent.Gloomblade: return WoW.Talent(1) == 3;
                case Talent.Nightstalker: return WoW.Talent(2) == 1;
                case Talent.Subterfuge: return WoW.Talent(2) == 2;
                case Talent.ShadowFocus: return WoW.Talent(2) == 3;
                case Talent.DeeperStratagem: return WoW.Talent(3) == 1;
                case Talent.Anticipation: return WoW.Talent(3) == 2;
                case Talent.Vigor: return WoW.Talent(3) == 3;
                case Talent.SoothingDarkness: return WoW.Talent(4) == 1;
                case Talent.Elusiveness: return WoW.Talent(4) == 2;
                case Talent.CheatDeath: return WoW.Talent(4) == 3;
                case Talent.StrikefromtheShadows: return WoW.Talent(5) == 1;
                case Talent.PreyontheWeak: return WoW.Talent(5) == 2;
                case Talent.TangledShadow: return WoW.Talent(5) == 3;
                case Talent.DarkShadow: return WoW.Talent(6) == 1;
                case Talent.Alacrity: return WoW.Talent(6) == 2;
                case Talent.EnvelopingShadows: return WoW.Talent(6) == 3;
                case Talent.MasterofShadows: return WoW.Talent(7) == 1;
                case Talent.MarkedforDeath: return WoW.Talent(7) == 2;
                case Talent.DeathfromAbove: return WoW.Talent(7) == 3;
                default: return false;
            }
        }
        ...
        private static bool HasAura(Auras aura)
        {
            switch (aura)
            {
                case Auras.Stealth: return WoW.PlayerHasBuff("StealthAura");
                case Auras.ShadowDance: return WoW.PlayerHasBuff("ShadowDanceAura");
                case Auras.ShadowBlades: return WoW.PlayerHasBuff("ShadowBladesAura");
                case Auras.Vanish: return WoW.PlayerHasBuff("VanishAura");
                case Auras.GoremawsBite: return WoW.PlayerHasBuff("GoremawsBiteAura");
                case Auras.SymbolsofDeath: return WoW.PlayerHasBuff("SymbolsofDeathAura");
                case Auras.CrimsonVial: return WoW.PlayerHasBuff("CrimsonVialAura");
                case Auras.ShurikenCombo: return WoW.PlayerHasBuff("ShurikenComboAura");
                case Auras.DeathfromAbove: return WoW.PlayerHasBuff("DeathfromAboveAura");
                case Auras.Nightblade: return WoW.TargetHasDebuff("NightbladeAura");
                case Auras.Subterfuge: return WoW.PlayerHasBuff("SubterfugeAura");
                case Auras.TheFirstoftheDead: return WoW.PlayerHasBuff("TheFirstoftheDeadAura");
                case Auras.TheDreadlordsDeceit: return WoW.PlayerHasBuff("TheDreadlordsDeceitAura");
                case Auras.FinalityEviscerate: return WoW.PlayerHasBuff("FinalityEviscerateAura");
                case Auras.FinalityNightblade: return WoW.PlayerHasBuff("FinalityNightbladeAura");
                case Auras.FeedingFrenzy: return WoW.PlayerHasBuff("FeedingFrenzyAura");
                default: return false;
            }
        }
        ...
        private static int AuraRemaining(Auras aura)
        {
            switch (aura)
            {
                case Auras.Nightblade: return WoW.TargetDebuffTimeRemaining("NightbladeAura");
                case Auras.DeathfromAbove: return WoW.PlayerBuffTimeRemaining("DeathfromAboveAura");
                case Auras.TheFirstoftheDead: return WoW.PlayerBuffTimeRemaining("TheFirstoftheDeadAura");
                case Auras.SymbolsofDeath: return WoW.PlayerBuffTimeRemaining("SymbolsofDeathAura");
        ...
        private static int AuraStacks(Auras aura)
        {
            switch (aura)
            {
                case Auras.TheDreadlordsDeceit: return WoW.PlayerBuffStacks("TheDreadlordsDeceitAura");
        ...
        private static int SpellCD(Spells spell)
        {
            switch (spell)
            {
                case Spells.ShadowDance: return WoW.PlayerSpellChargeTimeRemaining("ShadowDanceCharge");
                case Spells.SymbolsofDeath: return WoW.PlayerCooldownTimeRemaining("Symbols of Death");
                case Spells.GoremawsBite: return WoW.PlayerCooldownTimeRemaining("Goremaws Bite");
                case Spells.DeathfromAbove: return WoW.PlayerCooldownTimeRemaining("Death from Above");
                default: return 0;
            }
        }
        ...
        private static int SpellCharges(Spells spell)
        {
            switch (spell)
            {
                case Spells.ShadowDance: return WoW.PlayerSpellCharges("ShadowDanceCharge");
                case Spells.Shadowstep: return WoW.PlayerSpellCharges("Shadowstep");
                default: return 0;
            }
        }
        ...
        private static bool ExampleCheck
        {
            get { var ExampleCheck = ConfigFile.ReadValue("RoutineName", "ExampleCheck").Trim(); return ExampleCheck != "" && Convert.ToBoolean(ExampleCheck); }
            set { ConfigFile.WriteValue("Savage", "ExampleCheck", value.ToString()); }
        }

        private void ExampleCheck_CheckedChanged(object sender, EventArgs e)
        {
            ExampleCheck = Interface.ExampleCheck.Checked;
        }
        ...
        private static bool ExampleCheckConfig
        {
            get { return ConfigFile.ReadValue<bool>("RoutineName", "ExampleCheck"); }
        }
        ...
        private static bool PreCheck(Precheck ability)
        {
            switch (ability)
            {
                case Precheck.Combat: return (WoW.PlayerHasTarget || WoW.TargetIsBoss) && (WoW.PlayerIsInCombat || HasAura(Auras.Vanish)) && WoW.TargetIsEnemy && WoW.IsSpellInRange("Backstab") && WoW.PlayerHealthPercent > 0;

                case Precheck.RangeCombat: return (WoW.PlayerHasTarget || WoW.TargetIsBoss) && WoW.PlayerIsInCombat && WoW.TargetIsEnemy && WoW.IsSpellInRange("Shuriken Toss") && WoW.PlayerHealthPercent > 0;

                case Precheck.Stealth: return (HasAura(Auras.Stealth) || HasAura(Auras.Vanish) || HasAura(Auras.ShadowDance));

                case Precheck.DSH_DFA: return (HasTalent(Talent.DeathfromAbove) && HasTalent(Talent.DarkShadow) && WoW.CurrentEnemyUnitCount < 4);
                default:
                    return false;
            }
        }
        ...
        private bool SpellCast(string spell, bool condition = true)
        {
            ...
            if (WoW.CanCast(spell))
            {
                if (spell == "Nightblade")
                {
                    if (HasAura(Auras.FinalityNightblade))
                    {
                        finality = true;
                    }
                    if (!HasAura(Auras.FinalityNightblade))
        ...
        private static int ComboPointsMax
        {
            get
            {
                ...
                { return 6; }
                if (HasTalent(Talent.Anticipation))
                { return 10; }
                return 5;
            }
        }
        ...
        private static int StealthThreshold
        {
            get
            {
                return (65 + (Convert.ToInt32(HasTalent(Talent.Vigor)) * 35) + (Convert.ToInt32(HasTalent(Talent.MasterofShadows)) * 10));
            }
        }
        ...
        {
            get { return 1.725 + 0.725 * Convert.ToDouble(HasTalent(Talent.EnvelopingShadows)); }
        }
        private static double SHDCDFractional
        {
            get { return (((60.00 - WoW.PlayerSpellChargeTimeRemaining("ShadowDanceCharge")) / 60.00) + WoW.PlayerSpellCharges("ShadowDanceCharge")); }
        }
        private static int Mantle_Duration
        {
            get {
                if (WoW.PlayerHasBuff("MasterAssassinsInitativeAura")) return 6;
                if (WoW.PlayerHasBuff("MasterAssassinsInitativeAuraSecs")) return WoW.PlayerBuffTimeRemaining("MasterAssassinsInitiativeAuraSecs");
                return 0;
            }
        }
        ...
        private static bool refreshable
        {

            get { return (AuraRemaining(Auras.Nightblade) < nightblade_pandemic(Power(Unit.ComboPoints))); }
        }

        private static double nightblade_pandemic(int CP)
        {
            switch (CP)
            {
                case 0: return 0;
        ...
        public void OpenerRotation()
        {
            //Log.Write("SoD Remaining: " + AuraRemaining(Auras.SymbolsofDeath), Color.Orange);
            if (SpellCast("Nightblade", Power(Unit.ComboPoints) >= 3 && !HasAura(Auras.Nightblade))) return;
            if (SpellCast("Shadow Dance",
                !PreCheck(Precheck.Stealth) && HasAura(Auras.Nightblade) && SpellCharges(Spells.ShadowDance) == 2)) return;
            if (SpellCast("Symbols of Death", HasAura(Auras.Nightblade))) return;
            if (SpellCast("Death from Above",
                !PreCheck(Precheck.Stealth) && Power(Unit.ComboPoints) >= 5 && !HasAura(Auras.TheFirstoftheDead))) return;
            if (SpellCast("Eviscerate", Power(Unit.ComboPoints) >= 4 && HasAura(Auras.Nightblade) && HasAura(Auras.SymbolsofDeath) && AuraRemaining(Auras.SymbolsofDeath) >= 7)) return;
            if (SpellCast("Shadowstrike", PreCheck(Precheck.Stealth) && ComboPointsDeficit > 0)) return;
            if (SpellCast("Backstab", !PreCheck(Precheck.Stealth) && ComboPointsDeficit > 0)) return;
        ...
        public void CDRotation()
        {
            ...
            //actions.cds +=/ use_item,name = specter_of_betrayal,if= talent.dark_shadow.enabled & buff.shadow_dance.up & (!set_bonus.tier20_4pc | buff.symbols_of_death.up | (!talent.death_from_above.enabled & ((mantle_duration >= 3 | !equipped.mantle_of_the_master_assassin) | cooldown.vanish.remains >= 43)))
            ...
            if (SpellCast("Blood Fury", PlayerRace(Race.Orc) && PreCheck(Precheck.Stealth))) return;

            //actions.cds +=/ berserking,if= stealthed.rogue
            if (SpellCast("Berserking", PlayerRace(Race.Troll) && PreCheck(Precheck.Stealth))) return;

            //actions.cds +=/ arcane_torrent,if= stealthed.rogue & energy.deficit > 70
            if (SpellCast("Arcane Torrent", PlayerRace(Race.BloodElf) && ((HasTalent(Talent.Vigor) || Power(Unit.Energy) < 80) || (!HasTalent(Talent.Vigor) && Power(Unit.Energy) < 30)))) return;
            ...
            if (SpellCast("Symbols of Death", !HasTalent(Talent.DeathfromAbove) && ((CombatSec > 10 && EnergyDeficit >= 40 - Convert.ToInt32(PreCheck(Precheck.Stealth))) || (CombatSec < 10 && HasAura(Auras.Nightblade))))) return;
            ...
            if (SpellCast("Symbols of Death", (HasTalent(Talent.DeathfromAbove) && WoW.PlayerCooldownTimeRemaining("Death from Above") <= 3 && (AuraRemaining(Auras.Nightblade) >= WoW.PlayerCooldownTimeRemaining("Death from Above") + 3) && (CombatSec >= 3 || HasSet(Bonus.T20Four))))) return;
            ...
            if (SpellCast("Marked for Death", (HasTalent(Talent.MarkedforDeath) && !PreCheck(Precheck.Stealth) && ComboPointsDeficit >= ComboPointsSpend))) return;
            ...
            //if (SpellCast("Shadow Blades", (CombatSec > 10 && ComboPointsDeficit >= 2 + Convert.ToInt32(PreCheck(Precheck.Stealth))) || (CombatSec < 10 && (!HasTalent(Talent.MarkedforDeath) || ComboPointsDeficit >= 3 || HasAura(Auras.Nightblade))))) return;
            ...
            //Removed combat timer protion due to issues with Goremaw's casting with too many CP
            if (SpellCast("Goremaws Bite", (!PreCheck(Precheck.Stealth) && SHDCDFractional <= SHDFractional && (ComboPointsDeficit >= 4 && EnergyDeficit > 50 + Convert.ToInt32(HasTalent(Talent.Vigor)) * 25)))) return;
...
//            if (SpellCast("Vanish", Power(Unit.Energy) >= 55 - Convert.ToInt32(HasTalent(Talent.ShadowFocus)) * 10 && PreCheck(Precheck.DSH_DFA) && (HasAura(Auras.SymbolsofDeath)) && SHDCDFractional <= SHDFractional && !HasAura(Auras.ShadowDance) && !HasAura(Auras.Stealth) && (AuraRemaining(Auras.Nightblade) >= WoW.PlayerCooldownTimeRemaining("Death from Above") + 6))
        ...
        #region StealthedRotation

        public void StealthedRotation()
        {
            ...
            if (SpellCast("Shadowstrike", HasAura(Auras.Stealth))) return;
            ...
            if (Power(Unit.ComboPoints) >= 5 + Convert.ToInt32(HasTalent(Talent.DeeperStratagem) && HasAura(Auras.Vanish)) && (Power(Unit.EnemyCount) >= 3 + Convert.ToInt32(HasItem(Item.ShadowSatyrsWalk)))) FinishRotation();
            ...
            if (SpellCast("Shuriken Storm", ((ComboPointsDeficit >= 2 + Convert.ToInt32(HasItem(Item.InsigniaofRavenholdt)) && Power(Unit.EnemyCount) >= 3 + Convert.ToInt32(HasItem(Item.ShadowSatyrsWalk))) || (ComboPointsDeficit >= 1 && AuraStacks(Auras.TheDreadlordsDeceit) >= 29)))) return;
            ...
            if (Power(Unit.ComboPoints) >= 5 + Convert.ToInt32(HasTalent(Talent.DeeperStratagem) && HasAura(Auras.Vanish)) && ComboPointsDeficit < 3 + Convert.ToInt32(HasAura(Auras.ShadowBlades)) - Convert.ToInt32(HasItem(Item.MantleoftheMasterAssassin))) FinishRotation();

            //actions.stealthed +=/ shadowstrike
            if (SpellCast("Shadowstrike")) return;

        }
        #endregion

        #region StealthALSRotation

        public void StealthALSRotation()
        {
            ...
            if (EnergyDeficit <= StealthThreshold - 25 * Convert.ToInt32(SpellCD(Spells.GoremawsBite) == 0 && !HasAura(Auras.FeedingFrenzy)) && (!HasItem(Item.ShadowSatyrsWalk) || SHDCDFractional >= SHDFractional || EnergyDeficit >= 10)) StealthCDRotation();
            //actions.stealth_als +=/ call_action_list,name = stealth_cds,if= mantle_duration > 2.3
            if (Mantle_Duration > 2.3) StealthCDRotation();
            //actions.stealth_als +=/ call_action_list,name = stealth_cds,if= spell_targets.shuriken_storm >= 4
            if (Power(Unit.EnemyCount) >= 4) StealthCDRotation();
        ...
        #region StealthCDRotation

        public void StealthCDRotation()
        {
            if (SpellCast("Shadow Dance",
                (!HasAura(Auras.SymbolsofDeath) && AuraRemaining(Auras.Nightblade) > 4 &&
                 (SpellCD(Spells.SymbolsofDeath) > 20 || SpellCD(Spells.DeathfromAbove) > 15) &&
                 SHDCDFractional >= 1.5))) return;
            ...
            if (SpellCast("Shadow Dance", ((SpellCD(Spells.SymbolsofDeath) > 6 || WoW.PlayerCooldownTimeRemaining("Death from Above") > 6) && SHDCDFractional >= SHDFractional && AuraRemaining(Auras.Nightblade) > 4))) return;
            ...
            if (SpellCast("Shadow Dance", (WoW.PlayerCooldownTimeRemaining("Death from Above") > 6 && (!PreCheck(Precheck.DSH_DFA) && ComboPointsDeficit >= 2 + Convert.ToInt32(HasTalent(Talent.Subterfuge)) * 2 && (AuraRemaining(Auras.SymbolsofDeath) >= 1.2 || SpellCD(Spells.SymbolsofDeath) >= 12 + Convert.ToInt32(HasTalent(Talent.DarkShadow) && HasSet(Bonus.T20Four)) * 3 - Convert.ToInt32(!HasTalent(Talent.DarkShadow) && HasSet(Bonus.T20Four)) * 4 || Mantle_Duration > 0) && (Power(Unit.EnemyCount) >= 4 || !HasAura(Auras.TheFirstoftheDead)))))) return;
        }
        #endregion 

        #region Builders
        public void BuilderRotation()
        {
            
            //actions.build = shuriken_storm,if= spell_targets.shuriken_storm >= 2 + buff.the_first_of_the_dead.up
            if (SpellCast("Shuriken Storm", WoW.CurrentEnemyUnitCount >= 2 + Convert.ToInt32(HasAura(Auras.TheFirstoftheDead)))) return;

            //actions.build +=/ gloomblade
            if (SpellCast("Gloomblade", HasTalent(Talent.Gloomblade))) return;

            //actions.build +=/ backstab
            if (SpellCast("Backstab", !HasTalent(Talent.Gloomblade))) return;
        }
        #endregion

        #region FinishRotation
        public void FinishRotation()
        {
            //Log.Write("finality: " + finality, Color.Orange);
            //Log.Write("refreshable: " + refreshable, Color.Orange);
            //Log.Write("tick_time: " + tick_time, Color.Orange);
            //Log.Write("DSH_DFA: " + PreCheck(Precheck.DSH_DFA), Color.Orange);
            ...
            if (SpellCast("Nightblade", (!HasTalent(Talent.DarkShadow) || !HasAura(Auras.ShadowDance))
                                        && (Mantle_Duration == 0 || AuraRemaining(Auras.Nightblade) <= Mantle_Duration)
                                        && ((refreshable && (!finality || HasAura(Auras.FinalityNightblade) || PreCheck(Precheck.DSH_DFA))) || AuraRemaining(Auras.Nightblade) < tick_time * 2)
                                        && (Power(Unit.EnemyCount) < 4 && !PreCheck(Precheck.DSH_DFA) || !HasAura(Auras.SymbolsofDeath)))) return;
            ...
            if (SpellCast("Nightblade",
                ((!HasTalent(Talent.DeathfromAbove) | HasSet(Bonus.T19Two)) &&
                 (!HasTalent(Talent.DarkShadow) || !HasAura(Auras.ShadowDance)) && Mantle_Duration == 0 &&
                 ((refreshable && (!finality || HasAura(Auras.FinalityNightblade) || PreCheck(Precheck.DSH_DFA))) ||
                  AuraRemaining(Auras.Nightblade) < tick_time * 2) &&
                 (Power(Unit.EnemyCount) < 4 && !PreCheck(Precheck.DSH_DFA) ||
                  !HasAura(Auras.SymbolsofDeath))))) return;
            ...
            if (SpellCast("Nightblade", (AuraRemaining(Auras.Nightblade) < SpellCD(Spells.SymbolsofDeath) + 10 
                                         && SpellCD(Spells.SymbolsofDeath) <= 5 + Convert.ToInt32(Power(Unit.ComboPoints) == 6)))) return;
            if (SpellCast("Eviscerate",
                (Power(Unit.ComboPoints) > 3 && WoW.PlayerWasLastCastedSpell("Symbols of Death")))) return;
            ...
            if (SpellCast("Death from Above", (Power(Unit.ComboPoints) >= 5 && (!HasTalent(Talent.DarkShadow) || (!HasAura(Auras.ShadowDance) || Power(Unit.EnemyCount) >= 4) && (HasAura(Auras.SymbolsofDeath) || SpellCD(Spells.SymbolsofDeath) >= 10 + Convert.ToInt32(HasSet(Bonus.T20Four)) * 5) && (HasAura(Auras.FinalityEviscerate) || Power(Unit.EnemyCount) < 4))))) return;
            //actions.finish +=/ eviscerate
            if (SpellCast("Eviscerate")) return;
        }
        #endregion
        ...
        public override void Pulse()
        {
            ...
            if ((Player(Status.TargetBoss) || !Player(Status.TargetBoss)) && Player(Status.InCombat) && Player(Status.TargetEnemy) && WoW.IsSpellInRange("Backstab"))
            {
                //Log.Write("Nightblade Remaining: " + AuraRemaining(Auras.Nightblade), Color.Orange);
                //Log.Write("Shadow Dance CD: " + WoW.PlayerSpellChargeTimeRemaining("ShadowDanceCharge"), Color.Orange);
                //Log.Write("Shadow Dance Charges: " + WoW.PlayerSpellCharges("ShadowDanceCharge"), Color.Orange);
                //Log.Write("Combat Timer: " + CombatSec, Color.Orange);
                ...
                if (SpellCast("Shadow Dance", (HasTalent(Talent.DarkShadow) && !PreCheck(Precheck.Stealth) && (HasAura(Auras.DeathfromAbove) || WoW.PlayerCooldownTimeRemaining("Death from Above") > 16)))) return;
                //Opener for the first 10 seconds of combat
                if (CombatSec < 10.00 && Player(Status.TargetBoss)) OpenerRotation();
                //actions +=/ call_action_list,name = cds
                CDRotation();
                //actions +=/ run_action_list,name = stealthed,if= stealthed.all
                if (PreCheck(Precheck.Stealth)) StealthedRotation();
                ...
                if (HasTalent(Talent.DarkShadow) && ComboPointsDeficit >= 2 + Convert.ToInt32(HasAura(Auras.ShadowBlades)) && (AuraRemaining(Auras.Nightblade) > 4 + Convert.ToInt32(HasTalent(Talent.Subterfuge)) || SHDCDFractional >= 1.9 && (!HasItem(Item.DenialoftheHalfGiants) || CombatSec > 10))) StealthALSRotation();
                ...
                if (!HasTalent(Talent.DarkShadow) && (ComboPointsDeficit >= 2 + Convert.ToInt32(HasAura(Auras.ShadowBlades)) || SHDCDFractional >= 1.9 + Convert.ToInt32(HasTalent(Talent.EnvelopingShadows)))) StealthALSRotation();
                ...
                if (Power(Unit.ComboPoints) >= 5 + 3 * Convert.ToInt32(HasAura(Auras.TheFirstoftheDead)
                                                                       && HasTalent(Talent.Anticipation)) + Convert.ToInt32(HasTalent(Talent.DeeperStratagem)
                                                                                                                            && !HasAura(Auras.ShadowBlades)
                                                                                                                            && (Mantle_Duration == 0 || HasSet(Bonus.T20Four)) 
                                                                                                                            && (!HasAura(Auras.TheFirstoftheDead) || PreCheck(Precheck.DSH_DFA)))
                    || (Power(Unit.ComboPoints) >=4 && ComboPointsDeficit <= 2 && Power(Unit.EnemyCount) >= 3 && Power(Unit.EnemyCount) <= 4)) FinishRotation();
                ...
                if (AuraRemaining(Auras.TheFirstoftheDead) >= 1 && Power(Unit.ComboPoints) >= 3 &&
                    Power(Unit.EnemyCount) < 2 /* && !HasAura(Auras.ShadowGestures)*/) FinishRotation();
                ...
                if (PreCheck(Precheck.DSH_DFA) && HasItem(Item.TheFirstoftheDead) && AuraRemaining(Auras.Nightblade) <= (SpellCD(Spells.SymbolsofDeath) + 10) && SpellCD(Spells.SymbolsofDeath) <= 2 && Power(Unit.ComboPoints) >= 2) FinishRotation();
                ...
                if (EnergyDeficit <= StealthThreshold - 15) BuilderRotation();
        ...
        public class ShadowFuryInterface : Form
        {
            ...
            {
                System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ShadowFuryInterface));
                ...
                // ExampleCheck
                // 
                ExampleCheck.AutoSize = true;
                ExampleCheck.Font = new Font("Microsoft Sans Serif", 9F, FontStyle.Regular, GraphicsUnit.Point, ((byte)(0)));
                ExampleCheck.ForeColor = SystemColors.Control;
                ExampleCheck.Location = new Point(6, 25);
                ExampleCheck.Name = "ExampleCheck";
                ExampleCheck.Size = new Size(238, 19);
                ExampleCheck.TabIndex = 1;
                ExampleCheck.Text = "Auto Prowl / Rake When Out of Combat";
                ExampleCheck.UseVisualStyleBackColor = true;
                // 
                // SavageInterface
                // 
...
Spell,53,Backstab,D1w
Spell,26297,Berserking,O
Spell,20572,Blood Fury,O
Spell,185311,Crimson Vial,D5
Spell,152150,Death from Above,D4
Spell,196819,Eviscerate,NumPad2
Spell,200758,Gloomblade,D1
Spell,209782,Goremaws Bite,F3
Spell,137619,Marked for Death,D4
Spell,195452,Nightblade,NumPad1
Spell,121471,Shadow Blades,F2
Spell,185313,Shadow Dance,F1
Spell,36554,Shadowstep,R
Spell,185438,Shadowstrike,D1
Spell,197835,Shuriken Storm,D2
Spell,114014,Shuriken Toss,D3
Spell,1784,Stealth,NumPad0
Spell,212283,Symbols of Death,NumPad3
Spell,1856,Vanish,NumPad5
Item,137100,Denial of the Half-Giants,F10
Item,151818,TheFirstoftheDead,F10
Item,137032,ShadowSatyrsWalk,F10
Item,137049,InsigniaofRavenholdt,F10
Item,144236,MantleoftheMasterAssassin,F10
Range,53,Backstab,D1
Range,114014,Shuriken Toss,D3
...
Buff,248110,TheFirstoftheDeadAura
Buff,235022,MasterAssassinsInitativeAura
Buff,235027,MasterAssassinsInitativeAuraSecs
Buff,228224,TheDreadlordsDeceitAura
Buff,197496,FinalityEviscerateAura
Buff,197498,FinalityNightbladeAura
Buff,242705,FeedingFrenzyAura
Debuff,195452,NightbladeAura
Debuff,1079,RipAura
Debuff,155722,RakeAura
Charge,185313,ShadowDanceCharge
Charge,36554,ShadowstepCharge
*/
