...
{
    public class ShadowFury : CombatRoutine
    {
        ...
        {
            get { return "ShadowFury - Subtlety Rogue - version:" + _versionnumber; }
        }
        ...
        public override void Initialize()
        {
            ...
            Interface = new ShadowFuryInterface();
        ...
        private static void WriteLogging()
        {
            ...
            WriteLog("ShadowFury by Bash - v" + _versionnumber);
        ...
        /// Override for Settings Form.
        /// </summary>
        private ShadowFuryInterface Interface
        {
            get; set;
        }
        ...
        private void BuildInterface()
        {
            ...
            // Ability Settings
            Interface.boxexampleonboss.Checked = AvatarOnBoss;
            Interface.boxexampleonboss.CheckedChanged += AvatarOnBoss_CheckedChanged;
            Interface.boxexample2onboss.Checked = BattleCryOnBoss;
            Interface.boxexample2onboss.CheckedChanged += BattleCryOnBoss_CheckedChanged;
        ...
        private static bool HasAura(Auras aura)
        {
            switch (aura)
            {
                ...
                case Auras.Stealth:
                    return WoW.PlayerHasBuff("StealthAura");
                case Auras.ShadowDance:
                    return WoW.PlayerHasBuff("ShadowDanceAura");
                case Auras.ShadowBlades:
                    return WoW.PlayerHasBuff("ShadowBladesAura");
                case Auras.Vanish:
                    return WoW.PlayerHasBuff("VanishAura");
                case Auras.GoremawsBite:
                    return WoW.PlayerHasBuff("GoremawsBiteAura");
                case Auras.SymbolsofDeath:
                    return WoW.PlayerHasBuff("SymbolsofDeathAura");
                case Auras.CrimsonVial:
                    return WoW.PlayerHasBuff("CrimsonVialAura");
                case Auras.ShurikenCombo:
                    return WoW.PlayerHasBuff("ShurikenComboAura");
                case Auras.DeathfromAbove:
                    return WoW.PlayerHasBuff("DeathfromAboveAura");
                case Auras.Nightblade:
                    return WoW.TargetHasDebuff("NightbladeAura");
                case Auras.Subterfuge:
                    return WoW.PlayerHasBuff("SubterfugeAura");
        ...
        private static bool ItemCD(Itemeq itemeq)
        {
            switch (itemeq)
            {
                case Itemeq.ExampleItem:
                    return WoW.IsItemOnCooldown("Example Item");
                default:
                    return false;
            }
        }
        ...
        private static bool HasTalent(Talents talent)
        {
            switch (talent)
            {
                case Talents.MasterofSubtlety:
                    return WoW.Talent(1) == 1;
                case Talents.Weaponmaster:
                    return WoW.Talent(1) == 2;
                case Talents.Gloomblade:
                    return WoW.Talent(1) == 3;
                case Talents.Nightstalker:
                    return WoW.Talent(2) == 1;
                case Talents.Subterfuge:
                    return WoW.Talent(2) == 2;
                case Talents.ShadowFocus:
                    return WoW.Talent(2) == 3;
                case Talents.DeeperStratagem:
                    return WoW.Talent(3) == 1;
                case Talents.Anticipation:
                    return WoW.Talent(3) == 2;
                case Talents.Vigor:
                    return WoW.Talent(3) == 3;
                case Talents.SoothingDarkness:
                    return WoW.Talent(4) == 1;
                case Talents.Elusiveness:
                    return WoW.Talent(4) == 2;
                case Talents.CheatDeath:
                    return WoW.Talent(4) == 3;
                case Talents.StrikefromtheShadows:
                    return WoW.Talent(5) == 1;
                case Talents.PreyontheWeak:
                    return WoW.Talent(5) == 2;
                case Talents.TangledShadow:
                    return WoW.Talent(5) == 3;
                case Talents.DarkShadow:
                    return WoW.Talent(6) == 1;
                case Talents.Alacrity:
                    return WoW.Talent(6) == 2;
                case Talents.EnvelopingShadows:
                    return WoW.Talent(6) == 3;
                case Talents.MasterofShadows:
                    return WoW.Talent(7) == 1;
                case Talents.MarkedforDeath:
                    return WoW.Talent(7) == 2;
                case Talents.DeathfromAbove:
        ...
        private static int AuraRemaining(Auras aura)
        {
            ...
            {
                case Auras.Nightblade:
                    return WoW.TargetDebuffTimeRemaining("NightbladeAura");
                case Auras.DeathfromAbove:
                    return WoW.PlayerBuffTimeRemaining("DeathfromAboveAura");
        ...
        private static bool PreAbilityCheck(PreAbility ability)
        {
            switch (ability)
            {
                case PreAbility.Combat:
                    return (WoW.PlayerHasTarget || WoW.TargetIsBoss) && (WoW.PlayerIsInCombat || HasAura(Auras.Vanish)) && WoW.TargetIsEnemy && WoW.IsSpellInRange("Backstab") && WoW.PlayerHealthPercent > 0;

                case PreAbility.RangeCombat:
                    return (WoW.PlayerHasTarget || WoW.TargetIsBoss) && WoW.PlayerIsInCombat && WoW.TargetIsEnemy && WoW.IsSpellInRange("Shuriken Toss") && WoW.PlayerHealthPercent > 0;

                case PreAbility.Stealth:
                    return (HasAura(Auras.Stealth) || HasAura(Auras.Vanish) || HasAura(Auras.ShadowDance));

                case PreAbility.DSH_DFA:
                    return (HasTalent(Talents.DeathfromAbove) && HasTalent(Talents.DarkShadow) && WoW.CurrentEnemyUnitCount < 4);
        ...
        private int Rage
        {
            get { return WoW.CurrentRage; }
        }
        private static int Energy
        {
            get { return WoW.CurrentEnergy; }
        }
        private static int Hp
        {
            get { return WoW.PlayerHealthPercent; }
        }
        private static int TargetHp
        {
            get { return WoW.TargetHealthPercent; }
        }
        private static int ComboPoints
        {
            get { return WoW.CurrentComboPoints; }
        }
        private static int EnergyMax
        {
            get {
                if (HasTalent(Talents.Vigor))
                {
                    return 150;
                }
                return 100;
        ...
        private static int ComboPointsMax
        {
            get
            {
                if (HasTalent(Talents.DeeperStratagem))
                { return 6; }
                if (HasTalent(Talents.Anticipation))
                { return 10; }
                return 5;
            }
        }
        ...
        {
            get { return ComboPointsMax - ComboPoints; }
        }
        ...
        private static int StealthThreshold
        {
            get
            {
                return (65 + Convert.ToInt32(HasTalent(Talents.Vigor)) * 35 + Convert.ToInt32(HasTalent(Talents.MasterofShadows)) * 10);
            }
        }
        private static int EnergyDeficit
        {
            get {
                return EnergyMax - Energy;
            }
        }
        private static double SHDFractional
        {
            get { return 1.725 + 0.725 * Convert.ToDouble(HasTalent(Talents.EnvelopingShadows)); }
        }
        private static double SHDCDFractional
        {
            get { return (((60.00 - WoW.PlayerSpellChargeTimeRemaining("ShadowDance")) / 60.00) + WoW.PlayerSpellCharges("ShadowDance")); }
        }
        private static bool PoolForVanish = false;
        ...
        private void lblavataronboss_Click(object sender, System.EventArgs e)
        {

        }

        private void SelectRotation_SelectedIndexChanged(object sender, System.EventArgs e)
        {

        }
        internal static bool EnableAutomatedAoE
        {
            get
            {
                var enableautomatedaoe = ConfigFile.ReadValue("ShadowFury", "EnableAutomatedAoE").Trim();
                return enableautomatedaoe != "" && Convert.ToBoolean(enableautomatedaoe);
            }
            set { ConfigFile.WriteValue("ShadowFury", "EnableAutomatedAoE", value.ToString()); }
        }

        /// <summary>
        /// Setting boolean.
        /// </summary>
        internal static bool EnableCooldowns
        {
            get
            {
                var enablecooldowns = ConfigFile.ReadValue("ShadowFury", "EnableCooldowns").Trim();
                return enablecooldowns != "" && Convert.ToBoolean(enablecooldowns);
            }
            set { ConfigFile.WriteValue("ShadowFury", "EnableCooldowns", value.ToString()); }
        }

        internal static bool ExampleItem
        {
            get
            {
                var exampleitem = ConfigFile.ReadValue("ShadowFury", "ExampleItem").Trim();
                return exampleitem != "" && Convert.ToBoolean(exampleitem);
            }
            set { ConfigFile.WriteValue("ShadowFury", "ExampleItem", value.ToString()); }
        }

        /// <summary>
        /// Setting boolean.
        /// </summary>
        internal static bool AvatarOnBoss
        {
            get
            {
                var avataronboss = ConfigFile.ReadValue("ShadowFury", "AvatarBoss").Trim();
                return avataronboss != "" && Convert.ToBoolean(avataronboss);
            }
            set { ConfigFile.WriteValue("ShadowFury", "AvatarBoss", value.ToString()); }
        }

        /// <summary>
        /// Setting boolean.
        /// </summary>
        internal static bool BattleCryOnBoss
        {
            get
            {
                var battleoncry = ConfigFile.ReadValue("ShadowFury", "BattleCry").Trim();
                return battleoncry != "" && Convert.ToBoolean(battleoncry);
            }
            set { ConfigFile.WriteValue("ShadowFury", "BattleCry", value.ToString()); }
        }
        ...
        internal static bool EnableDebugger
        {
            get
            {
                var enabledebugger = ConfigFile.ReadValue("ShadowFury", "EnableDebugger").Trim();
                return enabledebugger != "" && Convert.ToBoolean(enabledebugger);
            }
            set { ConfigFile.WriteValue("ShadowFury", "EnableDebugger", value.ToString()); }
        }
        #region Checkboxes
        ...
        {
            ShadowFury.EnableAutomatedAoE = Interface.boxuseautoaoe.Checked;
        }

        private void ExampleItem_CheckedChanged(object sender, EventArgs e)
        {
            ShadowFury.ExampleItem = Interface.exampleitem1.Checked;
        }

        private void EnableCooldowns_CheckedChanged(object sender, EventArgs e)
        {
            ShadowFury.EnableCooldowns = Interface.boxuseautocooldowns.Checked;
        }

        private void AvatarOnBoss_CheckedChanged(object sender, EventArgs e)
        {
            ShadowFury.AvatarOnBoss = Interface.boxexampleonboss.Checked;
        }

        private void BattleCryOnBoss_CheckedChanged(object sender, EventArgs e)
        {
            ShadowFury.BattleCryOnBoss = Interface.boxexampleonboss.Checked;
        }

        private void EnableDebugger_CheckedChanged(object sender, EventArgs e)
        {
            ShadowFury.EnableDebugger = Interface.boxenabledebugger.Checked;
        }
        ...
        #region Rotations
        private void ShadowFuryRotation()
        {
            ...
            #region Rotation
            {
                ...
                if (!WoW.PlayerIsInCombat && !HasAura(Auras.Vanish))
                {
                    if (CombatSec > 0.00)
                    {
                        CombatTimer.Reset();
                ...
                if (WoW.CanCast("Shadow Dance") && HasTalent(Talents.DarkShadow) && !PreAbilityCheck(PreAbility.Stealth) && (HasAura(Auras.DeathfromAbove) || WoW.PlayerCooldownTimeRemaining("Death from Above") > 16))
                {
                ...
                {
                    #region Logging
                    const string msg = "NORMAL - Switching to SingleTarget";
                    if (_nomdebugger && msg != _nomdebuggerstring)
                    {
                        Log.Write(msg + "_" + WoW.PlayerSpellChargeTimeRemaining("ShadowDance") + "_" + WoW.PlayerSpellCharges("ShadowDance"), Color.OrangeRed);
                        _nomdebuggerstring = msg;
                    }
                    #endregion
                    Log.Write("Nightblade Remaining: " + AuraRemaining(Auras.Nightblade), Color.Orange);
                    Log.Write("Shadow Dance CD: " + WoW.PlayerSpellChargeTimeRemaining("ShadowDance"), Color.Orange);
                    Log.Write("Shadow Dance Charges: " + WoW.PlayerSpellCharges("ShadowDance"), Color.Orange); 

                    if (WoW.CanCast("Blood Fury") && PlayerRace(Races.Orc) && PreAbilityCheck(PreAbility.Stealth))
                    {
                        WoW.CastSpell("Blood Fury");
                        return;
                    }

                    if (WoW.CanCast("Berserking") && PlayerRace(Races.Troll) && PreAbilityCheck(PreAbility.Stealth))
                    {
                        WoW.CastSpell("Berserking");
                        return;
                    }

                    if (WoW.CanCast("Arcane Torrent") && PlayerRace(Races.BloodElf) && ((HasTalent(Talents.Vigor) || Energy < 80) || (!HasTalent(Talents.Vigor) && Energy < 30)))
                    {
                    ...
                    //Maintain Nightblade
                    if (WoW.CanCast("Nightblade") && ((!HasAura(Auras.Nightblade) && ComboPoints >= 3) || (AuraRemaining(Auras.Nightblade) <= 5 && ComboPoints >= 5)))
                    {
                        Log.Write(HasAura(Auras.Nightblade) + "_" + AuraRemaining(Auras.Nightblade), Color.OrangeRed);
                        WoW.CastSpell("Nightblade");
                        return;
                    }

                    //Activate Shadow Blades Icon Shadow Blades if available.
                    //if (WoW.CanCast("Shadow Blades"))
                    //{
                    ...
                    if (WoW.CanCast("Goremaws Bite") && (HasAura(Auras.Stealth) || HasAura(Auras.ShadowDance)) && ComboPointsDeficit >= 2 && EnergyDeficit > 50)
                    {
                        WoW.CastSpell("Goremaws Bite");
                        return;
                    }
                    if (WoW.CanCast("Shadowstrike") && PreAbilityCheck(PreAbility.Stealth) && ((!HasTalent(Talents.Anticipation) && ComboPointsDeficit >= 1) || (HasTalent(Talents.Anticipation) && ComboPoints < 7)))
                    {
                        WoW.CastSpell("Shadowstrike");
                        return;
                    }
                    if (WoW.CanCast("Shadow Dance") && ((!HasTalent(Talents.EnvelopingShadows) && (WoW.PlayerSpellCharges("ShadowDance") == 2)) || (HasTalent(Talents.EnvelopingShadows) && (WoW.PlayerSpellCharges("ShadowDance") == 3))) && Energy > 50 && (WoW.PlayerCooldownTimeRemaining("Death from Above") < 4 || WoW.PlayerCooldownTimeRemaining("Symbols of Death") < 4))
                    {
                        WoW.CastSpell("Shadow Dance");
                        return;
                    }
                    if (WoW.CanCast("Shadow Dance") && WoW.PlayerCooldownTimeRemaining("Death from Above") < 1 && WoW.CanCast("Symbols of Death") && (EnergyDeficit > 60 || ComboPoints < 5))
                    {
                        if(WoW.CanCast("Backstab") && ComboPoints < 5)
                        {
                            Log.Write(WoW.PlayerSpellChargeTimeRemaining("ShadowDance") + "_" + WoW.PlayerSpellCharges("ShadowDance"), Color.OrangeRed);
                    ...
                    if (WoW.CanCast("Symbols of Death") && WoW.CanCast("Shadow Dance") && WoW.CanCast("Death from Above") && EnergyDeficit > 40 && ComboPoints >= 5)
                    {
                    ...
                    if (WoW.CanCast("Death from Above") && HasAura(Auras.SymbolsofDeath) && WoW.CanCast("Shadow Dance") && ComboPoints >= 5)
                    {
                        WoW.CastSpell("Death from Above");
                        return;
                    }

                    //Activate Vanish Icon Vanish and then Shadowstrike Icon Shadowstrike when available if you are at or below 3 Combo Points.
                    /*if (WoW.CanCast("Vanish") && ComboPointsDeficit > 1 && !PreAbilityCheck(PreAbility.Stealth))
                    {
                    ...
                    if (WoW.CanCast("Eviscerate") && (!HasTalent(Talents.Anticipation) && ComboPointsDeficit == 0) || (HasTalent(Talents.Anticipation) && ComboPoints >= 5))
                    {
    ...
    public class ShadowFuryInterface : Form
    {
        ...
        public ShadowFuryInterface()
        {
            ...
            this.boxexample2onboss = new System.Windows.Forms.CheckBox();
            this.boxexamplesetting = new System.Windows.Forms.CheckBox();
            this.boxuseautoaoe = new System.Windows.Forms.CheckBox();
            this.boxexampleonboss = new System.Windows.Forms.CheckBox();
            ...
            this.rotationsettings.Controls.Add(this.boxexample2onboss);
            this.rotationsettings.Controls.Add(this.boxexamplesetting);
            this.rotationsettings.Controls.Add(this.boxuseautoaoe);
            this.rotationsettings.Controls.Add(this.boxexampleonboss);
            ...
            // boxexample2onboss
            // 
            this.boxexample2onboss.AutoSize = true;
            this.boxexample2onboss.ForeColor = System.Drawing.Color.Chocolate;
            this.boxexample2onboss.Location = new System.Drawing.Point(6, 147);
            this.boxexample2onboss.Name = "boxexample2onboss";
            this.boxexample2onboss.Size = new System.Drawing.Size(217, 17);
            this.boxexample2onboss.TabIndex = 6;
            this.boxexample2onboss.Text = "Use Example Cooldown #2 only on Boss";
            this.boxexample2onboss.UseVisualStyleBackColor = true;
            // 
            // boxexamplesetting
            // 
            ...
            // boxexampleonboss
            // 
            this.boxexampleonboss.AutoSize = true;
            this.boxexampleonboss.ForeColor = System.Drawing.Color.Chocolate;
            this.boxexampleonboss.Location = new System.Drawing.Point(6, 124);
            this.boxexampleonboss.Name = "boxexampleonboss";
            this.boxexampleonboss.Size = new System.Drawing.Size(201, 17);
            this.boxexampleonboss.TabIndex = 5;
            this.boxexampleonboss.Text = "Use Example Cooldown only on Boss";
            this.boxexampleonboss.UseVisualStyleBackColor = true;
            // 
            // boxuseautocooldowns
            // 
        ...
        public System.Windows.Forms.CheckBox boxexample2onboss;
        public System.Windows.Forms.CheckBox boxexampleonboss;
...
[SpellBook.db]
Spell,69179,Arcane Torrent,O
Spell,53,Backstab,NumPad1
Spell,26297,Berserking,O
Spell,20572,Blood Fury,O
Spell,185311,Crimson Vial,NumPad2
Spell,152150,Death from Above,NumPad3
Spell,196819,Eviscerate,NumPad4
Spell,200758,Gloomblade,NumPad1
Spell,209782,Goremaws Bite,NumPad5
Spell,137619,Marked for Death,NumPad3
Spell,195452,Nightblade,NumPad6
Spell,121471,Shadow Blades,NumPad7
Spell,185313,Shadow Dance,NumPad8
Spell,36554,Shadowstep,NumPad9
Spell,185438,Shadowstrike,NumPad0
Spell,197835,Shuriken Storm,Subtract
Spell,114014,Shuriken Toss,Multiply
Spell,1784,Stealth,F1
Spell,212283,Symbols of Death,F2
Spell,1856,Vanish,F3
Item,144259,BurningWish,F11
Item,137056,Luffa,F10
Range,53,Backstab
Range,114014,Shuriken Toss
Buff,1784,StealthAura
Buff,185422,ShadowDanceAura
Buff,121471,ShadowBladesAura
Buff,11327,VanishAura
Buff,220901,GoremawsBiteAura
Buff,212283,SymbolsofDeathAura
Buff,185311,CrimsonVialAura
Buff,245640,ShurikenComboAura
Buff,152150,DeathfromAboveAura
Buff,115192,SubterfugeAura
Debuff,195452,NightbladeAura
Debuff,1079,RipAura
Debuff,155722,RakeAura
Charge,185313,ShadowDance
Charge,36554,Shadowstep
