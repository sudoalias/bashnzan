...
{
    public class NecroticFury : CombatRoutine
    {
        #region Startup
        ...
        {
            get { return "NecroticFury - Warlock Routine by Bash - version:" + _versionnumber; }
        }
        ...
        public override void Initialize()
        {
            ...
            Interface = new NecroticFuryInterface();
        ...
        private NecroticFuryInterface Interface { get; set; }
        ...
        {
            WriteLog("NecroticFury - Warlock Routine by Bash - v" + _versionnumber);
        ...
        private static bool HasItem(Item item)
        {
            switch (item)
            {
                //case Item.ExampleItem: return WoW.IsItemOnCooldown("ExampleItem");
        ...
        private static bool HasTalent(Talent talent)
        {
            switch (talent)
            {
                case Talent.Haunt: return WoW.Talent(1) == 1;
                case Talent.WritheinAgony: return WoW.Talent(1) == 2;
                case Talent.MaleficGrasp: return WoW.Talent(1) == 3;
                case Talent.Contagion: return WoW.Talent(2) == 1;
                case Talent.AbsoluteCorruption: return WoW.Talent(2) == 2;
                case Talent.EmpoweredLifeTap: return WoW.Talent(2) == 3;
                case Talent.DemonicCircle: return WoW.Talent(3) == 1;
                case Talent.MortalCoil: return WoW.Talent(3) == 2;
                case Talent.HowlofTerror: return WoW.Talent(3) == 3;
                case Talent.PhantomSingularity: return WoW.Talent(4) == 1;
                case Talent.SowtheSeeds: return WoW.Talent(4) == 2;
                case Talent.SoulHarvest: return WoW.Talent(4) == 3;
                case Talent.DemonSkin: return WoW.Talent(5) == 1;
                case Talent.BurningRush: return WoW.Talent(5) == 2;
                case Talent.DarkPact: return WoW.Talent(5) == 3;
                case Talent.GrimoireofSupremacy: return WoW.Talent(6) == 1;
                case Talent.GrimoireofService: return WoW.Talent(6) == 2;
                case Talent.GrimoireofSacrifice: return WoW.Talent(6) == 3;
                case Talent.DeathsEmbrace: return WoW.Talent(7) == 1;
                case Talent.SiphonLife: return WoW.Talent(7) == 2;
                case Talent.SoulConduit: return WoW.Talent(7) == 3;
                default: return false;
            }
        }
        ...
        private static bool HasAura(Auras aura)
        {
            switch (aura)
            {
                case Auras.EmpoweredLifeTap: return WoW.PlayerHasBuff("EmpoweredLifeTapAura");
                case Auras.DeadwindHarvester: return WoW.PlayerHasBuff("DeadwindHarvesterAura");
                case Auras.TormentedSouls: return WoW.PlayerHasBuff("TormentedSoulsAura");
                case Auras.SoulHarvest: return WoW.PlayerHasBuff("SoulHarvestAura");
                case Auras.ConcordanceoftheLegionfall: return WoW.PlayerHasBuff("ConcordanceoftheLegionfallAura");
                case Auras.Haunt: return WoW.TargetHasDebuff("HauntAura");
                case Auras.Agony: return WoW.TargetHasDebuff("AgonyAura");
                case Auras.Corruption: return WoW.TargetHasDebuff("CorruptionAura");
                case Auras.SeedofCorruption: return WoW.TargetHasDebuff("SeedofCorruptionAura");
                case Auras.SiphonLife: return WoW.TargetHasDebuff("SiphonLifeAura");
                case Auras.UnstableAffliction1: return WoW.TargetHasDebuff("UnstableAffliction1Aura");
                case Auras.UnstableAffliction2: return WoW.TargetHasDebuff("UnstableAffliction2Aura");
                case Auras.UnstableAffliction3: return WoW.TargetHasDebuff("UnstableAffliction3Aura");
                case Auras.UnstableAffliction4: return WoW.TargetHasDebuff("UnstableAffliction4Aura");
                case Auras.UnstableAffliction5: return WoW.TargetHasDebuff("UnstableAffliction5Aura");
                default: return false;
            }
        }
        ...
        private static int AuraRemaining(Auras aura)
        {
            switch (aura)
            {
                case Auras.EmpoweredLifeTap: return WoW.PlayerBuffTimeRemaining("EmpoweredLifeTapAura");
                case Auras.DeadwindHarvester: return WoW.PlayerBuffTimeRemaining("DeadwindHarvesterAura");
                case Auras.TormentedSouls: return WoW.PlayerBuffTimeRemaining("TormentedSoulsAura");
                case Auras.SoulHarvest: return WoW.PlayerBuffTimeRemaining("SoulHarvestAura");
                case Auras.ConcordanceoftheLegionfall: return WoW.PlayerBuffTimeRemaining("ConcordanceoftheLegionfallAura");
                case Auras.Haunt: return WoW.TargetDebuffTimeRemaining("HauntAura");
                case Auras.Agony: return WoW.TargetDebuffTimeRemaining("AgonyAura");
                case Auras.Corruption: return WoW.TargetDebuffTimeRemaining("CorruptionAura");
                case Auras.SeedofCorruption: return WoW.TargetDebuffTimeRemaining("SeedofCorruptionAura");
                case Auras.SiphonLife: return WoW.TargetDebuffTimeRemaining("SiphonLifeAura");
                case Auras.UnstableAffliction1: return WoW.TargetDebuffTimeRemaining("UnstableAffliction1Aura");
                case Auras.UnstableAffliction2: return WoW.TargetDebuffTimeRemaining("UnstableAffliction2Aura");
                case Auras.UnstableAffliction3: return WoW.TargetDebuffTimeRemaining("UnstableAffliction3Aura");
                case Auras.UnstableAffliction4: return WoW.TargetDebuffTimeRemaining("UnstableAffliction4Aura");
                case Auras.UnstableAffliction5: return WoW.TargetDebuffTimeRemaining("UnstableAffliction5Aura");
                default: return 0;
            }
        }
        ...
        private static int AuraStacks(Auras aura)
        {
            switch (aura)
            {
                case Auras.TormentedSouls: return WoW.PlayerBuffStacks("TormentedSoulsAura");
                //case Auras.UnstableAffliction1: return WoW.TargetDebuffStacks("UnstableAffliction1Aura");
                default: return 0;
            }
        }

        private static int SpellCharges(Auras aura)
        {
            switch (aura)
            {
                //case Auras.ExampleSpell: return WoW.PlayerSpellCharges("ExampleSpell");
                default: return 0;
            }
        }
        ...
        private static bool PreCheck(Precheck ability)
        {
            switch (ability)
            {
                //case Precheck.ExamplePreAbility: return HasTalent(Talent.ExampleTalent1) && Power(Unit.Energy) <= 2 && PlayerRace(Race.BloodElf) && ExampleCheckConfig && ExampleComboConfig == "" && ExampleNumConfig <= 1;
                //case Precheck.ExamplePreAbility2: return HasAura(Auras.ExampleBuff) && AuraRemaining(Auras.ExampleDebuff) <= 10 && AuraStacks(Auras.ExampleDebuff) >= 2 && SpellCharges(Auras.ExampleSpell) >= 1;
                default:
                    return false;
            }
        }
        ...
        private static int UAStacks
        {
            get
            {
                return (Convert.ToInt32(HasAura(Auras.UnstableAffliction1)) +
                        Convert.ToInt32(HasAura(Auras.UnstableAffliction2)) +
                        Convert.ToInt32(HasAura(Auras.UnstableAffliction3)) +
                        Convert.ToInt32(HasAura(Auras.UnstableAffliction4)) +
                        Convert.ToInt32(HasAura(Auras.UnstableAffliction5)));
                //return AuraStacks(Auras.UnstableAffliction1);
            }
        }

        private static float UADrainSec
        {
            get
            {
                if (Power(Unit.SoulShards) >= 2)
                {
                    return Convert.ToSingle((2f * (1.5f * (WoW.PlayerHastePercent / 100f))) + (8f * (WoW.PlayerHastePercent / 100f)));
                }

                if (Power(Unit.SoulShards) == 1)
                {
                    return Convert.ToSingle((1.5f * (WoW.PlayerHastePercent / 100f)) + (8f * (WoW.PlayerHastePercent / 100f)));
                }
        ...
        private static bool UACheck
        {
            get
            {
                if (AuraRemaining(Auras.Agony) < UADrainSec) { return false; }
                if (AuraRemaining(Auras.Corruption) < UADrainSec) { return false; }
                if (HasTalent(Talent.SiphonLife) && AuraRemaining(Auras.SiphonLife) < UADrainSec) { return false; }
                return true;
            }
        }
        ...
        public void MaleficGrasp()
        {
            WriteLog("Agony: " + AuraRemaining(Auras.Agony));
            ...
            if (SpellCast("ReapSouls", (!HasAura(Auras.DeadwindHarvester) && CombatSec > 5 &&
                                      (AuraStacks(Auras.TormentedSouls) >= 4 + Power(Unit.EnemyCount) ||
                                       AuraStacks(Auras.TormentedSouls) >= 9)))) return;
            ...
            if (SpellCast("Agony", AuraRemaining(Auras.Agony) <= 2)) return;
            //actions.mg+=/seed_of_corruption,if=talent.sow_the_seeds.enabled&spell_targets.seed_of_corruption>=3&soul_shard=5
            if (SpellCast("SeedofCorruption",
                (HasTalent(Talent.SowtheSeeds) && active_enemies >= 3 && Power(Unit.SoulShards) == 5))) return;
            //actions.mg+=/unstable_affliction,if=target=sim.target&soul_shard=5
            if (SpellCast("UnstableAffliction", Power(Unit.SoulShards) == 5)) return;
            //actions.mg+=/drain_soul,cycle_targets=1,if=target.time_to_die<gcd*2&soul_shard<5
            if (SpellCast("DrainSoul", (Power(Unit.TargetHP) < 5 && Power(Unit.SoulShards) < 5 && !WoW.PlayerIsChanneling))) return;
            //actions.mg+=/life_tap,if=talent.empowered_life_tap.enabled&buff.empowered_life_tap.remains<=gcd
            if (SpellCast("LifeTap",
                (HasTalent(Talent.EmpoweredLifeTap) &&
                 AuraRemaining(Auras.EmpoweredLifeTap) <= CurrentGlobalCooldown))) return;
            ...
            if (SpellCast("SiphonLife", (HasTalent(Talent.SiphonLife) && AuraRemaining(Auras.SiphonLife) <= 1))) return;
            ...
            if (SpellCast("Corruption",
                ((!HasTalent(Talent.SowtheSeeds) || active_enemies < 3) && active_enemies < 5 &&
                 AuraRemaining(Auras.Corruption) <= 1))) return;
            //actions.mg+=/phantom_singularity
            if (SpellCast("PhantomSingularity", HasTalent(Talent.PhantomSingularity))) return;
            ...
            if (SpellCast("SoulHarvest", (UAStacks > 1 && AuraRemaining(Auras.SoulHarvest) <= 8))) return;
            ...
            if (SpellCast("Agony",
                (AuraRemaining(Auras.Agony) <= 6 && (UAStacks == 0/* || WoW.PlayerWasLastCastedSpell("Agony")*/)))) return;
            ...
            if (SpellCast("SiphonLife",
                (HasTalent(Talent.SiphonLife) && AuraRemaining(Auras.SiphonLife) <= 4 &&
                 (UAStacks == 0/* || WoW.PlayerWasLastCastedSpell("SiphonLife")*/)))) return;
            ...
            if (SpellCast("Corruption",
                ((!HasTalent(Talent.SowtheSeeds) || active_enemies < 3) && active_enemies < 5 &&
                 AuraRemaining(Auras.Corruption) <= 4 &&
                 (UAStacks == 0/* || WoW.PlayerWasLastCastedSpell("Corruption")*/)))) return;
            ...
            if (SpellCast("LifeTap",
                (HasTalent(Talent.EmpoweredLifeTap) && AuraRemaining(Auras.EmpoweredLifeTap) < 6 ||
                 Power(Unit.Mana) < 10))) return;
            ...
            if (SpellCast("SeedofCorruption",
                ((HasTalent(Talent.SowtheSeeds) && active_enemies >= 3) ||
                 (active_enemies >= 5 && AuraRemaining(Auras.Corruption) <= 3)))) return;
            ...
            if (SpellCast("UnstableAffliction", (active_enemies > 1 && Power(Unit.SoulShards) >= 4))) return;
            ...
            if (SpellCast("UnstableAffliction",
                (Power(Unit.SoulShards) >= 1 && (UAStacks == 0 || (UAStacks <= 2 && WoW.PlayerWasLastCastedSpell("UnstableAffliction"))) &&
                 AuraRemaining(Auras.Agony) >
                 (1.5 * (WoW.PlayerHastePercent / 100)) + (6.5 * (WoW.PlayerHastePercent / 100))))) return;
            ...
            if (SpellCast("ReapSouls", (AuraStacks(Auras.TormentedSouls) >= 1 && !HasAura(Auras.DeadwindHarvester) && UAStacks >= 1))) return;
            //actions.mg+=/life_tap,if=mana.pct<=10
            if (SpellCast("LifeTap", Power(Unit.Mana) <= 10)) return;
            //actions.mg+=/life_tap,if=prev_gcd.1.life_tap&buff.active_uas.stack=0&mana.pct<50
            if (SpellCast("LifeTap",
                (WoW.PlayerWasLastCastedSpell("LifeTap") && UAStacks == 0 && Power(Unit.Mana) < 50))) return;
            //actions.mg+=/drain_soul, chain=1, interrupt=1
            if (SpellCast("DrainSoul", !WoW.PlayerIsChanneling)) return;
            ...
            //WriteLog("PlayerHastePrecent: " + Convert.ToSingle(WoW.PlayerHastePercent / 100f));
            //WriteLog("UAStacks: " + UAStacks);
            //WriteLog("UADrainSec: " + UADrainSec);
            //WriteLog("UACheck: " + UACheck);
            //WriteLog("Agony: " + AuraRemaining(Auras.Agony));
            //WriteLog("Corruption: " + AuraRemaining(Auras.Corruption));
            //WriteLog("SiphonLife: " + AuraRemaining(Auras.SiphonLife));
            /*
            if (SpellCast("ReapSouls", (AuraStacks(Auras.TormentedSouls) >= 1 && UAStacks >= 2 && !HasAura(Auras.DeadwindHarvester)))) return;
            //UA - SoulShards == 5
            if (SpellCast("UnstableAffliction", Power(Unit.SoulShards) == 5)) return;
            //Agony - (Agony < 5 and No UA) or(Agony < 3 and UA)
            if (SpellCast("Agony",
                ((AuraRemaining(Auras.Agony) < 5 && UAStacks == 0) ||
                 (AuraRemaining(Auras.Agony) < 3 && UAStacks > 0)))) return;
            if (SpellCast("SeedofCorruption",
                ((HasTalent(Talent.SowtheSeeds) && active_enemies >= 3) || active_enemies >= 5 ||
                 (active_enemies >= 3 && AuraRemaining(Auras.Corruption) <= 3)))) return;
            //Corruption - (Corruption <= 4 and No UA) or no Corruption
            if (SpellCast("Corruption",
                ((AuraRemaining(Auras.Corruption) <= 4 && UAStacks == 0) || !HasAura(Auras.Corruption)))) return;
            //Siphon Life - (Siphon Life <= 4 and No UA) or No siphon life
            if (SpellCast("SiphonLife",
                (HasTalent(Talent.SiphonLife) &&
                 ((AuraRemaining(Auras.SiphonLife) <= 4 && UAStacks == 0) || !HasAura(Auras.SiphonLife))))) return;
            //UA - UAStacks < 2 and SoulShards > 0
            if (SpellCast("UnstableAffliction", (UACheck && UAStacks < 2 && Power(Unit.SoulShards) > 1))) return;
            if (SpellCast("UnstableAffliction", (UACheck & UAStacks == 1 && Power(Unit.SoulShards) > 0))) return;
            //UA - UAStacks <= 4 and SoulShards > 3
            if (SpellCast("UnstableAffliction", (UACheck && UAStacks <= 4 && Power(Unit.SoulShards) > 3))) return;
            //Drain Soul - UA
            if (SpellCast("DrainSoul", (UAStacks >= 2 && !WoW.PlayerIsChanneling))) return;
            //Life Tap -Mana < 50
            if (SpellCast("LifeTap", ((!WoW.PlayerIsChanneling || UAStacks == 0) && Power(Unit.Mana) < 50))) return;
            //Drain Soul
            if (SpellCast("DrainSoul", (!WoW.PlayerIsChanneling))) return;
            */

            /*if (SpellCast("DrainSoul", (Power(Unit.TargetHP) < 5 && Power(Unit.SoulShards) < 5 && !WoW.PlayerIsChanneling))) return;
            if (SpellCast("Agony", (!HasAura(Auras.Agony) || AuraRemaining(Auras.Agony) < 5))) return;
            if (SpellCast("Corruption", !HasAura(Auras.Corruption))) return;
            if (SpellCast("SiphonLife", (HasTalent(Talent.SiphonLife) && !HasAura(Auras.SiphonLife)))) return;
            if (SpellCast("PhantomSingularity", HasTalent(Talent.PhantomSingularity))) return;
            if (SpellCast("SeedofCorruption", (!HasAura(Auras.SeedofCorruption) && active_enemies >= 3 && Power(Unit.SoulShards) >= 2))) return;
            if (SpellCast("SoulHarvest",
                (HasAura(Auras.Agony) && HasAura(Auras.Corruption) &&
                 ((HasTalent(Talent.SiphonLife) && HasAura(Auras.SiphonLife)) || !HasTalent(Talent.SiphonLife)))));
            if (SpellCast("ReapSouls",
                (HasAura(Auras.SoulHarvest) && !HasAura(Auras.DeadwindHarvester) &&
                 AuraStacks(Auras.TormentedSouls) >= 1))) return;
            if (SpellCast("UnstableAffliction", (Power(Unit.SoulShards) >= 2 && UAStacks == 0 && HasAura(Auras.SoulHarvest)))) return;
            if (SpellCast("UnstableAffliction", (Power(Unit.SoulShards) >= 1 && UAStacks <= 1 && WoW.PlayerWasLastCastedSpell("UnstableAffliction") && HasAura(Auras.SoulHarvest)))) return;
            if (SpellCast("ReapSouls", (UAStacks >= 2 && AuraStacks(Auras.TormentedSouls) >= 1 && !HasAura(Auras.DeadwindHarvester)))) return;
            if (SpellCast("ReapSouls",
                AuraStacks(Auras.TormentedSouls) >= 6 && !HasAura(Auras.DeadwindHarvester))) return;
            if (SpellCast("UnstableAffliction", (Power(Unit.SoulShards) >= 5 && UAStacks == 0 ))) return;
            if (SpellCast("UnstableAffliction", (Power(Unit.SoulShards) >= 4 && UAStacks <= 1 && WoW.PlayerWasLastCastedSpell("UnstableAffliction")))) return;
            if (SpellCast("DrainSoul", (UAStacks >= 1 && !WoW.PlayerIsChanneling))) return;
            if (SpellCast("Corruption", (AuraRemaining(Auras.Corruption) < 4 && !HasTalent(Talent.AbsoluteCorruption)))) return;
            if (SpellCast("SiphonLife", AuraRemaining(Auras.SiphonLife) < 4)) return;
            if (SpellCast("LifeTap", (Power(Unit.PlayerHP) > 40 && Power(Unit.Mana) < 40))) return;
            if (SpellCast("DrainSoul", !WoW.PlayerIsChanneling)) return;
            */
        }
        #endregion
        ...
        public override void Pulse()
        {
            ...
            if ((Player(Status.TargetBoss) || !Player(Status.TargetBoss)) && Player(Status.InCombat) && Player(Status.TargetEnemy) && WoW.IsSpellInRange("Agony"))
            {
                //actions = call_action_list,name = mg,if= talent.malefic_grasp.enabled
                if (HasTalent(Talent.MaleficGrasp)) { MaleficGrasp(); }
                //actions +=/ call_action_list,name = writhe,if= talent.writhe_in_agony.enabled
                if (HasTalent(Talent.WritheinAgony)) { Writhe(); }
                //actions +=/ call_action_list,name = haunt,if= talent.haunt.enabled
                if (HasTalent(Talent.Haunt)) { Haunt(); }
        ...
        public class NecroticFuryInterface : Form
        {
            ...
            public NecroticFuryInterface()
            {
                System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(NecroticFuryInterface));
...
[SpellBook.db]
Spell,216698,ReapSouls,NumPad1
Spell,980,Agony,NumPad2
Spell,30108,UnstableAffliction,NumPad3
Spell,198590,DrainSoul,NumPad4
Spell,1454,LifeTap,NumPad5
Spell,63106,SiphonLife,NumPad6
Spell,172,Corruption,NumPad7
Spell,205179,PhantomSingularity,NumPad8
Spell,196098,SoulHarvest,NumPad8
Spell,27243,SeedofCorruption,NumPad9
Buff,235156,EmpoweredLifeTapAura
Buff,216708,DeadwindHarvesterAura
Buff,216695,TormentedSoulsAura
Buff,196098,SoulHarvestAura
Buff,242586,ConcordanceoftheLegionfallAura
Debuff,48181,HauntAura
Debuff,980,AgonyAura
Debuff,146739,CorruptionAura
Debuff,27243,SeedofCorruptionAura
Debuff,63106,SiphonLifeAura
Debuff,233490,UnstableAffliction1Aura
Debuff,233496,UnstableAffliction2Aura
Debuff,233497,UnstableAffliction3Aura
Debuff,233498,UnstableAffliction4Aura
Debuff,233499,UnstableAffliction5Aura
Debuff,252938,TormentedAgonyAura
Range,980,Agony,NumPad2
*/
